#Load data
library('foreign')
da02566.0001<-read.spss('02566-0001-Data.sav') #female only
da02566.0002<-read.spss('02566-0002-Data.sav') #male only
da02566.0000<-dplyr::bind_rows(da02566.0001,da02566.0002)
#Coded variables
#Participant ID: NA
#Measure Name (not a variable in the dataset): SF-36 Health Survey
#Depressive symptom items: 
#B32(RC),B33,B34,B35(RC),B36,B37,B38(RC),B39
...
#Evaluation Month: MO
#Evaluation Day: DAY
#Participant Income: B11  
#Maternal Income: NA
#Paternal Income: NA
#Household Income: B13
#Participant Education: B6
...
#Notes: Violence and Threats of Violence Against Women and Men in the United States, 1994-1996

#Create Dataset ----
attach(da02566.0000)
#Extract relevant variables into a dataframe.
ID2566DS0<-data.frame(b32,b33,b34,b35,b36,b37,b38,b39,b8,b7,rgender,b1,b3,year,mo,day,
                      b11,b13,b6)
detach(da02566.0000)
ID2566DS0$ORIGOBS<-nrow(ID2566DS0)
rm(da02566.0000,da02566.0001,da02566.0002)

#Check to make sure there is no funny business
head(ID2566DS0)

#Depressive Symptoms ---------
ID2566DS0$b32<-ifelse(ID2566DS0$b32=="Never",3,            
               ifelse(ID2566DS0$b32=="Rarely",2,           
               ifelse(ID2566DS0$b32=="Some of the time",1, 
               ifelse(ID2566DS0$b32=="Most of the time",0,NA))))#RC
ID2566DS0$b33<-ifelse(ID2566DS0$b33=="Never",0,            
               ifelse(ID2566DS0$b33=="Rarely",1,           
               ifelse(ID2566DS0$b33=="Some of the time",2, 
               ifelse(ID2566DS0$b33=="Most of the time",3,NA))))  
ID2566DS0$b34<-ifelse(ID2566DS0$b34=="Never",0,            
               ifelse(ID2566DS0$b34=="Rarely",1,           
               ifelse(ID2566DS0$b34=="Some of the time",2, 
               ifelse(ID2566DS0$b34=="Most of the time",3,NA))))  
ID2566DS0$b35<-ifelse(ID2566DS0$b35=="Never",3,            
               ifelse(ID2566DS0$b35=="Rarely",2,           
               ifelse(ID2566DS0$b35=="Some of the time",1, 
               ifelse(ID2566DS0$b35=="Most of the time",0,NA))))#RC
ID2566DS0$b36<-ifelse(ID2566DS0$b36=="Never",0,            
               ifelse(ID2566DS0$b36=="Rarely",1,           
               ifelse(ID2566DS0$b36=="Some of the time",2, 
               ifelse(ID2566DS0$b36=="Most of the time",3,NA))))  
ID2566DS0$b37<-ifelse(ID2566DS0$b37=="Never",0,            
               ifelse(ID2566DS0$b37=="Rarely",1,           
               ifelse(ID2566DS0$b37=="Some of the time",2, 
               ifelse(ID2566DS0$b37=="Most of the time",3,NA))))  
ID2566DS0$b38<-ifelse(ID2566DS0$b38=="Never",3,            
               ifelse(ID2566DS0$b38=="Rarely",2,           
               ifelse(ID2566DS0$b38=="Some of the time",1, 
               ifelse(ID2566DS0$b38=="Most of the time",0,NA))))#RC
ID2566DS0$b39<-ifelse(ID2566DS0$b39=="Never",0,            
               ifelse(ID2566DS0$b39=="Rarely",1,           
               ifelse(ID2566DS0$b39=="Some of the time",2, 
               ifelse(ID2566DS0$b39=="Most of the time",3,NA)))) 
...
dsitems <- ID2566DS0[c(1:8)]
#dsitemspw <- ID2566DS0[c(:)]
#Identify participants missing more than half of dsitems (not dsitemsW1) (1=missing > 50%) - to be used later
ID2566DS0$dsmiss<-ifelse(rowSums(is.na(dsitems))>((ncol(dsitems)/2)),1,0)
#Compute mean symptom score 
ID2566DS0$DEP<-rowMeans(x=dsitems,na.rm=TRUE)
ID2566DS0$DEPPW<-NA#rowMeans(x=dsitemspw,na.rm=TRUE)
...
ID2566DS0$LAT<-ifelse(ID2566DS0$b8=="Yes",1,
               ifelse(ID2566DS0$b8=="No",0,NA))
ID2566DS0$WHT<-ifelse(ID2566DS0$b7=="White",1,0)   
ID2566DS0$BLK<-ifelse(ID2566DS0$b7=="Black/African-American",1,0)
ID2566DS0$AI<-ifelse(ID2566DS0$b7=="American Indian/Alaskan Native",1,0)
ID2566DS0$AA<-ifelse(ID2566DS0$b7=="Asian/Pacific Islander",1,0)
ID2566DS0$OTH<-NA

#Compute variable for participants who reported more than one race (mixed/biracial; do not include Latino)
ID2566DS0$MR<-ifelse(ID2566DS0$b7=="Mixed race",1,0)
#ID2566DS0$MR<-ifelse((rowSums(x=cbind(ID2566DS0$WHT,ID2566DS0$BLK,ID2566DS0$AI,ID2566DS0$AA,
#                                     ID2566DS0$OTH),na.rm=TRUE)) > 1, 1, 0)

##Compute variables for participants who reported a single race (excluding mixed/biracial & Latino)
ID2566DS0$WHT<-ifelse(((ID2566DS0$LAT == 0)&(ID2566DS0$WHT == 1)), 1, 0)
ID2566DS0$BLK<-ifelse(((ID2566DS0$LAT == 0)&(ID2566DS0$BLK == 1)), 1, 0)
ID2566DS0$AI<-ifelse(((ID2566DS0$LAT == 0)&(ID2566DS0$AI == 1)), 1, 0)
ID2566DS0$AA<-ifelse(((ID2566DS0$LAT == 0)&(ID2566DS0$AA == 1)), 1, 0)
#ID2566DS0$OTH<-ifelse(((ID2566DS0$LAT == 0)&(ID2566DS0$OTH == 1)), 1, 0)
ID2566DS0$MR<-ifelse(((ID2566DS0$LAT == 0)&(ID2566DS0$MR == 1)), 1, 0)

#Recode sex
ID2566DS0$SEX<-ifelse(ID2566DS0$rgender == "Male", 1, 0)

#Recode age 
levels(ID2566DS0$b1)[levels(ID2566DS0$b1)=="97 yrs or older"]<-97
ID2566DS0$AGECALC<-as.numeric(as.character(ID2566DS0$b1))

#Income, Education, Occupation ----
##Income   
ID2566DS0$b11<-ifelse(ID2566DS0$b11=="None",0,
               ifelse(ID2566DS0$b11=="Under $5,000",4999,     
               ifelse(ID2566DS0$b11=="$5,000-$10,000",7500,   
               ifelse(ID2566DS0$b11=="$10,000-$15,000",12500,  
               ifelse(ID2566DS0$b11=="$15,000-$20,000",17500, 
               ifelse(ID2566DS0$b11=="$20,000-$25,000",22500,  
               ifelse(ID2566DS0$b11=="$25,000-$35,000",30000,  
               ifelse(ID2566DS0$b11=="$35,000-$50,000",42500,  
               ifelse(ID2566DS0$b11=="$50,000-$80,000",65000, 
               ifelse(ID2566DS0$b11=="$80,000-$100,000",90000, 
               ifelse(ID2566DS0$b11=="Over $100,000",100001,NA)))))))))))   
ID2566DS0$b13<-ifelse(ID2566DS0$b13=="None",0,
               ifelse(ID2566DS0$b13=="Under $5,000",4999,     
               ifelse(ID2566DS0$b13=="$5,000-$10,000",7500,   
               ifelse(ID2566DS0$b13=="$10,000-$15,000",12500,  
               ifelse(ID2566DS0$b13=="$15,000-$20,000",17500, 
               ifelse(ID2566DS0$b13=="$20,000-$25,000",22500,  
               ifelse(ID2566DS0$b13=="$25,000-$35,000",30000,  
               ifelse(ID2566DS0$b13=="$35,000-$50,000",42500,  
               ifelse(ID2566DS0$b13=="$50,000-$80,000",65000, 
               ifelse(ID2566DS0$b13=="$80,000-$100,000",90000, 
               ifelse(ID2566DS0$b13=="Over $100,000",100001,NA))))))))))) 
ID2566DS0$INC<-pmax(ID2566DS0$b11,ID2566DS0$b13,na.rm=TRUE)

##Education 
ID2566DS0$EDU<-ifelse(ID2566DS0$b6=="No schooling",0,        
               ifelse(ID2566DS0$b6=="1st-8th grade",4.5,       
               ifelse(ID2566DS0$b6=="Some high school",10.5,   
               ifelse(ID2566DS0$b6=="HS graduate",12,         
               ifelse(ID2566DS0$b6=="Some college",14,        
               ifelse(ID2566DS0$b6=="4 yr college degree",16,
               ifelse(ID2566DS0$b6=="Postgraduate",18,NA)))))))
...
write.csv(ID2566DS0, file = 'ID2566DS0_recoded.csv')

#Descriptives and Correlations -----
#Exclude participants with more than 50% missing on depressive symptoms items
ID2566DS0 <- ID2566DS0[which(ID2566DS0$dsmiss==0), ]

##Compute mean and sd across all participants within dataset
library('psych')
#Means & SDs of focal variables
dstatsage<-describe(ID2566DS0$AGECALC)
dstatsdep<-describe(ID2566DS0$DEP)
dstatsachv<-NA#describe(ID2566DS0$ACHV)
dstatsinc<-describe(ID2566DS0$INC)
dstatsedu<-describe(ID2566DS0$EDU)
dstatsoccs<-NA#describe(ID2566DS0$OCCS)
dstatsoccp<-NA#describe(ID2566DS0$OCCP)

#Save descriptive stats
dstats<-rbind(dstatsage,dstatsdep,dstatsachv,dstatsinc,dstatsedu,dstatsoccs,dstatsoccp,make.row.names= FALSE)
write.csv(dstats,file = 'ID2566DS0_dstats.csv',
          row.names=c("dstatsage","dstatsdep","dstatsachv","dstatsinc","dstatsedu","dstatsoccs","dstatsoccp"))

##Histograms 
pdf('ID2566DS0_dephist.pdf')
hist(ID2566DS0$DEP, xlab="Depressive Symptoms", main = NULL, col="grey")
dev.off()
#pdf('ID2566DS0_achvhist.pdf')
#hist(ID2566DS0$ACHV, xlab="Academic Achievement", main = NULL, col="grey")
#dev.off()
pdf('ID2566DS0_inchist.pdf')
hist(ID2566DS0$INC, xlab="Income", main = NULL, col="grey")
dev.off()
pdf('ID2566DS0_educhist.pdf')
hist(ID2566DS0$EDU, xlab="Educational Attainment", main = NULL, col="grey")
dev.off()
#pdf('ID2566DS0_occshist.pdf')
#hist(ID2566DS0$OCCS, xlab="Occupational Status", main = NULL, col="grey")
#dev.off()
#pdf('ID2566DS0_occphist.pdf')
#hist(ID2566DS0$OCCP, xlab="Occupational Prestige", main = NULL, col="grey")
#dev.off()
...
table(ID2566DS0$AGECALC)
#Separate dataset by developmental period, if needed
#CH<-ID2566DS0[which((ID2566DS0$AGECALC >= 5)&(ID2566DS0$AGECALC <= 11)), ] 
#AD<-ID2566DS0[which((ID2566DS0$AGECALC >= 12)&(ID2566DS0$AGECALC <= 17)), ]
YD<-ID2566DS0[which((ID2566DS0$AGECALC >= 18)&(ID2566DS0$AGECALC <= 25)), ]
AT<-ID2566DS0[which((ID2566DS0$AGECALC >= 26)&(ID2566DS0$AGECALC <= 64)), ]
OA<-ID2566DS0[which(ID2566DS0$AGECALC >= 65), ]
...
##Assign ICPSR ID number (ICPSR Number; e.g., file name = ID2566DS0, then DATAID = 21600)
#DATAID<-'2566'
#names(DATAID)<-'DATAID'
...
#ALPHAOV <- ci.reliability(data=WHTCHF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTCHM[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHM[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTADF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTADF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTADM[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTADM[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTYDF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTYDF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTYDM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTYDM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTATF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTATF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTATM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTATM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTOAF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTOAF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTOAM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTOAM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#names(DATAYEAR)<-'DATAYEAR'
##Compute reliability estimates
#ALPHAOV <- ci.reliability(data=LATCHF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATCHM[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHM[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#names(DATAYEAR)<-'DATAYEAR'
##Compute reliability estimates
#ALPHAOV <- ci.reliability(data=LATADF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATADF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATADM[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATADM[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATYDF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATYDF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATYDM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATYDM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATATF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATATF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATATM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATATM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATOAF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATOAF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATOAM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATOAM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHM[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHM[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKADF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKADF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKADM[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKADM[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKYDF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKYDF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKYDM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKYDM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKATF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKATF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKATM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKATM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKOAF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKOAF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKOAM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKOAM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHMC[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHMC[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADM[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADM[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AAYDF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AAYDF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AAYDM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AAYDM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AAATF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AAATF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AAATM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AAATM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AAOAM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AAOAM[1:8], type = "omega", interval.type = "none")
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHM[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHM[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADM[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADM[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AIYDF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AIYDF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AIYDM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AIYDM[1:8], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AIATF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AIATF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AIATM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AIATM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIOAF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIOAF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIOAM[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIOAM[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHM[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHM[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADF[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADF[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADM[1:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADM[1:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=MRYDF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=MRYDF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=MRYDM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=MRYDM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=MRATF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=MRATF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=MRATM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=MRATM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=MROAF[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=MROAF[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=MROAM[1:8], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=MROAM[1:8], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
ID2566DS0_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID2566DS0_aggregated, file = 'ID2566DS0_aggregated.csv',row.names = FALSE)
