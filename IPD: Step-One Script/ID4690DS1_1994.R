...
#Birth Month: NA
#Birth Day: NA
#Evaluation Year: V11403
#Evaluation Month: V11402
#Evaluation Day: V11401
#Participant Income: NA  
#Maternal Income: NA
#Paternal Income: NA
#Household Income: V11203
...
#Participant Occupation: V11318, V7018 & V1112 (prior waves)
...
#Notes: Americans' Changing Lives - Wave 3

#Create Dataset ----
attach(da04690.0001)
#Extract relevant variables into a dataframe.
ID4690DS1<-data.frame(V10283,V10284,V10285,V10286,V10287,V10288,V10289,V10290,V10291,V10292,V10293,
                      V5001,V5002,V5003,V5004,V5005,V5006,V5007,V5008,V5010,V5011,V5012,V1620,V2004,
                      V1628,V1629,V1631,V1630,V1632,V1801,V2001,V11403,V11402,V11401,V11203,V2007,
                      V11318,V7018,V1112) 
detach(da04690.0001)
...
#Recode age
ID4690DS1$AGECALC<-1994-ID4690DS1$V2001

#Income, Education, Occupation ----
##Income
ID4690DS1$INC<-ID4690DS1$V11203 
...
ID4690DS1$occ<-ifelse((is.na(ID4690DS1$V11318)),ID4690DS1$occpw,ID4690DS1$V11318)
#Nam-Powers-Boyd scale (Nam & Boyd, 2008)
occ_codes<-read.csv(file = 'ID4690DS1_1994_Occupational codes.csv')
...
write.csv(ID4690DS1, file = 'ID4690DS1_1994_recoded.csv')
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AIATF[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AIATF[1:11], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
ID4690DS1_1994_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID4690DS1_1994_aggregated, file = 'ID4690DS1_1994_aggregated.csv',row.names = FALSE)
