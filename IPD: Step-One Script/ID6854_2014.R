#load dataset
library('foreign')
#H14B_R.SAV (demographics) is partial data (a lot missing), merge with prior wave 
#merge with recoded data from 2012 (includes prior wave dep symptoms, race/ethnicity, and education)
demographics<-read.spss('H14B_R.SAV') 
demographicspw<-read.csv(file = 'ID6854DS0_2012_recoded.csv')
...
depression<-read.spss('H14D_R.SAV')
income<-read.spss('H14Q_H.sav')
employment<-read.spss('H14J_R.SAV')
other<-read.spss('H14A_R.SAV')
preload<-read.spss('H14PR_R.SAV')
#Merge datasets by Case ID (V1)
ID68542014<-merge(depression,income,by="HHID",all=TRUE)
ID68542014$HHIDPN<-paste(ID68542014$HHID,ID68542014$PN,sep = "")
ID68542014<-merge(ID68542014,demographics,by="HHIDPN",all=TRUE)
employment$HHIDPN<-paste(employment$HHID,employment$PN,sep = "")
ID68542014<-merge(ID68542014,employment,by="HHIDPN",all=TRUE)
other$HHIDPN<-paste(other$HHID,other$PN,sep = "")
ID68542014<-merge(ID68542014,other,by="HHIDPN",all=TRUE)
preload$HHIDPN<-paste(preload$HHID,preload$PN,sep = "")
ID68542014<-merge(ID68542014,preload,by="HHIDPN",all=TRUE)
#Coded variables
...
#Ethnicity: OB028 prior wave: NB028
#Race: OB089M1M,OB089M2M,OB089M3M prior wave: NB089M1M,NB089M2M,NB089M3M 
#White: NA
#Black: NA 
...
#Birth Month: OX004_R
#Birth Day: NA
#Evaluation Year: OA501
#Evaluation Month: OA500
#Evaluation Day: NA
#Participant Income: OQ020  
#Maternal Income: NA
#Paternal Income: NA
#Household Income: OQ020+OQ045(partner)
#Participant Education: OB014 prior wave: EDU
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: OJ168M 
...
ID6854DS0<-data.frame(HHIDPN,OD110,OD111,OD112,OD113,OD114,OD115,OD116,OD117,
                      ND110,ND111,ND112,ND113,ND114,ND115,ND116,ND117,OB028,NB028,
                      OB089M1M,OB089M2M,OB089M3M,NB089M1M,NB089M2M,NB089M3M,OX060_R,
                      OA019,OX067_R,OX004_R,OA501,OA500,OQ020,OQ045,OB014,EDU,OJ168M)
detach(ID68542014)
ID6854DS0$ORIGOBS<-nrow(ID6854DS0)
rm(ID68542014,demographics,demographicspw,depression,employment,income,other,preload)
...
#9=RF (refused)
ID6854DS0$OD110<-ifelse(ID6854DS0$OD110==1,1,
                ifelse(ID6854DS0$OD110==5,0,NA))
ID6854DS0$OD111<-ifelse(ID6854DS0$OD111==1,1,
                ifelse(ID6854DS0$OD111==5,0,NA))                 
ID6854DS0$OD112<-ifelse(ID6854DS0$OD112==1,1,
                ifelse(ID6854DS0$OD112==5,0,NA))
ID6854DS0$OD113<-ifelse(ID6854DS0$OD113==1,0,
                ifelse(ID6854DS0$OD113==5,1,NA))#RC
ID6854DS0$OD114<-ifelse(ID6854DS0$OD114==1,1,
                ifelse(ID6854DS0$OD114==5,0,NA))
ID6854DS0$OD115<-ifelse(ID6854DS0$OD115==1,0,
                ifelse(ID6854DS0$OD115==5,1,NA))#RC
ID6854DS0$OD116<-ifelse(ID6854DS0$OD116==1,1,
                ifelse(ID6854DS0$OD116==5,0,NA))
ID6854DS0$OD117<-ifelse(ID6854DS0$OD117==1,1,
                 ifelse(ID6854DS0$OD117==5,0,NA))
...
#1=YES
#5=NO
ID6854DS0$OB028<-ifelse(is.na(ID6854DS0$OB028),ID6854DS0$NB028,ID6854DS0$OB028)
ID6854DS0$LAT<-ifelse(ID6854DS0$OB028==1,1,0)
#1=WHITE/CAUCASIAN
#2=BLACK/AFRICAN AM
#97=OTHER (SPECIFY);
#98=DK (don't know);
#99=RF (refused)
ID6854DS0$OB089M1M<-ifelse(is.na(ID6854DS0$OB089M1M),ID6854DS0$NB089M1M,ID6854DS0$OB089M1M)
ID6854DS0$OB089M2M<-ifelse(is.na(ID6854DS0$OB089M2M),ID6854DS0$NB089M2M,ID6854DS0$OB089M2M)
ID6854DS0$OB089M3M<-ifelse(is.na(ID6854DS0$OB089M3M),ID6854DS0$NB089M3M,ID6854DS0$OB089M3M)
ID6854DS0$BLK<-ifelse(((ID6854DS0$OB089M1M==2)|(ID6854DS0$OB089M2M==2)|(ID6854DS0$OB089M3M==2)),1,0)
ID6854DS0$OTH<-ifelse(((ID6854DS0$OB089M1M==97)|(ID6854DS0$OB089M2M==97)|(ID6854DS0$OB089M3M==97)),1,0)
ID6854DS0$WHT<-ifelse(((ID6854DS0$OB089M1M==1)|(ID6854DS0$OB089M2M==1)|(ID6854DS0$OB089M3M==1)),1,0)
...
#1=MALE
#2=FEMALE
ID6854DS0$SEX<-ifelse(ID6854DS0$OX060_R==1,1,
               ifelse(ID6854DS0$OX060_R==2,0,NA))

#Recode age 
ID6854DS0$AGECALC<-ID6854DS0$OA019

#Income, Education, Occupation ----
##Income
ID6854DS0$OQ020[ID6854DS0$OQ020=="99999998"]<-NA
ID6854DS0$OQ020[ID6854DS0$OQ020=="99999999"]<-NA
ID6854DS0$OQ045[ID6854DS0$OQ045=="999998"]<-NA
ID6854DS0$OQ045[ID6854DS0$OQ045=="999999"]<-NA
ID6854DS0$INC<-rowSums(x=cbind(ID6854DS0$OQ020,ID6854DS0$OQ045),na.rm = TRUE)
        
##Education
ID6854DS0$OB014[ID6854DS0$OB014=="97"]<-NA
ID6854DS0$OB014[ID6854DS0$OB014=="98"]<-NA
ID6854DS0$EDU<-pmax(ID6854DS0$EDU,ID6854DS0$OB014,na.rm=TRUE)
...
write.csv(ID6854DS0, file = 'ID6854DS0_2014_recoded.csv')
...
ID6854DS0_2014_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID6854DS0_2014_aggregated, file = 'ID6854DS0_2014_aggregated.csv',row.names = FALSE)
