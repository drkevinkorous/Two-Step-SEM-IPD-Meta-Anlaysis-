#load dataset
library('foreign')
demographics<-read.spss('H02B_R.SAV')
depression<-read.spss('H02D_R.SAV')
income<-read.spss('H02Q_H.sav')
employment<-read.spss('H02J_R.SAV')
other<-read.spss('H02A_R.SAV')
preload<-read.spss('H02PR_R.SAV')
#Merge datasets by Case ID
ID68542002<-merge(demographics,income,by="HHID")
ID68542002$HHIDPN<-paste(ID68542002$HHID,ID68542002$PN,sep = "")
depression$HHIDPN<-paste(depression$HHID,depression$PN,sep = "")
ID68542002<-merge(ID68542002,depression,by="HHIDPN")
employment$HHIDPN<-paste(employment$HHID,employment$PN,sep = "")
ID68542002<-merge(ID68542002,employment,by="HHIDPN")
other$HHIDPN<-paste(other$HHID,other$PN,sep = "")
ID68542002<-merge(ID68542002,other,by="HHIDPN")
preload$HHIDPN<-paste(preload$HHID,preload$PN,sep = "")
ID68542002<-merge(ID68542002,preload,by="HHIDPN")
#Merge prior wave dep symptoms
depressionpw<-read.spss('H00C_R.SAV')
depressionpw$HHIDPN<-paste(depressionpw$HHID,depressionpw$PN,sep = "")
ID68542002<-merge(ID68542002,depressionpw,by="HHIDPN",all.x = TRUE)
#Coded variables
#Participant ID: HHID (household ID); PN (rep ID)
#Measure Name (not a variable in the dataset): CESD
#Depressive symptom items: 
#HD110,HD111,HD112,HD113(RC),HD114,HD115(RC),HD116,HD117
#Depressive symptom items prior wave:
#G1669,G1670,G1671,G1672(RC),G1673,G1674(RC),G1675,G1676
...
#Birth Month: HX004_R
#Birth Day: NA
#Evaluation Year: HA501
#Evaluation Month: HA500
#Evaluation Day: NA
#Participant Income: HQ020  
#Maternal Income: NA
#Paternal Income: NA
#Household Income: HQ020+HQ045(partner)
#Participant Education: HB014A
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: HJ061M 
...
ID6854DS0<-data.frame(HHIDPN,HD110,HD111,HD112,HD113,HD114,HD115,HD116,HD117,
                      G1669,G1670,G1671,G1672,G1673,G1674,G1675,G1676,HB028A,HB031A,
                      HX060_R,HA019,HX067_R,HX004_R,HA501,HA500,HQ020,HQ045,HB014A,HJ061M)

detach(ID68542002)
ID6854DS0$ORIGOBS<-nrow(ID6854DS0)
rm(ID68542002,demographics,depression,employment,income,other,preload,depressionpw)
...
#9=RF (refused)
ID6854DS0$HD110<-ifelse(ID6854DS0$HD110==1,1,
                ifelse(ID6854DS0$HD110==5,0,NA))
ID6854DS0$HD111<-ifelse(ID6854DS0$HD111==1,1,
                ifelse(ID6854DS0$HD111==5,0,NA))                 
ID6854DS0$HD112<-ifelse(ID6854DS0$HD112==1,1,
                ifelse(ID6854DS0$HD112==5,0,NA))
ID6854DS0$HD113<-ifelse(ID6854DS0$HD113==1,0,
                ifelse(ID6854DS0$HD113==5,1,NA))#RC
ID6854DS0$HD114<-ifelse(ID6854DS0$HD114==1,1,
                ifelse(ID6854DS0$HD114==5,0,NA))
ID6854DS0$HD115<-ifelse(ID6854DS0$HD115==1,0,
                ifelse(ID6854DS0$HD115==5,1,NA))#RC
ID6854DS0$HD116<-ifelse(ID6854DS0$HD116==1,1,
                ifelse(ID6854DS0$HD116==5,0,NA))
ID6854DS0$HD117<-ifelse(ID6854DS0$HD117==1,1,
                 ifelse(ID6854DS0$HD117==5,0,NA))
...
#8=DK (don't know); NA (not ascertained)
#9=RF (refused)
ID6854DS0$G1669<-ifelse(ID6854DS0$G1669==1,1,
                ifelse(ID6854DS0$G1669==5,0,NA))
ID6854DS0$G1670<-ifelse(ID6854DS0$G1670==1,1,
                ifelse(ID6854DS0$G1670==5,0,NA))                 
ID6854DS0$G1671<-ifelse(ID6854DS0$G1671==1,1,
                ifelse(ID6854DS0$G1671==5,0,NA))
ID6854DS0$G1672<-ifelse(ID6854DS0$G1672==1,0,
                ifelse(ID6854DS0$G1672==5,1,NA))#RC
ID6854DS0$G1673<-ifelse(ID6854DS0$G1673==1,1,
                ifelse(ID6854DS0$G1673==5,0,NA))
ID6854DS0$G1674<-ifelse(ID6854DS0$G1674==1,0,
                ifelse(ID6854DS0$G1674==5,1,NA))#RC
ID6854DS0$G1675<-ifelse(ID6854DS0$G1675==1,1,
                ifelse(ID6854DS0$G1675==5,0,NA))
ID6854DS0$G1676<-ifelse(ID6854DS0$G1676==1,1,
                 ifelse(ID6854DS0$G1676==5,0,NA))
...
#1=YES
#5=NO
ID6854DS0$LAT<-ifelse(ID6854DS0$HB028A==1,1,0)
#1=WHITE/CAUCASIAN
#2=BLACK/AFRICAN AM
#7=OTHER (SPECIFY);
#8=DK (don't know);
#9=RF (refused)
ID6854DS0$BLK<-ifelse(ID6854DS0$HB031A==2,1,0)
ID6854DS0$OTH<-ifelse(ID6854DS0$HB031A==7,1,0)
ID6854DS0$WHT<-ifelse(ID6854DS0$HB031A==1,1,0)
...
#1=MALE
#2=FEMALE
ID6854DS0$SEX<-ifelse(ID6854DS0$HX060_R==1,1,
               ifelse(ID6854DS0$HX060_R==2,0,NA))

#Recode age 
ID6854DS0$AGECALC<-ID6854DS0$HA019

#Income, Education, Occupation ----
##Income
ID6854DS0$HQ020[ID6854DS0$HQ020=="999998"]<-NA
ID6854DS0$HQ020[ID6854DS0$HQ020=="999999"]<-NA
ID6854DS0$HQ045[ID6854DS0$HQ045=="999998"]<-NA
ID6854DS0$HQ045[ID6854DS0$HQ045=="999999"]<-NA
ID6854DS0$INC<-rowSums(x=cbind(ID6854DS0$HQ020,ID6854DS0$HQ045),na.rm = TRUE)
        
##Education
ID6854DS0$HB014A[ID6854DS0$HB014A=="97"]<-NA
ID6854DS0$HB014A[ID6854DS0$HB014A=="98"]<-NA
ID6854DS0$HB014A[ID6854DS0$HB014A=="99"]<-NA
ID6854DS0$EDU<-ID6854DS0$HB014A
...
write.csv(ID6854DS0, file = 'ID6854DS0_2002_recoded.csv')
...
ID6854DS0_2002_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID6854DS0_2002_aggregated, file = 'ID6854DS0_2002_aggregated.csv',row.names = FALSE)
