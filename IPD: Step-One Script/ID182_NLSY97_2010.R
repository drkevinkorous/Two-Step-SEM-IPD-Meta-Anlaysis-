...
#Depressive symptom items: T6143700,T6143800(RC),T6143900,T6144000(RC),T6144100
#Depressive symptom items prior wave: T2782600,T2782700(RC),T2782800,T2782900(RC),T2783000
#Academic Achievement: 
#college transcripts collected in 2012
#B0004600,B0004700,B0004800,B0004900,B0005000,B0005100,B0005200
#self-report college GPA
#T5470200,T5470300,T5470400,T5470500
#Academic Achievement prior wave: Self-report grade for participants in college
#T2317700,T2317800,T2317900,T2318000,T2318100,T2318200
#Ethnicity: S1224800
#Race: NA
#White: S1224900
#Black: S1224901 
...
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: T6055500 
#Maternal Income: NA
#Paternal Income: NA
#Household Income: T5206900 
#Participant Education: S7683200,T2119900,T5322100
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: T6231000 (2002 census codes) 
...
ID182DS0<-data.frame(R0000100,T6143700,T6143800,T6143900,T6144000,T6144100,T2782600,T2782700,T2782800,T2782900,T2783000,
                     B0004600,B0004700,B0004800,B0004900,B0005000,B0005100,B0005200,T5470200,T5470300,T5470400,T5470500,
                     T2317700,T2317800,T2317900,T2318000,T2318100,T2318200,
                     S1224800,S1224900,S1224901,S1224902,S1224903,S1224904,S1224905,R0536300,
                     T5201400,R0536402,R0536401,T6055500,T5206900,S7683200,T2119900,T5322100,T6231000)
detach(merged182)
...
ID182DS0$T6143700<-ifelse(ID182DS0$T6143700=="All of the time",3,                 
                   ifelse(ID182DS0$T6143700=="Most of the time",2, 
                   ifelse(ID182DS0$T6143700=="Some of the time",1,       
                   ifelse(ID182DS0$T6143700=="None of the time",0,NA))))
ID182DS0$T6143800<-ifelse(ID182DS0$T6143800=="All of the time",0,                 
                   ifelse(ID182DS0$T6143800=="Most of the time",1, 
                   ifelse(ID182DS0$T6143800=="Some of the time",2,       
                   ifelse(ID182DS0$T6143800=="None of the time",3,NA))))#RC
ID182DS0$T6143900<-ifelse(ID182DS0$T6143900=="All of the time",3,                 
                   ifelse(ID182DS0$T6143900=="Most of the time",2, 
                   ifelse(ID182DS0$T6143900=="Some of the time",1,       
                   ifelse(ID182DS0$T6143900=="None of the time",0,NA))))
ID182DS0$T6144000<-ifelse(ID182DS0$T6144000=="All of the time",0,                 
                   ifelse(ID182DS0$T6144000=="Most of the time",1, 
                   ifelse(ID182DS0$T6144000=="Some of the time",2,       
                   ifelse(ID182DS0$T6144000=="None of the time",3,NA))))#RC
ID182DS0$T6144100<-ifelse(ID182DS0$T6144100=="All of the time",3,                 
                   ifelse(ID182DS0$T6144100=="Most of the time",2, 
                   ifelse(ID182DS0$T6144100=="Some of the time",1,       
                   ifelse(ID182DS0$T6144100=="None of the time",0,NA))))

#Depressive symptoms prior wave 
ID182DS0$T2782600<-ifelse(ID182DS0$T2782600=="All of the time",3,                 
                   ifelse(ID182DS0$T2782600=="Most of the time",2, 
                   ifelse(ID182DS0$T2782600=="Some of the time",1,       
                   ifelse(ID182DS0$T2782600=="None of the time",0,NA))))
ID182DS0$T2782700<-ifelse(ID182DS0$T2782700=="All of the time",0,                 
                   ifelse(ID182DS0$T2782700=="Most of the time",1, 
                   ifelse(ID182DS0$T2782700=="Some of the time",2,       
                   ifelse(ID182DS0$T2782700=="None of the time",3,NA))))#RC
ID182DS0$T2782800<-ifelse(ID182DS0$T2782800=="All of the time",3,                 
                   ifelse(ID182DS0$T2782800=="Most of the time",2, 
                   ifelse(ID182DS0$T2782800=="Some of the time",1,       
                   ifelse(ID182DS0$T2782800=="None of the time",0,NA))))
ID182DS0$T2782900<-ifelse(ID182DS0$T2782900=="All of the time",0,                 
                   ifelse(ID182DS0$T2782900=="Most of the time",1, 
                   ifelse(ID182DS0$T2782900=="Some of the time",2,       
                   ifelse(ID182DS0$T2782900=="None of the time",3,NA))))#RC
ID182DS0$T2783000<-ifelse(ID182DS0$T2783000=="All of the time",3,                 
                   ifelse(ID182DS0$T2783000=="Most of the time",2, 
                   ifelse(ID182DS0$T2783000=="Some of the time",1,       
                   ifelse(ID182DS0$T2783000=="None of the time",0,NA))))
...
ID182DS0$B0004600<-colGPArecode(ID182DS0$B0004600)
ID182DS0$B0004700<-colGPArecode(ID182DS0$B0004700)
ID182DS0$B0004800<-colGPArecode(ID182DS0$B0004800)
ID182DS0$B0004900<-colGPArecode(ID182DS0$B0004900)
ID182DS0$B0005000<-colGPArecode(ID182DS0$B0005000)
ID182DS0$B0005100<-colGPArecode(ID182DS0$B0005100)
ID182DS0$B0005200<-colGPArecode(ID182DS0$B0005200)
gpatranscrpt<-rowMeans(x=cbind(ID182DS0$B0004600,ID182DS0$B0004700,ID182DS0$B0004800,
                               ID182DS0$B0004900,ID182DS0$B0005000,ID182DS0$B0005100,
                               ID182DS0$B0005200 ),na.rm = TRUE)
ID182DS0$T5470200<-colGPArecode(ID182DS0$T5470200)
ID182DS0$T5470300<-colGPArecode(ID182DS0$T5470300)
ID182DS0$T5470400<-colGPArecode(ID182DS0$T5470400)
ID182DS0$T5470500<-colGPArecode(ID182DS0$T5470500)
gpasr<-rowMeans(x=cbind(ID182DS0$T5470200,ID182DS0$T5470300,ID182DS0$T5470400,ID182DS0$T5470500),na.rm = TRUE)
ID182DS0$ACHV<-rowMeans(x=cbind(gpatranscrpt,gpasr),na.rm = TRUE)

#Recode Academic Achievement (prior wave)
ID182DS0$T2317700<-colGPArecode(ID182DS0$T2317700)
ID182DS0$T2317800<-colGPArecode(ID182DS0$T2317800)
ID182DS0$T2317900<-colGPArecode(ID182DS0$T2317900)
ID182DS0$T2318000<-colGPArecode(ID182DS0$T2318000)
ID182DS0$T2318100<-colGPArecode(ID182DS0$T2318100)
ID182DS0$T2318200<-colGPArecode(ID182DS0$T2318200)
ID182DS0$ACHVPW<-rowMeans(x=cbind(ID182DS0$T2317700,ID182DS0$T2317800,ID182DS0$T2317900,
                                  ID182DS0$T2318000,ID182DS0$T2318100,ID182DS0$T2318200),na.rm = TRUE)
...
#Recode age 
ID182DS0$AGECALC<-ID182DS0$T5201400

#Income, Education, Occupation ----
##Income
#Take highest income reported
ID182DS0$INC<-pmax(ID182DS0$T6055500,ID182DS0$T5206900,na.rm = TRUE)

##Education
ID182DS0$S7683200<-ifelse(ID182DS0$S7683200=="1ST GRADE",1,         
                   ifelse(ID182DS0$S7683200=="2ND GRADE",2,          
                   ifelse(ID182DS0$S7683200=="3RD GRADE",3,         
                   ifelse(ID182DS0$S7683200=="4TH GRADE",4,          
                   ifelse(ID182DS0$S7683200=="5TH GRADE",5,         
                   ifelse(ID182DS0$S7683200=="6TH GRADE",6,          
                   ifelse(ID182DS0$S7683200=="7TH GRADE",7,         
                   ifelse(ID182DS0$S7683200=="8TH GRADE",8,          
                   ifelse(ID182DS0$S7683200=="9TH GRADE",9,         
                   ifelse(ID182DS0$S7683200=="10TH GRADE",10,         
                   ifelse(ID182DS0$S7683200=="11TH GRADE",11,        
                   ifelse(ID182DS0$S7683200=="12TH GRADE",12,         
                   ifelse(ID182DS0$S7683200=="1ST YEAR COLLEGE",13,        
                   ifelse(ID182DS0$S7683200=="2ND YEAR COLLEGE",14,         
                   ifelse(ID182DS0$S7683200=="3RD YEAR COLLEGE",15,        
                   ifelse(ID182DS0$S7683200=="4TH YEAR COLLEGE",16,         
                   ifelse(ID182DS0$S7683200=="5TH YEAR COLLEGE",17,        
                   ifelse(ID182DS0$S7683200=="6TH YEAR COLLEGE",18,         
                   ifelse(ID182DS0$S7683200=="7TH YEAR COLLEGE",19,        
                   ifelse(ID182DS0$S7683200=="8TH YEAR COLLEGE OR MORE",20,NA))))))))))))))))))))
ID182DS0$T2119900<-ifelse(ID182DS0$T2119900=="1ST GRADE",1,         
                   ifelse(ID182DS0$T2119900=="2ND GRADE",2,          
                   ifelse(ID182DS0$T2119900=="3RD GRADE",3,         
                   ifelse(ID182DS0$T2119900=="4TH GRADE",4,          
                   ifelse(ID182DS0$T2119900=="5TH GRADE",5,         
                   ifelse(ID182DS0$T2119900=="6TH GRADE",6,          
                   ifelse(ID182DS0$T2119900=="7TH GRADE",7,         
                   ifelse(ID182DS0$T2119900=="8TH GRADE",8,          
                   ifelse(ID182DS0$T2119900=="9TH GRADE",9,         
                   ifelse(ID182DS0$T2119900=="10TH GRADE",10,         
                   ifelse(ID182DS0$T2119900=="11TH GRADE",11,        
                   ifelse(ID182DS0$T2119900=="12TH GRADE",12,         
                   ifelse(ID182DS0$T2119900=="1ST YEAR COLLEGE",13,        
                   ifelse(ID182DS0$T2119900=="2ND YEAR COLLEGE",14,         
                   ifelse(ID182DS0$T2119900=="3RD YEAR COLLEGE",15,        
                   ifelse(ID182DS0$T2119900=="4TH YEAR COLLEGE",16,         
                   ifelse(ID182DS0$T2119900=="5TH YEAR COLLEGE",17,        
                   ifelse(ID182DS0$T2119900=="6TH YEAR COLLEGE",18,         
                   ifelse(ID182DS0$T2119900=="7TH YEAR COLLEGE",19,        
                   ifelse(ID182DS0$T2119900=="8TH YEAR COLLEGE OR MORE",20,NA))))))))))))))))))))    
ID182DS0$T5322100<-ifelse(ID182DS0$T5322100=="1ST GRADE",1,         
                   ifelse(ID182DS0$T5322100=="2ND GRADE",2,          
                   ifelse(ID182DS0$T5322100=="3RD GRADE",3,         
                   ifelse(ID182DS0$T5322100=="4TH GRADE",4,          
                   ifelse(ID182DS0$T5322100=="5TH GRADE",5,         
                   ifelse(ID182DS0$T5322100=="6TH GRADE",6,          
                   ifelse(ID182DS0$T5322100=="7TH GRADE",7,         
                   ifelse(ID182DS0$T5322100=="8TH GRADE",8,          
                   ifelse(ID182DS0$T5322100=="9TH GRADE",9,         
                   ifelse(ID182DS0$T5322100=="10TH GRADE",10,         
                   ifelse(ID182DS0$T5322100=="11TH GRADE",11,        
                   ifelse(ID182DS0$T5322100=="12TH GRADE",12,         
                   ifelse(ID182DS0$T5322100=="1ST YEAR COLLEGE",13,        
                   ifelse(ID182DS0$T5322100=="2ND YEAR COLLEGE",14,         
                   ifelse(ID182DS0$T5322100=="3RD YEAR COLLEGE",15,        
                   ifelse(ID182DS0$T5322100=="4TH YEAR COLLEGE",16,         
                   ifelse(ID182DS0$T5322100=="5TH YEAR COLLEGE",17,        
                   ifelse(ID182DS0$T5322100=="6TH YEAR COLLEGE",18,         
                   ifelse(ID182DS0$T5322100=="7TH YEAR COLLEGE",19,        
                   ifelse(ID182DS0$T5322100=="8TH YEAR COLLEGE OR MORE",20,NA))))))))))))))))))))  
#Not all participants answered education, use prior wave for missing data
ID182DS0$EDU<-pmax(ID182DS0$S7683200,ID182DS0$T2119900,ID182DS0$T5322100,na.rm = TRUE)
...
occ_codes<-read.csv('IPD182DS0_NLSY97_2010_Occupational codes.csv')
...
ID182DS0$T6231000<-factor(ID182DS0$T6231000)
ID182DS0$OCCS<-as.numeric(as.character(occstatusvalues[ match(ID182DS0$T6231000, occvalues) ]))
...
ID182DS0$T6231000<-factor(ID182DS0$T6231000)
ID182DS0$OCCP<-as.numeric(as.character(occprestvalues[ match(ID182DS0$T6231000, occvalues) ]))

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID182DS0, file = 'ID182NLSY97_2010_recoded.csv')
...
#Select variables for correlation matrix
LATYDFCmatrixvars<-matrixvars[-12]
...
#Select variables for correlation matrix
LATYDMCmatrixvars<-matrixvars[-12]
...
#Select variables for correlation matrix
BLKYDMCmatrixvars<-matrixvars[-12]
...
#Select variables for correlation matrix
AIATFCmatrixvars<-matrixvars[-c(12)]
...
#Select variables for correlation matrix
AIATMCmatrixvars<-matrixvars[-c(12)]
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AIATM[2:6], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AIATM[2:6], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
write.csv(ID182DS0_aggregated, file = 'ID182NLSY97_2010_aggregated.csv',row.names = FALSE)
