...
merged171<-merged171[which(merged171$TYPE.x=="S"),]
#Load W1 for educaton
load(file = '06041-0001-Data.rda')
merged171<-merge(merged171,da06041.0001,by="MCASEID")
#Load W2 for race and prior wave dep symptoms
load('06906-0002-Data.rda')
merged171<-merge(merged171,da06906.0002,by="MCASEID",all.x = TRUE)
load('06906-0005-Data.rda') #main spouse/partner prior wave dep symptoms
merged171<-merge(merged171,da06906.0005,by="MCASEID",all.x = TRUE)
#Coded variables
...
ID171DS1<-data.frame(MCASEID,RT206A,RT206B,RT206C,RT206D,RT206E,RT206F,RT206G,RT206H,RT206I,RT206J,
                     RT206K,RT206L,CT206A,CT206B,CT206C,CT206D,CT206E,CT206F,CT206G,CT206H,CT206I,
                     CT206J,CT206K,CT206L,CH27,SEX_A,DOBY,DOBM,IDATYY,IDATMM,RQ2,RQ6P01,RQ6P02,
                     S175,RP10OCC) 
detach(merged171)
ID171DS1$ORIGOBS<-nrow(ID171DS1)
rm(merged171,da06041.0001,da06906.0002,da06906.0005,da00171.0001,da00171.0002)
...
#Occasionally or a moderate amount of time: 3-4 days (code as 2)
#Most or all of the time: 5 - 7 days (Code as 3)
ID171DS1$CT206A<-ifelse(ID171DS1$CT206A==0,0,
                  ifelse(((ID171DS1$CT206A==1)|(ID171DS1$CT206A==2)),1,
                  ifelse(((ID171DS1$CT206A==3)|(ID171DS1$CT206A==4)),2,
                  ifelse(ID171DS1$CT206A>=5,3,NA))))
ID171DS1$CT206B<-ifelse(ID171DS1$CT206B==0,0,
                  ifelse(((ID171DS1$CT206B==1)|(ID171DS1$CT206B==2)),1,
                  ifelse(((ID171DS1$CT206B==3)|(ID171DS1$CT206B==4)),2,
                  ifelse(ID171DS1$CT206B>=5,3,NA))))
ID171DS1$CT206C<-ifelse(ID171DS1$CT206C==0,0,
                  ifelse(((ID171DS1$CT206C==1)|(ID171DS1$CT206C==2)),1,
                  ifelse(((ID171DS1$CT206C==3)|(ID171DS1$CT206C==4)),2,
                  ifelse(ID171DS1$CT206C>=5,3,NA))))
ID171DS1$CT206D<-ifelse(ID171DS1$CT206D==0,0,
                  ifelse(((ID171DS1$CT206D==1)|(ID171DS1$CT206D==2)),1,
                  ifelse(((ID171DS1$CT206D==3)|(ID171DS1$CT206D==4)),2,
                  ifelse(ID171DS1$CT206D>=5,3,NA))))
ID171DS1$CT206E<-ifelse(ID171DS1$CT206E==0,0,
                  ifelse(((ID171DS1$CT206E==1)|(ID171DS1$CT206E==2)),1,
                  ifelse(((ID171DS1$CT206E==3)|(ID171DS1$CT206E==4)),2,
                  ifelse(ID171DS1$CT206E>=5,3,NA))))
ID171DS1$CT206F<-ifelse(ID171DS1$CT206F==0,0,
                  ifelse(((ID171DS1$CT206F==1)|(ID171DS1$CT206F==2)),1,
                  ifelse(((ID171DS1$CT206F==3)|(ID171DS1$CT206F==4)),2,
                  ifelse(ID171DS1$CT206F>=5,3,NA))))
ID171DS1$CT206G<-ifelse(ID171DS1$CT206G==0,0,
                  ifelse(((ID171DS1$CT206G==1)|(ID171DS1$CT206G==2)),1,
                  ifelse(((ID171DS1$CT206G==3)|(ID171DS1$CT206G==4)),2,
                  ifelse(ID171DS1$CT206G>=5,3,NA))))
ID171DS1$CT206H<-ifelse(ID171DS1$CT206H==0,0,
                  ifelse(((ID171DS1$CT206H==1)|(ID171DS1$CT206H==2)),1,
                  ifelse(((ID171DS1$CT206H==3)|(ID171DS1$CT206H==4)),2,
                  ifelse(ID171DS1$CT206H>=5,3,NA))))
ID171DS1$CT206I<-ifelse(ID171DS1$CT206I==0,0,
                  ifelse(((ID171DS1$CT206I==1)|(ID171DS1$CT206I==2)),1,
                  ifelse(((ID171DS1$CT206I==3)|(ID171DS1$CT206I==4)),2,
                  ifelse(ID171DS1$CT206I>=5,3,NA))))
ID171DS1$CT206J<-ifelse(ID171DS1$CT206J==0,0,
                  ifelse(((ID171DS1$CT206J==1)|(ID171DS1$CT206J==2)),1,
                  ifelse(((ID171DS1$CT206J==3)|(ID171DS1$CT206J==4)),2,
                  ifelse(ID171DS1$CT206J>=5,3,NA))))
ID171DS1$CT206K<-ifelse(ID171DS1$CT206K==0,0,
                  ifelse(((ID171DS1$CT206K==1)|(ID171DS1$CT206K==2)),1,
                  ifelse(((ID171DS1$CT206K==3)|(ID171DS1$CT206K==4)),2,
                  ifelse(ID171DS1$CT206K>=5,3,NA))))
ID171DS1$CT206L<-ifelse(ID171DS1$CT206L==0,0,
                  ifelse(((ID171DS1$CT206L==1)|(ID171DS1$CT206L==2)),1,
                  ifelse(((ID171DS1$CT206L==3)|(ID171DS1$CT206L==4)),2,
                  ifelse(ID171DS1$CT206L>=5,3,NA))))
...
ID171DS1$LAT<-ifelse(((ID171DS1$CH27 == "(03) MEX AMER/CHICANO/MEXICANO")|
                      (ID171DS1$CH27 == "(04) PUERTO RICAN")|
                      (ID171DS1$CH27 == "(05) CUBAN")),1,0)
ID171DS1$WHT<-ifelse(ID171DS1$CH27=="(02) WHITE-NON-HISP",1,0)
ID171DS1$BLK<-ifelse(ID171DS1$CH27=="(01) BLACK",1,0)
ID171DS1$AI<-ifelse(ID171DS1$CH27=="(06) AMERICAN INDIAN",1,0)
ID171DS1$AA<-ifelse(ID171DS1$CH27=="(07) ASIAN",1,0)
ID171DS1$OTH<-ifelse(ID171DS1$CH27=="(77) OTHER",1,0)
...
write.csv(ID171DS1, file = 'ID171DS1_S_recoded.csv')
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=LATOAF[2:13], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=LATOAF[2:13], type = "omega", interval.type = "none")
...
ID171DS1_S_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID171DS1_S_aggregated, file = 'ID171DS1_S_aggregated.csv',row.names = FALSE)
