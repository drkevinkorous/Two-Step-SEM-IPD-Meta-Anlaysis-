#Load data
library('foreign')
da09211.0001<-read.spss('09211-0001-Data.sav') #Data was downloaded in ASCII format and setup in SPSS
#Coded variables
#Participant ID: NA
#Measure Name (not a variable in the dataset): PERI-D
#Depressive symptom items: 
#Q63D,Q63F,Q63H,Q63I,Q63J (Q64 left out due to a different scale system)
...
#Household Education: F3HR,F3WR
#Participant Occupation: NA 
#Maternal Occupation: NA
#Paternal Occupation: NA
#Household Occupation: Q5H,Q5W
#SES: NA
#Year of data collection (not a variable in the dataset): 1985
#Notes: Physical Violence in American Families, 1985

#Create Dataset ----
attach(da09211.0001)
#Extract relevant variables into a dataframe.
ID9211DS1<-data.frame(Q63D,Q63F,Q63H,Q63I,Q63J,F5,SEXR,Q1,F6,F3HR,F3WR,Q5H,Q5W)
detach(da09211.0001)
ID9211DS1$ORIGOBS<-nrow(ID9211DS1)
rm(da09211.0001)
...
#Depressive Symptoms ---------
ID9211DS1$Q63D<-ifelse(ID9211DS1$Q63D=="NEVER",0,
                ifelse(ID9211DS1$Q63D=="ALMT NVR",1,     
                ifelse(ID9211DS1$Q63D=="SOMETIMES",2,    
                ifelse(ID9211DS1$Q63D=="FAIRLY OFTEN",3,
                ifelse(ID9211DS1$Q63D=="VRY OFTEN",4,NA)))))  
ID9211DS1$Q63F<-ifelse(ID9211DS1$Q63F=="NEVER",0,
                ifelse(ID9211DS1$Q63F=="ALMT NVR",1,     
                ifelse(ID9211DS1$Q63F=="SOMETIMES",2,    
                ifelse(ID9211DS1$Q63F=="FAIRLY OFTEN",3,
                ifelse(ID9211DS1$Q63F=="VRY OFTEN",4,NA)))))  
ID9211DS1$Q63H<-ifelse(ID9211DS1$Q63H=="NEVER",0,
                ifelse(ID9211DS1$Q63H=="ALMT NVR",1,     
                ifelse(ID9211DS1$Q63H=="SOMETIMES",2,    
                ifelse(ID9211DS1$Q63H=="FAIRLY OFTEN",3,
                ifelse(ID9211DS1$Q63H=="VRY OFTEN",4,NA)))))  
ID9211DS1$Q63I<-ifelse(ID9211DS1$Q63I=="NEVER",0,
                ifelse(ID9211DS1$Q63I=="ALMT NVR",1,     
                ifelse(ID9211DS1$Q63I=="SOMETIMES",2,    
                ifelse(ID9211DS1$Q63I=="FAIRLY OFTEN",3,
                ifelse(ID9211DS1$Q63I=="VRY OFTEN",4,NA)))))  
ID9211DS1$Q63J<-ifelse(ID9211DS1$Q63J=="NEVER",0,
                ifelse(ID9211DS1$Q63J=="ALMT NVR",1,     
                ifelse(ID9211DS1$Q63J=="SOMETIMES",2,    
                ifelse(ID9211DS1$Q63J=="FAIRLY OFTEN",3,
                ifelse(ID9211DS1$Q63J=="VRY OFTEN",4,NA)))))  
...
dsitems <- ID9211DS1[c(1:5)]
#dsitemspw <- ID9211DS1[c(:)]
#Identify participants missing more than half of dsitems (not dsitemsW1) (1=missing > 50%) - to be used later
ID9211DS1$dsmiss<-ifelse(rowSums(is.na(dsitems))>((ncol(dsitems)/2)),1,0)
#Compute mean symptom score 
ID9211DS1$DEP<-rowMeans(x=dsitems,na.rm=TRUE)
ID9211DS1$DEPPW<-NA#rowMeans(x=dsitemspw,na.rm=TRUE)
...
ID9211DS1$LAT<-ifelse(((ID9211DS1$F5 == "HISPANIC")|(ID9211DS1$F5 == "HIS-BK")), 1, 0)
ID9211DS1$WHT<-ifelse(ID9211DS1$F5=="WHITE",1,0)
ID9211DS1$BLK<-ifelse(ID9211DS1$F5=="BLACK",1,0)
ID9211DS1$AI<-ifelse(ID9211DS1$F5=="AM IND",1,0)
ID9211DS1$AA<-ifelse(((ID9211DS1$F5=="ASIAN")|(ID9211DS1$F5=="PACFC IS")),1,0)
ID9211DS1$OTH<-NA

#Compute variable for participants who reported more than one race (mixed/biracial; do not include Latino)
ID9211DS1$MR<-NA#ifelse((rowSums(x=cbind(ID9211DS1$WHT,ID9211DS1$BLK,ID9211DS1$AI,ID9211DS1$AA,
#                                       ID9211DS1$OTH),na.rm=TRUE)) > 1, 1, 0)

##Compute variables for participants who reported a single race (excluding mixed/biracial & Latino)
#ID9211DS1$WHT<-ifelse(((ID9211DS1$LAT == 0)&(ID9211DS1$MR == 0)&(ID9211DS1$WHT == 1)), 1, 0)
#ID9211DS1$BLK<-ifelse(((ID9211DS1$LAT == 0)&(ID9211DS1$MR == 0)&(ID9211DS1$BLK == 1)), 1, 0)
#ID9211DS1$AI<-ifelse(((ID9211DS1$LAT == 0)&(ID9211DS1$MR == 0)&(ID9211DS1$AI == 1)), 1, 0)
#ID9211DS1$AA<-ifelse(((ID9211DS1$LAT == 0)&(ID9211DS1$MR == 0)&(ID9211DS1$AA == 1)), 1, 0)
#ID9211DS1$OTH<-ifelse(((ID9211DS1$LAT == 0)&(ID9211DS1$MR == 0)&(ID9211DS1$OTH == 1)), 1, 0)
#ID9211DS1$MR<-ifelse(((ID9211DS1$LAT == 0)&(ID9211DS1$MR == 1)), 1, 0)

#Recode sex
ID9211DS1$SEX<-ifelse(ID9211DS1$SEXR == "MALE", 1, 0)

#Recode age 
ID9211DS1$AGECALC<-as.numeric(as.character(ID9211DS1$Q1))

#Income, Education, Occupation ----
##Income   
ID9211DS1$INC<-ifelse(ID9211DS1$F6=="NONE",0,    
               ifelse(ID9211DS1$F6=="LE 5000",4999, 
               ifelse(ID9211DS1$F6==">5-10",7500,   
               ifelse(ID9211DS1$F6==">10-15",12500,  
               ifelse(ID9211DS1$F6==">15-20",17500, 
               ifelse(ID9211DS1$F6==">20-25",22500,  
               ifelse(ID9211DS1$F6==">25-30",27500,  
               ifelse(ID9211DS1$F6==">30-35",32500, 
               ifelse(ID9211DS1$F6==">35-40",37500,  
               ifelse(ID9211DS1$F6==">40-45",42500, 
               ifelse(ID9211DS1$F6==">45-50",47500,  
               ifelse(ID9211DS1$F6==">50",51000,NA))))))))))))

##Education 
ID9211DS1$F3HR<-ifelse(ID9211DS1$F3HR=="NO EDUC.THRU 8TH",4.5,    
                ifelse(ID9211DS1$F3HR=="SOME HIGH SCH.",10.5,     
                ifelse(ID9211DS1$F3HR=="HIGH SCHOOL GRAD.",12,   
                ifelse(ID9211DS1$F3HR=="SOME COLLEGE",14,       
                ifelse(ID9211DS1$F3HR=="COLLEGE GRAD.AND UP",16,NA)))))
ID9211DS1$F3WR<-ifelse(ID9211DS1$F3WR=="NO EDUC.THRU 8TH",4.5,    
                ifelse(ID9211DS1$F3WR=="SOME HIGH SCH.",10.5,     
                ifelse(ID9211DS1$F3WR=="HIGH SCHOOL GRAD.",12,   
                ifelse(ID9211DS1$F3WR=="SOME COLLEGE",14,       
                ifelse(ID9211DS1$F3WR=="COLLEGE GRAD.AND UP",16,NA)))))   
ID9211DS1$EDU<-pmax(ID9211DS1$F3HR,ID9211DS1$F3WR,na.rm = TRUE)

##Occupation
#Nam-Powers-Boyd scale (Nam & Boyd, 2008) 
occ_codes<-read.csv('ID9211DS1_Occupational codes.csv')
...
ID9211DS1$Q5Hstatus<-as.numeric(as.character(occstatusvalues[ match(ID9211DS1$Q5H, occvalues) ]))
ID9211DS1$Q5Wstatus<-as.numeric(as.character(occstatusvalues[ match(ID9211DS1$Q5W, occvalues) ]))
ID9211DS1$OCCS<-pmax(ID9211DS1$Q5Hstatus,ID9211DS1$Q5Wstatus,na.rm=TRUE)
...
ID9211DS1$Q5Hprest<-as.numeric(as.character(occprestvalues[ match(ID9211DS1$Q5H, occvalues) ]))
ID9211DS1$Q5Wprest<-as.numeric(as.character(occprestvalues[ match(ID9211DS1$Q5W, occvalues) ]))
ID9211DS1$OCCP<-pmax(ID9211DS1$Q5Hprest,ID9211DS1$Q5Wprest,na.rm=TRUE)

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID9211DS1, file = 'ID9211DS1_recoded.csv')

#Descriptives and Correlations -----
#Exclude participants with more than 50% missing on depressive symptoms items
ID9211DS1 <- ID9211DS1[which(ID9211DS1$dsmiss==0), ]

##Compute mean and sd across all participants within dataset
library('psych')
#Means & SDs of focal variables
dstatsage<-describe(ID9211DS1$AGECALC)
dstatsdep<-describe(ID9211DS1$DEP)
dstatsachv<-NA#describe(ID9211DS1$ACHV)
dstatsinc<-describe(ID9211DS1$INC)
dstatsedu<-describe(ID9211DS1$EDU)
dstatsoccs<-describe(ID9211DS1$OCCS)
dstatsoccp<-describe(ID9211DS1$OCCP)

#Save descriptive stats
dstats<-rbind(dstatsage,dstatsdep,dstatsachv,dstatsinc,dstatsedu,dstatsoccs,dstatsoccp,make.row.names= FALSE)
write.csv(dstats,file = 'ID9211DS1_dstats.csv',
          row.names=c("dstatsage","dstatsdep","dstatsachv","dstatsinc","dstatsedu","dstatsoccs","dstatsoccp"))

##Histograms 
pdf('ID9211DS1_dephist.pdf')
hist(ID9211DS1$DEP, xlab="Depressive Symptoms", main = NULL, col="grey")
dev.off()
#pdf('ID9211DS1_achvhist.pdf')
#hist(ID9211DS1$ACHV, xlab="Academic Achievement", main = NULL, col="grey")
#dev.off()
pdf('ID9211DS1_inchist.pdf')
hist(ID9211DS1$INC, xlab="Income", main = NULL, col="grey")
dev.off()
pdf('ID9211DS1_educhist.pdf')
hist(ID9211DS1$EDU, xlab="Educational Attainment", main = NULL, col="grey")
dev.off()
pdf('ID9211DS1_occshist.pdf')
hist(ID9211DS1$OCCS, xlab="Occupational Status", main = NULL, col="grey")
dev.off()
pdf('ID9211DS1_occphist.pdf')
hist(ID9211DS1$OCCP, xlab="Occupational Prestige", main = NULL, col="grey")
dev.off()
...
table(ID9211DS1$AGECALC)
#Separate dataset by developmental period, if needed
#CH<-ID9211DS1[which((ID9211DS1$AGECALC >= 5)&(ID9211DS1$AGECALC <= 11)), ] 
#AD<-ID9211DS1[which((ID9211DS1$AGECALC >= 12)&(ID9211DS1$AGECALC <= 17)), ]
YD<-ID9211DS1[which((ID9211DS1$AGECALC >= 18)&(ID9211DS1$AGECALC <= 25)), ]
AT<-ID9211DS1[which((ID9211DS1$AGECALC >= 26)&(ID9211DS1$AGECALC <= 64)), ]
OA<-ID9211DS1[which(ID9211DS1$AGECALC >= 65), ]
...
##Assign ICPSR ID number (ICPSR Number; e.g., file name = ID9211DS1, then DATAID = 21600)
#DATAID<-'9211'
#names(DATAID)<-'DATAID'
...
#ALPHAOV <- ci.reliability(data=WHTCHF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTCHM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTADF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTADF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTADM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTADM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTYDF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTYDF[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTYDM[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTYDM[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTATF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTATF[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTATM[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTATM[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTOAF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTOAF[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTOAM[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTOAM[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#names(DATAYEAR)<-'DATAYEAR'
##Compute reliability estimates
#ALPHAOV <- ci.reliability(data=LATCHF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATCHM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#names(DATAYEAR)<-'DATAYEAR'
##Compute reliability estimates
#ALPHAOV <- ci.reliability(data=LATADF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATADF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATADM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATADM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATYDF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATYDF[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATYDM[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATYDM[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATATF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATATF[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATATM[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATATM[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATOAF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATOAF[1:5], type = "omega", interval.type = "none")
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATOAM[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATOAM[1:5], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKADF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKADF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKADM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKADM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKYDF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKYDF[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKYDM[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKYDM[1:5], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKATF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKATF[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKATM[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKATM[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKOAF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKOAF[1:5], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKOAM[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKOAM[1:5], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHMC[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHMC[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AAYDF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AAYDF[1:5], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAYDM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAYDM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AAATF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AAATF[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AAATM[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AAATM[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AIYDF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AIYDF[1:5], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AIYDM[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AIYDM[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AIATF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AIATF[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AIATM[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AIATM[1:5], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AIOAF[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AIOAF[1:5], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AIOAM[1:5], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AIOAM[1:5], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRYDF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRYDF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRYDM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRYDM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRATF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRATF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRATM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRATM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MROAF[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MROAF[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MROAM[1:5], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MROAM[1:5], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
ID9211DS1_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID9211DS1_aggregated, file = 'ID9211DS1_aggregated.csv',row.names = FALSE)