...
#Depressive symptom items: T2782600,T2782700(RC),T2782800,T2782900(RC),T2783000
#Depressive symptom items prior wave: S8332300,S8332400(RC),S8332500,S8332600(RC),S8332700
#Academic Achievement: self-report college GPA only
...
#S7888600,S7888700,S7888800,S7888900,S7889000
#Ethnicity: S1224800
#Race: NA
#White: S1224900
#Black: S1224901 
...
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: T3003000 
#Maternal Income: NA
#Paternal Income: NA
#Household Income: T2016200 
#Participant Education: S7683200,T2119900 
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: T3186900 (2002 census codes) 
...
ID182DS0<-data.frame(R0000100,T2782600,T2782700,T2782800,T2782900,T2783000,S8332300,S8332400,S8332500,S8332600,S8332700,
                     T2317700,T2317800,T2317900,T2318000,T2318100,T2318200,S7888600,S7888700,S7888800,S7888900,S7889000,
                     S1224800,S1224900,S1224901,S1224902,S1224903,S1224904,S1224905,R0536300,
                     T2011100,R0536402,R0536401,T3003000,T2016200,S7683200,T2119900,T3186900)
detach(merged182)
...
ID182DS0$S8332300<-ifelse(ID182DS0$S8332300=="All of the time",3,                 
                   ifelse(ID182DS0$S8332300=="Most of the time",2, 
                   ifelse(ID182DS0$S8332300=="Some of the time",1,       
                   ifelse(ID182DS0$S8332300=="None of the time",0,NA))))
ID182DS0$S8332400<-ifelse(ID182DS0$S8332400=="All of the time",0,                 
                   ifelse(ID182DS0$S8332400=="Most of the time",1, 
                   ifelse(ID182DS0$S8332400=="Some of the time",2,       
                   ifelse(ID182DS0$S8332400=="None of the time",3,NA))))#RC
ID182DS0$S8332500<-ifelse(ID182DS0$S8332500=="All of the time",3,                 
                   ifelse(ID182DS0$S8332500=="Most of the time",2, 
                   ifelse(ID182DS0$S8332500=="Some of the time",1,       
                   ifelse(ID182DS0$S8332500=="None of the time",0,NA))))
ID182DS0$S8332600<-ifelse(ID182DS0$S8332600=="All of the time",0,                 
                   ifelse(ID182DS0$S8332600=="Most of the time",1, 
                   ifelse(ID182DS0$S8332600=="Some of the time",2,       
                   ifelse(ID182DS0$S8332600=="None of the time",3,NA))))#RC
ID182DS0$S8332700<-ifelse(ID182DS0$S8332700=="All of the time",3,                 
                   ifelse(ID182DS0$S8332700=="Most of the time",2, 
                   ifelse(ID182DS0$S8332700=="Some of the time",1,       
                   ifelse(ID182DS0$S8332700=="None of the time",0,NA))))
...
ID182DS0$ACHV<-rowMeans(x=cbind(ID182DS0$T2317700,ID182DS0$T2317800,ID182DS0$T2317900,
                                ID182DS0$T2318000,ID182DS0$T2318100,ID182DS0$T2318200),na.rm = TRUE)

#Recode Academic Acehievement (prior wave)
ID182DS0$S7888600<-colGPArecode(ID182DS0$S7888600)
ID182DS0$S7888700<-colGPArecode(ID182DS0$S7888700)
ID182DS0$S7888800<-colGPArecode(ID182DS0$S7888800)
ID182DS0$S7888900<-colGPArecode(ID182DS0$S7888900)
ID182DS0$S7889000<-colGPArecode(ID182DS0$S7889000)
ID182DS0$ACHVPW<-rowMeans(x=cbind(ID182DS0$S7888600,ID182DS0$S7888700,ID182DS0$S7888800,
                                  ID182DS0$S7888900,ID182DS0$S7889000),na.rm = TRUE)
...
#Recode age 
ID182DS0$AGECALC<-ID182DS0$T2011100

#Income, Education, Occupation ----
##Income
#Take highest income reported
ID182DS0$INC<-pmax(ID182DS0$T3003000,ID182DS0$T2016200,na.rm = TRUE)
...
ID182DS0$EDU<-pmax(ID182DS0$S7683200,ID182DS0$T2119900,na.rm = TRUE)
...
occ_codes<-read.csv('IPD182DS0_NLSY97_2008_Occupational codes.csv')
...
ID182DS0$T3186900<-factor(ID182DS0$T3186900)
ID182DS0$OCCS<-as.numeric(as.character(occstatusvalues[ match(ID182DS0$T3186900, occvalues) ]))
...
ID182DS0$T3186900<-factor(ID182DS0$T3186900)
ID182DS0$OCCP<-as.numeric(as.character(occprestvalues[ match(ID182DS0$T3186900, occvalues) ]))

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID182DS0, file = 'ID182NLSY97_2008_recoded.csv')
...
#Select variables for correlation matrix
AAYDFCmatrixvars<-matrixvars[-c(11:12)]
AAYDFC <- AAYDF[AAYDFCmatrixvars]
...
#Select variables for correlation matrix
AAYDMCmatrixvars<-matrixvars[-c(11:12)]
AAYDMC <- AAYDM[AAYDMCmatrixvars]
...
#Select variables for correlation matrix
AAATFCmatrixvars<-matrixvars[-c(11:12)]
AAATFC <- AAATF[AAATFCmatrixvars]
...
write.csv(ID182DS0_aggregated, file = 'ID182NLSY97_2008_aggregated.csv',row.names = FALSE)
