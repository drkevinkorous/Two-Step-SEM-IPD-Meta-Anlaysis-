#load dataset
library('foreign')
data<-read.spss('06844-0001-Data.sav')
#Coded variables
#Participant ID: NA
#Measure Name (not a variable in the dataset): CESD
#Depressive symptom items: 
#FELTGOOD(RC),FELTMIND,FELTDEP,FELTEFF,FELTHOPE(RC),FELTSLEP,
#ELTHAP(RC),FELTUNF,FELTENJ(RC),FELTCRY,FELTDISL,FELTNOGO
...
#Birth Day: NA
#Evaluation Year: NA
#Evaluation Month: INTMONTH
#Evaluation Day: NA
#Participant Income: NA 
#Maternal Income: NA
#Paternal Income: NA
#Household Income: INCOME 
#Participant Education: IREDUC
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: ROCCUP1 
#Maternal Occupation: NA
#Paternal Occupation: NA
#Household Occupation: NA
#SES: NA
#Year of data collection (not a variable in the dataset): 1985
#Notes: NSDUH

#Create Dataset ----
attach(data)
#Extract relevant variables into a dataframe.
ID6844DS1<-data.frame(FELTGOOD,FELTMIND,FELTDEP,FELTEFF,FELTHOPE,FELTSLEP,
                      FELTHAP,FELTUNF,FELTENJ,FELTCRY,FELTDISL,FELTNOGO,IRHOIND,IRHOGRP2,IRRACE,
                      IRSEX,IRAGE,BIRYEAR,BIRMON,EIIDATE,INTMONTH,INCOME,IREDUC,ROCCUP1)
detach(data)
ID6844DS1$ORIGOBS<-nrow(ID6844DS1)
rm(data)
...
ID6844DS1$FELTGOOD<-ifelse(ID6844DS1$FELTGOOD == "Rarely or none of the time (less than a day)", 3, ifelse(ID6844DS1$FELTGOOD == "Some or a little of the time (1-2 days)", 2, 
                    ifelse(ID6844DS1$FELTGOOD == "Occasionally/moderate amnt of time (3-4 days)", 1, ifelse(ID6844DS1$FELTGOOD == "Most or all of the time (5-7 days)", 0, NA))))
                    #reverse code item
ID6844DS1$FELTMIND<-ifelse(ID6844DS1$FELTMIND == "Rarely or none of the time (less than a day)", 0, ifelse(ID6844DS1$FELTMIND == "Some or a little of the time (1-2 days)", 1, 
                    ifelse(ID6844DS1$FELTMIND == "Occasionally/moderate amnt of time (3-4 days)", 2, ifelse(ID6844DS1$FELTMIND == "Most or all of the time (5-7 days)", 3, NA))))
ID6844DS1$FELTDEP<-ifelse(ID6844DS1$FELTDEP == "Rarely or none of the time (less than a day)", 0, ifelse(ID6844DS1$FELTDEP == "Some or a little of the time (1-2 days)", 1, 
                   ifelse(ID6844DS1$FELTDEP == "Occasionally/moderate amnt of time (3-4 days)", 2, ifelse(ID6844DS1$FELTDEP == "Most or all of the time (5-7 days)", 3, NA))))
ID6844DS1$FELTEFF<-ifelse(ID6844DS1$FELTEFF == "Rarely or none of the time (less than a day)", 0, ifelse(ID6844DS1$FELTEFF == "Some or a little of the time (1-2 days)", 1, 
                   ifelse(ID6844DS1$FELTEFF == "Occasionally/moderate amnt of time (3-4 days)", 2, ifelse(ID6844DS1$FELTEFF == "Most or all of the time (5-7 days)", 3, NA))))
ID6844DS1$FELTHOPE<-ifelse(ID6844DS1$FELTHOPE == "Rarely or none of the time (less than a day)", 3, ifelse(ID6844DS1$FELTHOPE == "Some or a little of the time (1-2 days)", 2, 
                    ifelse(ID6844DS1$FELTHOPE == "Occasionally/moderate amnt of time (3-4 days)", 1, ifelse(ID6844DS1$FELTHOPE == "Most or all of the time (5-7 days)", 0, NA))))
                    #reverse code item
ID6844DS1$FELTSLEP<-ifelse(ID6844DS1$FELTSLEP == "Rarely or none of the time (less than a day)", 0, ifelse(ID6844DS1$FELTSLEP == "Some or a little of the time (1-2 days)", 1, 
                    ifelse(ID6844DS1$FELTSLEP == "Occasionally/moderate amnt of time (3-4 days)", 2, ifelse(ID6844DS1$FELTSLEP == "Most or all of the time (5-7 days)", 3, NA))))
ID6844DS1$FELTHAP<-ifelse(ID6844DS1$FELTHAP == "Rarely or none of the time (less than a day)", 3, ifelse(ID6844DS1$FELTHAP == "Some or a little of the time (1-2 days)", 2, 
                   ifelse(ID6844DS1$FELTHAP == "Occasionally/moderate amnt of time (3-4 days)", 1, ifelse(ID6844DS1$FELTHAP == "Most or all of the time (5-7 days)", 0, NA))))
                    #reverse code item
ID6844DS1$FELTUNF<-ifelse(ID6844DS1$FELTUNF == "Rarely or none of the time (less than a day)", 0, ifelse(ID6844DS1$FELTUNF == "Some or a little of the time (1-2 days)", 1, 
                   ifelse(ID6844DS1$FELTUNF == "Occasionally/moderate amnt of time (3-4 days)", 2, ifelse(ID6844DS1$FELTUNF == "Most or all of the time (5-7 days)", 3, NA))))
ID6844DS1$FELTENJ<-ifelse(ID6844DS1$FELTENJ == "Rarely or none of the time (less than a day)", 3, ifelse(ID6844DS1$FELTENJ == "Some or a little of the time (1-2 days)", 2, 
                   ifelse(ID6844DS1$FELTENJ == "Occasionally/moderate amnt of time (3-4 days)", 1, ifelse(ID6844DS1$FELTENJ == "Most or all of the time (5-7 days)", 0, NA))))
                    #reverse code item
ID6844DS1$FELTCRY<-ifelse(ID6844DS1$FELTCRY == "Rarely or none of the time (less than a day)", 0, ifelse(ID6844DS1$FELTCRY == "Some or a little of the time (1-2 days)", 1, 
                   ifelse(ID6844DS1$FELTCRY == "Occasionally/moderate amnt of time (3-4 days)", 2, ifelse(ID6844DS1$FELTCRY == "Most or all of the time (5-7 days)", 3, NA))))
ID6844DS1$FELTDISL<-ifelse(ID6844DS1$FELTDISL == "Rarely or none of the time (less than a day)", 0, ifelse(ID6844DS1$FELTDISL == "Some or a little of the time (1-2 days)", 1, 
                    ifelse(ID6844DS1$FELTDISL == "Occasionally/moderate amnt of time (3-4 days)", 2, ifelse(ID6844DS1$FELTDISL == "Most or all of the time (5-7 days)", 3, NA))))
ID6844DS1$FELTNOGO<-ifelse(ID6844DS1$FELTNOGO == "Rarely or none of the time (less than a day)", 0, ifelse(ID6844DS1$FELTNOGO == "Some or a little of the time (1-2 days)", 1, 
                    ifelse(ID6844DS1$FELTNOGO == "Occasionally/moderate amnt of time (3-4 days)", 2, ifelse(ID6844DS1$FELTNOGO == "Most or all of the time (5-7 days)", 3, NA))))
...
dsitems <- ID6844DS1[c(1:12)]
#dsitemspw <- ID6844DS1[c(:)]
#Identify participants missing more than half of dsitems (not dsitemsW1) (1=missing > 50%) - to be used later
ID6844DS1$dsmiss<-ifelse(rowSums(is.na(dsitems))>((ncol(dsitems)/2)),1,0)
#Compute mean symptom score 
ID6844DS1$DEP<-rowMeans(x=dsitems,na.rm=TRUE)
ID6844DS1$DEPPW<-NA#rowMeans(x=dsitemspw,na.rm=TRUE)
...
ID6844DS1$LAT<-ifelse(ID6844DS1$IRHOIND == "Hispanic", 1, 0)
ID6844DS1$WHT<-ifelse(ID6844DS1$IRRACE == "White", 1, 0)
ID6844DS1$BLK<-ifelse(ID6844DS1$IRRACE == "Black", 1, 0)
ID6844DS1$AI<-ifelse(ID6844DS1$IRRACE == "American indian/Alaskan native", 1, 0)
ID6844DS1$AA<-ifelse(ID6844DS1$IRRACE == "Asian or Pacific islander", 1, 0)
ID6844DS1$OTH<-NA

#Compute variable for participants who reported more than one race (mixed/biracial; do not include Latino/Hispanic)
ID6844DS1$MR<-ifelse((rowSums(x=cbind(ID6844DS1$WHT,ID6844DS1$BLK,ID6844DS1$AI,ID6844DS1$AA,ID6844DS1$OTH),
                              na.rm=TRUE)) > 1, 1, 0)

##Compute variables for participants who reported a single race (excluding mixed/biracial & Latino/Hispanic)
ID6844DS1$WHT<-ifelse(((ID6844DS1$LAT == 0)&(ID6844DS1$MR == 0)&(ID6844DS1$WHT == 1)), 1, 0)
ID6844DS1$BLK<-ifelse(((ID6844DS1$LAT == 0)&(ID6844DS1$MR == 0)&(ID6844DS1$BLK == 1)), 1, 0)
ID6844DS1$AI<-ifelse(((ID6844DS1$LAT == 0)&(ID6844DS1$MR == 0)&(ID6844DS1$AI == 1)), 1, 0)
ID6844DS1$AA<-ifelse(((ID6844DS1$LAT == 0)&(ID6844DS1$MR == 0)&(ID6844DS1$AA == 1)), 1, 0)
ID6844DS1$OTH<-NA#ifelse(((ID6844DS1$LAT == 0)&(ID6844DS1$MR == 0)&(ID6844DS1$OTH == 1)), 1, 0)
ID6844DS1$MR<-ifelse(((ID6844DS1$LAT == 0)&(ID6844DS1$MR == 1)), 1, 0)

#Recode factor into numeric,
ID6844DS1$SEX<-ifelse(ID6844DS1$IRSEX == "Male", 1, 0)

#Recode age 
ID6844DS1$AGECALC<-ID6844DS1$IRAGE

#Income, Education, Occupation ----
##Income
ID6844DS1$INC<-ifelse(ID6844DS1$INCOME=="No personal earnings",0,        
               ifelse(ID6844DS1$INCOME=="Yearly - under $5,000",4900,       
               ifelse(ID6844DS1$INCOME=="Yearly - $5,000 to $6,999",5999,    
               ifelse(ID6844DS1$INCOME=="Yearly - $7,000 to $8,999",7999,   
               ifelse(ID6844DS1$INCOME=="Yearly - $9,000 to $11,999",10499,   
               ifelse(ID6844DS1$INCOME=="Yearly - $12,000 to $14,999",13499, 
               ifelse(ID6844DS1$INCOME=="Yearly - $15,000 to $19,999",17499,  
               ifelse(ID6844DS1$INCOME=="Yearly - $20,000 to $24,999",22499, 
               ifelse(ID6844DS1$INCOME=="Yearly - $25,000 to $29,999",27499,  
               ifelse(ID6844DS1$INCOME=="Yearly - $30,000 to $39,999",34999, 
               ifelse(ID6844DS1$INCOME=="Yearly - $40,000 to $50,000",45000,  
               ifelse(ID6844DS1$INCOME=="Yearly - More than $50,000",51000,NA))))))))))))  
        
##Education
ID6844DS1$EDU<-ifelse(ID6844DS1$IREDUC=="No schooling",0,                
               ifelse(ID6844DS1$IREDUC=="First grade",1,                 
               ifelse(ID6844DS1$IREDUC=="Second grade",2,                 
               ifelse(ID6844DS1$IREDUC=="Third grade",3,                 
               ifelse(ID6844DS1$IREDUC=="Fourth grade",4,                 
               ifelse(ID6844DS1$IREDUC=="Fifth grade",5,                 
               ifelse(ID6844DS1$IREDUC=="Sixth grade",6,                  
               ifelse(ID6844DS1$IREDUC=="Seventh grade",7,               
               ifelse(ID6844DS1$IREDUC=="Eighth grade",8,                 
               ifelse(ID6844DS1$IREDUC=="Ninth grade",9,                 
               ifelse(ID6844DS1$IREDUC=="Tenth grade",10,                  
               ifelse(ID6844DS1$IREDUC=="Eleventh grade",11,              
               ifelse(ID6844DS1$IREDUC=="Twelfth grade",12,                
               ifelse(ID6844DS1$IREDUC=="One year of college",13,         
               ifelse(ID6844DS1$IREDUC=="Two years of college",14,         
               ifelse(ID6844DS1$IREDUC=="Three years of college",15,      
               ifelse(ID6844DS1$IREDUC=="Four years of college",16,        
               ifelse(ID6844DS1$IREDUC=="Graduate/professional school",17,NA))))))))))))))))))

##Occupation
#Recode factor into numeric (occupational status)
#Nam-Powers-Boyd scale (Nam & Boyd, 2008)
#categories are too broad
#levels(ID6844DS1$ROCCUP1)   
ID6844DS1$OCCS<-NA
...
write.csv(ID6844DS1, file = 'ID6844DS1_recoded.csv')

#Descriptives and Correlations -----
#Exclude participants with more than 50% missing on depressive symtpoms items
ID6844DS1 <- ID6844DS1[which(ID6844DS1$dsmiss==0), ]

##Compute mean and sd across all participants within dataset
library('psych')
#Means & SDs of focal variables
dstatsage<-describe(ID6844DS1$AGECALC)
dstatsdep<-describe(ID6844DS1$DEP)
dstatsachv<-NA#describe(ID6844DS1$ACHV)
dstatsinc<-describe(ID6844DS1$INC)
dstatsedu<-describe(ID6844DS1$EDU)
dstatsoccs<-NA#describe(ID6844DS1$OCCS)
dstatsoccp<-NA#describe(ID6844DS1$OCCP)

#Save descriptive stats
dstats<-rbind(dstatsage,dstatsdep,dstatsachv,dstatsinc,dstatsedu,dstatsoccs,dstatsoccp,make.row.names= FALSE)
write.csv(dstats,file = 'ID6844DS1_dstats.csv',
          row.names=c("dstatsage","dstatsdep","dstatsachv","dstatsinc","dstatsedu","dstatsoccs","dstatsoccp"))

##Histograms 
pdf('ID6844DS1_dephist.pdf')
hist(ID6844DS1$DEP, xlab="Depressive Symptoms", main = NULL, col="grey")
dev.off()
#pdf('ID6844DS1_achvhist.pdf')
#hist(ID6844DS1$ACHV, xlab="Academic Achievement", main = NULL, col="grey")
#dev.off()
pdf('ID6844DS1_inchist.pdf')
hist(ID6844DS1$INC, xlab="Income", main = NULL, col="grey")
dev.off()
pdf('ID6844DS1_educhist.pdf')
hist(ID6844DS1$EDU, xlab="Educational Attainment", main = NULL, col="grey")
dev.off()
#pdf('ID6844DS1_occshist.pdf')
#hist(ID6844DS1$OCCS, xlab="Occupational Status", main = NULL, col="grey")
#dev.off()
#pdf('ID6844DS1_occphist.pdf')
#hist(ID6844DS1$OCCP, xlab="Occupational Prestige", main = NULL, col="grey")
#dev.off()
...
table(ID6844DS1$AGECALC)
#Separate dataset by developmental period, if needed
#CH<-ID6844DS1[which((ID6844DS1$AGECALC >= 5)&(ID6844DS1$AGECALC <= 11)), ] 
AD<-ID6844DS1[which((ID6844DS1$AGECALC >= 12)&(ID6844DS1$AGECALC <= 17)), ]
YD<-ID6844DS1[which((ID6844DS1$AGECALC >= 18)&(ID6844DS1$AGECALC <= 25)), ]
AT<-ID6844DS1[which((ID6844DS1$AGECALC >= 26)&(ID6844DS1$AGECALC <= 64)), ]
OA<-ID6844DS1[which(ID6844DS1$AGECALC >= 65), ]
...
##Assign ICPSR ID number (ICPSR Number; e.g., file name = ID6844DS1, then DATAID = 21600)
#DATAID<-'6844'
#names(DATAID)<-'DATAID'
...
#ALPHAOV <- ci.reliability(data=WHTCHF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTCHM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTADF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTADF[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTADM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTADM[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTYDF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTYDF[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTYDM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTYDM[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTATF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTATF[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTATM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTATM[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTOAF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTOAF[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTOAM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTOAM[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#names(DATAYEAR)<-'DATAYEAR'
##Compute reliability estimates
#ALPHAOV <- ci.reliability(data=LATCHF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATCHM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
names(DATAYEAR)<-'DATAYEAR'
#Compute reliability estimates
ALPHAOV <- ci.reliability(data=LATADF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATADF[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATADM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATADM[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATYDF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATYDF[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATYDM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATYDM[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATATF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATATF[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATATM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATATM[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATOAF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATOAF[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATOAM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATOAM[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKADF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKADF[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKADM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKADM[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKYDF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKYDF[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKYDM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKYDM[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKATF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKATF[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKATM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKATM[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKOAF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKOAF[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKOAM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKOAM[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHMC[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHMC[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AAADF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AAADF[1:12], type = "omega", interval.type = "none")
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AAADM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AAADM[1:12], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AAYDF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AAYDF[1:12], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAYDM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAYDM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AAATF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AAATF[1:12], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AAATM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AAATM[1:12], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AIADF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AIADF[1:12], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIYDF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIYDF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIYDM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIYDM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AIATF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AIATF[1:12], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AIATM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AIATM[1:12], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIOAF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIOAF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIOAM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIOAM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRYDF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRYDF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRYDM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRYDM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRATF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRATF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRATM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRATM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MROAF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MROAF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MROAM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MROAM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
ID6844DS1_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
WHTADFAGGRTED,
WHTADMAGGRTED,
...
write.csv(ID6844DS1_aggregated, file = 'ID6844DS1_aggregated.csv',row.names = FALSE)
