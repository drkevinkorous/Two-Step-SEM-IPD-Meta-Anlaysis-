...
#Depressive symptom items: S8332300,S8332400(RC),S8332500,S8332600(RC),S8332700
#Depressive symptom items prior wave: S4681900,S4682000(RC),S4682100,S4682200(RC),S4682300
...
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: S8496500 
#Maternal Income: NA
#Paternal Income: NA
#Household Income: S7513700 
#Participant Education: S7683200 
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: S8689700 (2002 census codes) 
...
ID182DS0<-data.frame(R0000100,S8332300,S8332400,S8332500,S8332600,S8332700,S4681900,S4682000,S4682100,S4682200,S4682300,
                     S7888600,S7888700,S7888800,S7888900,S7889000,S4208300,S4208400,S4208500,S4208600,
                     S1224800,S1224900,S1224901,S1224902,S1224903,S1224904,S1224905,R0536300,
                     S7501200,R0536402,R0536401,S8496500,S7513700,S7683200,S8689700)
detach(merged182)
...
ID182DS0$ACHV<-rowMeans(x=cbind(ID182DS0$S7888600,ID182DS0$S7888700,ID182DS0$S7888800,
...
ID182DS0$ACHVPW<-rowMeans(x=cbind(ID182DS0$S4208300,ID182DS0$S4208400,ID182DS0$S4208500,
...
#Recode age 
ID182DS0$AGECALC<-ID182DS0$S7501200

#Income, Education, Occupation ----
##Income
#Take highest income reported
ID182DS0$INC<-pmax(ID182DS0$S8496500,ID182DS0$S7513700,na.rm = TRUE)

##Education
ID182DS0$EDU<-ifelse(ID182DS0$S7683200=="1ST GRADE",1,         
...
occ_codes<-read.csv('IPD182DS0_NLSY97_2006_Occupational codes.csv')
...
ID182DS0$S8689700<-factor(ID182DS0$S8689700)
ID182DS0$OCCS<-as.numeric(as.character(occstatusvalues[ match(ID182DS0$S8689700, occvalues) ]))
...
ID182DS0$S8689700<-factor(ID182DS0$S8689700)
ID182DS0$OCCP<-as.numeric(as.character(occprestvalues[ match(ID182DS0$S8689700, occvalues) ]))

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID182DS0, file = 'ID182NLSY97_2006_recoded.csv')
...
write.csv(ID182DS0_aggregated, file = 'ID182NLSY97_2006_aggregated.csv',row.names = FALSE)
