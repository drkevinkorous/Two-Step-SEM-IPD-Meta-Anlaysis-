...
load(file = '21600-0005-Data.rda')
merged21600<-merge(da21600.0005,da21600.0001,by="AID",all.x = TRUE)
#Coded variables
#Participant ID: AID
#Measure Name (not a variable in the dataset): CESD 
#Depressive symptom items: H2FS1,H2FS2,H2FS3,H2FS4,H2FS5,H2FS6,H2FS7,H2FS8,H2FS9,H2FS10,H2FS11,
#                                H2FS12,H2FS13,H2FS14,H2FS15,H2FS16,H2FS17,H2FS18,H2FS19
#Depressive symptom items prior wave: H1FS1,H1FS2,H1FS3,H1FS4,H1FS5,H1FS6,H1FS7,H1FS8,H1FS9,H1FS10,H1FS11,
#                                     H1FS12,H1FS13,H1FS14,H1FS15,H1FS16,H1FS17,H1FS18,H1FS19
#Academic Acehievement: H2ED7,H2ED8,H2ED9,H2ED10  
#Academic Acehievement prior wave: H1ED11,H1ED12,H1ED13,H1ED14  
#Ethnicity: H1GI4
#Race: H1GI8
#White: H1GI6A
#Black: H1GI6B 
...
#Birth Month: H2GI1M
#Birth Day: NA
#Evaluation Year: IYEAR2
#Evaluation Month: IMONTH2
#Evaluation Day: IDAY2
#Participant Income: NA (youth participant)
#Maternal Income: NA
#Paternal Income: NA
#Household Income: PA55 (0-999 thousand; From Parental Questionnaire Wave 1)
#Participant Education: H2GI9
#Maternal Education: H2RM1
#Paternal Education: H2RF1
#Household Education: NA
#Participant Occupation: NA
#Maternal Occupation: H2RM4
#Paternal Occupation: H2RF4
...
ID21600DS5<-data.frame(AID,H2FS1,H2FS2,H2FS3,H2FS4,H2FS5,H2FS6,H2FS7,H2FS8,H2FS9,H2FS10,H2FS11,H2FS12,H2FS13,
                     H2FS14,H2FS15,H2FS16,H2FS17,H2FS18,H2FS19,H2ED7,H2ED8,H2ED9,H2ED10,H1FS1,H1FS2,H1FS3,
                     H1FS4,H1FS5,H1FS6,H1FS7,H1FS8,H1FS9,H1FS10,H1FS11,H1FS12,H1FS13,H1FS14,H1FS15,H1FS16,H1FS17,
                     H1FS18,H1FS19, H1ED11,H1ED12,H1ED13,H1ED14,H1GI4,H1GI8,H1GI6A,H1GI6B,H1GI6D,H1GI6C,H1GI6E,
                     BIO_SEX2,CALCAGE2,H2GI1Y,H2GI1M,IYEAR2,IMONTH2,IDAY2,H1EE5,H1EE7,H2GI9,PA55,H2RM1,H2RF1,H2RM4,H2RF4)

detach(merged21600)
ID21600DS5$ORIGOBS<-nrow(da21600.0005)
rm(da21600.0005,da21600.0001,merged21600)

#Check to make sure there is no funny business
head(ID21600DS5)

#Recode factor into numeric (depressive symptoms)
ID21600DS5$H2FS1<-ifelse(ID21600DS5$H2FS1 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS1 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H2FS1 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS5$H2FS1 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS2<-ifelse(ID21600DS5$H2FS2 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS2 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H2FS2 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS5$H2FS2 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS3<-ifelse(ID21600DS5$H2FS3 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS3 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H2FS3 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS5$H2FS3 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS4<-ifelse(ID21600DS5$H2FS4 == "(0) (0) Never/rarely", 3, ifelse(ID21600DS5$H2FS4 == "(1) (1) Sometimes", 2, 
                  ifelse(ID21600DS5$H2FS4 == "(2) (2) A lot of the time", 1,
                  ifelse(ID21600DS5$H2FS4 == "(3) (3) Most/all of the time",0,NA))))#reverse coded item
ID21600DS5$H2FS5<-ifelse(ID21600DS5$H2FS5 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS5 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H2FS5 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS5$H2FS5 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS6<-ifelse(ID21600DS5$H2FS6 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS6 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H2FS6 == "(2) (2) A lot of the time", 2, 
                  ifelse(ID21600DS5$H2FS6 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS7<-ifelse(ID21600DS5$H2FS7 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS7 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H2FS7 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS5$H2FS7 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS8<-ifelse(ID21600DS5$H2FS8 == "(0) (0) Never/rarely", 3, ifelse(ID21600DS5$H2FS8 == "(1) (1) Sometimes", 2, 
                  ifelse(ID21600DS5$H2FS8 == "(2) (2) A lot of the time", 1, 
                  ifelse(ID21600DS5$H2FS8 == "(3) (3) Most/all of the time",0,NA))))#reverse coded item
ID21600DS5$H2FS9<-ifelse(ID21600DS5$H2FS9 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS9 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H2FS9 == "(2) (2) A lot of the time", 2, 
                  ifelse(ID21600DS5$H2FS9 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS10<-ifelse(ID21600DS5$H2FS10 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS10 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H2FS10 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS5$H2FS10 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS11<-ifelse(ID21600DS5$H2FS11 == "(0) (0) Never/rarely", 3, ifelse(ID21600DS5$H2FS11 == "(1) (1) Sometimes", 2, 
                   ifelse(ID21600DS5$H2FS11 == "(2) (2) A lot of the time", 1, 
                   ifelse(ID21600DS5$H2FS11 == "(3) (3) Most/all of the time",0,NA))))#reverse coded item
ID21600DS5$H2FS12<-ifelse(ID21600DS5$H2FS12 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS12 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H2FS12 == "(2) (2) A lot of the time", 2,
                   ifelse(ID21600DS5$H2FS12 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS13<-ifelse(ID21600DS5$H2FS13 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS13 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H2FS13 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS5$H2FS13 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS14<-ifelse(ID21600DS5$H2FS14 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS14 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H2FS14 == "(2) (2) A lot of the time", 2,
                   ifelse(ID21600DS5$H2FS14 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS15<-ifelse(ID21600DS5$H2FS15 == "(0) (0) Never/rarely", 3, ifelse(ID21600DS5$H2FS15 == "(1) (1) Sometimes", 2, 
                   ifelse(ID21600DS5$H2FS15 == "(2) (2) A lot of the time", 1, 
                   ifelse(ID21600DS5$H2FS15 == "(3) (3) Most/all of the time",0,NA))))#reverse coded item
ID21600DS5$H2FS16<-ifelse(ID21600DS5$H2FS16 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS16 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H2FS16 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS5$H2FS16 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS17<-ifelse(ID21600DS5$H2FS17 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS17 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H2FS17 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS5$H2FS17 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS18<-ifelse(ID21600DS5$H2FS18 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS18 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H2FS18 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS5$H2FS18 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H2FS19<-ifelse(ID21600DS5$H2FS19 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H2FS19 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H2FS19 == "(2) (2) A lot of the time", 2,
                   ifelse(ID21600DS5$H2FS19 == "(3) (3) Most/all of the time",3,NA))))

#Recode factor into numeric (depressive symptoms prior wave)
ID21600DS5$H1FS1<-ifelse(ID21600DS5$H1FS1 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS1 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H1FS1 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS5$H1FS1 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS2<-ifelse(ID21600DS5$H1FS2 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS2 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H1FS2 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS5$H1FS2 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS3<-ifelse(ID21600DS5$H1FS3 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS3 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H1FS3 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS5$H1FS3 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS4<-ifelse(ID21600DS5$H1FS4 == "(0) (0) Never/rarely", 3, ifelse(ID21600DS5$H1FS4 == "(1) (1) Sometimes", 2, 
                  ifelse(ID21600DS5$H1FS4 == "(2) (2) A lot of the time", 1,
                  ifelse(ID21600DS5$H1FS4 == "(3) (3) Most/all of the time",0,NA))))#reverse coded item
ID21600DS5$H1FS5<-ifelse(ID21600DS5$H1FS5 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS5 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H1FS5 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS5$H1FS5 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS6<-ifelse(ID21600DS5$H1FS6 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS6 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H1FS6 == "(2) (2) A lot of the time", 2, 
                  ifelse(ID21600DS5$H1FS6 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS7<-ifelse(ID21600DS5$H1FS7 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS7 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H1FS7 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS5$H1FS7 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS8<-ifelse(ID21600DS5$H1FS8 == "(0) (0) Never/rarely", 3, ifelse(ID21600DS5$H1FS8 == "(1) (1) Sometimes", 2, 
                  ifelse(ID21600DS5$H1FS8 == "(2) (2) A lot of the time", 1, 
                  ifelse(ID21600DS5$H1FS8 == "(3) (3) Most/all of the time",0,NA))))#reverse coded item
ID21600DS5$H1FS9<-ifelse(ID21600DS5$H1FS9 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS9 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS5$H1FS9 == "(2) (2) A lot of the time", 2, 
                  ifelse(ID21600DS5$H1FS9 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS10<-ifelse(ID21600DS5$H1FS10 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS10 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H1FS10 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS5$H1FS10 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS11<-ifelse(ID21600DS5$H1FS11 == "(0) (0) Never/rarely", 3, ifelse(ID21600DS5$H1FS11 == "(1) (1) Sometimes", 2, 
                   ifelse(ID21600DS5$H1FS11 == "(2) (2) A lot of the time", 1, 
                   ifelse(ID21600DS5$H1FS11 == "(3) (3) Most/all of the time",0,NA))))#reverse coded item
ID21600DS5$H1FS12<-ifelse(ID21600DS5$H1FS12 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS12 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H1FS12 == "(2) (2) A lot of the time", 2,
                   ifelse(ID21600DS5$H1FS12 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS13<-ifelse(ID21600DS5$H1FS13 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS13 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H1FS13 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS5$H1FS13 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS14<-ifelse(ID21600DS5$H1FS14 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS14 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H1FS14 == "(2) (2) A lot of the time", 2,
                   ifelse(ID21600DS5$H1FS14 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS15<-ifelse(ID21600DS5$H1FS15 == "(0) (0) Never/rarely", 3, ifelse(ID21600DS5$H1FS15 == "(1) (1) Sometimes", 2, 
                   ifelse(ID21600DS5$H1FS15 == "(2) (2) A lot of the time", 1, 
                   ifelse(ID21600DS5$H1FS15 == "(3) (3) Most/all of the time",0,NA))))#reverse coded item
ID21600DS5$H1FS16<-ifelse(ID21600DS5$H1FS16 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS16 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H1FS16 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS5$H1FS16 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS17<-ifelse(ID21600DS5$H1FS17 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS17 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H1FS17 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS5$H1FS17 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS18<-ifelse(ID21600DS5$H1FS18 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS18 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H1FS18 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS5$H1FS18 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS5$H1FS19<-ifelse(ID21600DS5$H1FS19 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS5$H1FS19 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS5$H1FS19 == "(2) (2) A lot of the time", 2,
                   ifelse(ID21600DS5$H1FS19 == "(3) (3) Most/all of the time",3,NA))))

#Assign dataframe that contains all depressive symtpoms (using the column numbers of the items)
dsitems <- ID21600DS5[c(2:20)]
dsitemspw <- ID21600DS5[c(25:43)]
#Identify participants missing more than half of dsitems (not dsitemsW1) (1=missing > 50%) - to be used later
ID21600DS5$dsmiss<-ifelse(rowSums(is.na(dsitems))>((ncol(dsitems)/2)),1,0)
#Compute mean symptom score 
ID21600DS5$DEP<-rowMeans(x=dsitems,na.rm=TRUE)
ID21600DS5$DEPPW<-rowMeans(x=dsitemspw,na.rm=TRUE)

#Recode Academic Acehievement
ID21600DS5$H2ED7<-ifelse(ID21600DS5$H2ED7 == "(1) (1) A", 4.0, ifelse(ID21600DS5$H2ED7 == "(2) (2) B", 3.0, 
                   ifelse(ID21600DS5$H2ED7 == "(3) (3) C", 2.0, ifelse(ID21600DS5$H2ED7 == "(4) (4) D or lower", 1.0, NA))))
ID21600DS5$H2ED8<-ifelse(ID21600DS5$H2ED8 == "(1) (1) A", 4.0, ifelse(ID21600DS5$H2ED8 == "(2) (2) B", 3.0, 
                   ifelse(ID21600DS5$H2ED8 == "(3) (3) C", 2.0, ifelse(ID21600DS5$H2ED8 == "(4) (4) D or lower", 1.0, NA))))
ID21600DS5$H2ED9<-ifelse(ID21600DS5$H2ED9 == "(1) (1) A", 4.0, ifelse(ID21600DS5$H2ED9 == "(2) (2) B", 3.0, 
                   ifelse(ID21600DS5$H2ED9 == "(3) (3) C", 2.0, ifelse(ID21600DS5$H2ED9 == "(4) (4) D or lower", 1.0, NA))))  
ID21600DS5$H2ED10<-ifelse(ID21600DS5$H2ED10 == "(1) (1) A", 4.0, ifelse(ID21600DS5$H2ED10 == "(2) (2) B", 3.0, 
                   ifelse(ID21600DS5$H2ED10 == "(3) (3) C", 2.0, ifelse(ID21600DS5$H2ED10 == "(4) (4) D or lower", 1.0, NA))))

#Recode Academic Acehievement (prior wave)
ID21600DS5$H1ED11<-ifelse(ID21600DS5$H1ED11 == "(1) (1) A", 4.0, ifelse(ID21600DS5$H1ED11 == "(2) (2) B", 3.0, 
                   ifelse(ID21600DS5$H1ED11 == "(3) (3) C", 2.0, ifelse(ID21600DS5$H1ED11 == "(4) (4) D or lower", 1.0, NA))))
ID21600DS5$H1ED12<-ifelse(ID21600DS5$H1ED12 == "(1) (1) A", 4.0, ifelse(ID21600DS5$H1ED12 == "(2) (2) B", 3.0, 
                   ifelse(ID21600DS5$H1ED12 == "(3) (3) C", 2.0, ifelse(ID21600DS5$H1ED12 == "(4) (4) D or lower", 1.0, NA))))
ID21600DS5$H1ED13<-ifelse(ID21600DS5$H1ED13 == "(1) (1) A", 4.0, ifelse(ID21600DS5$H1ED13 == "(2) (2) B", 3.0, 
                   ifelse(ID21600DS5$H1ED13 == "(3) (3) C", 2.0, ifelse(ID21600DS5$H1ED13 == "(4) (4) D or lower", 1.0, NA))))  
ID21600DS5$H1ED14<-ifelse(ID21600DS5$H1ED14 == "(1) (1) A", 4.0, ifelse(ID21600DS5$H1ED14 == "(2) (2) B", 3.0, 
                   ifelse(ID21600DS5$H1ED14 == "(3) (3) C", 2.0, ifelse(ID21600DS5$H1ED14 == "(4) (4) D or lower", 1.0, NA))))
...
ID21600DS5$ACHV<-rowMeans(x=cbind(ID21600DS5$H2ED7,ID21600DS5$H2ED8,ID21600DS5$H2ED9,ID21600DS5$H2ED10), na.rm = TRUE)
ID21600DS5$ACHVPW<-rowMeans(x=cbind(ID21600DS5$H1ED11,ID21600DS5$H1ED12,ID21600DS5$H1ED13,ID21600DS5$H1ED14), na.rm = TRUE)

#Recode variable for participants who identified as Latio or Hispanic (do not include in mixed/biracial code below)
ID21600DS5$LAT<-ifelse(ID21600DS5$H1GI4 == "(1) (1) Yes", 1, 0)

#Recode factor into numeric (individual race items)
ID21600DS5$WHT<-ifelse(ID21600DS5$H1GI6A == "(1) (1) Marked", 1, 0)
ID21600DS5$BLK<-ifelse(ID21600DS5$H1GI6B == "(1) (1) Marked", 1, 0)
ID21600DS5$AI<-ifelse(ID21600DS5$H1GI6C == "(1) (1) Marked", 1, 0)
ID21600DS5$AA<-ifelse(ID21600DS5$H1GI6D == "(1) (1) Marked", 1, 0)
ID21600DS5$OTH<-ifelse(ID21600DS5$H1GI6E == "(1) (1) Marked", 1, 0)

#Compute variable for participants who reported more than one race (mixed/biracial; do not include Latino/Hispanic)
ID21600DS5$MR<-ifelse((rowSums(x=cbind(ID21600DS5$WHT,ID21600DS5$BLK,ID21600DS5$AI,ID21600DS5$AA,ID21600DS5$OTH),
                               na.rm=TRUE)) > 1, 1, 0)

#Compute variables for participants who reported a single race (excluding mixed/biracial & Latino/Hispanic)
ID21600DS5$WHT<-ifelse(((ID21600DS5$LAT == 0)&(ID21600DS5$MR == 0)&(ID21600DS5$WHT == 1)), 1, 0)
ID21600DS5$BLK<-ifelse(((ID21600DS5$LAT == 0)&(ID21600DS5$MR == 0)&(ID21600DS5$BLK == 1)), 1, 0)
ID21600DS5$AI<-ifelse(((ID21600DS5$LAT == 0)&(ID21600DS5$MR == 0)&(ID21600DS5$AI == 1)), 1, 0)
ID21600DS5$AA<-ifelse(((ID21600DS5$LAT == 0)&(ID21600DS5$MR == 0)&(ID21600DS5$AA == 1)), 1, 0)
ID21600DS5$OTH<-ifelse(((ID21600DS5$LAT == 0)&(ID21600DS5$MR == 0)&(ID21600DS5$OTH == 1)), 1, 0)
ID21600DS5$MR<-ifelse(((ID21600DS5$LAT == 0)&(ID21600DS5$MR == 1)), 1, 0)

#Recode factor into numeric (sex)
ID21600DS5$SEX<-ifelse(ID21600DS5$BIO_SEX2 == "(1) (1) Male", 1, 0)

#Recode factor into numeric (grade level)
ID21600DS5$gdlevel<-ifelse(ID21600DS5$H2GI9 == "(07) (7) Seventh Grade", 7, ifelse(ID21600DS5$H2GI9 == "(08) (8) Eighth Gradee", 8, 
                    ifelse(ID21600DS5$H2GI9 == "(09) (9) Ninth Grade", 9, ifelse(ID21600DS5$H2GI9 == "(10) (10) Tenth Grade", 10, 
                    ifelse(ID21600DS5$H2GI9 == "(11) (11) Eleventh Grade", 11, ifelse(ID21600DS5$H2GI9 == "(12) (12) Twelfth Grade", 12, 
                    ifelse(ID21600DS5$H2GI9 == "(12) (12) Beyond High School", 13,NA)))))))

#Calculate age, if needed (evaluation year - birthdate year)
ID21600DS5$AGECALC<-ifelse(ID21600DS5$CALCAGE2 == "(11) (11) 11 years old", 11,
                     ifelse(ID21600DS5$CALCAGE2 == "(12) (12) 12 years old", 12,
                     ifelse(ID21600DS5$CALCAGE2 == "(13) (13) 13 years old", 13,
                     ifelse(ID21600DS5$CALCAGE2 == "(14) (14) 14 years old", 14,
                     ifelse(ID21600DS5$CALCAGE2 == "(15) (15) 15 years old", 15,
                     ifelse(ID21600DS5$CALCAGE2 == "(16) (16) 16 years old", 16,
                     ifelse(ID21600DS5$CALCAGE2 == "(17) (17) 17 years old", 17,
                     ifelse(ID21600DS5$CALCAGE2 == "(18) (18) 18 years old", 18,
                     ifelse(ID21600DS5$CALCAGE2 == "(19) (19) 19 years old", 19,
                     ifelse(ID21600DS5$CALCAGE2 == "(20) (20) 20 years old", 20,
                     ifelse(ID21600DS5$CALCAGE2 == "(21) (21) 21 years old", 21, NA)))))))))))

#Recode parental income, if needed (reported by parent in thousands)
ID21600DS5$INC <- ID21600DS5$PA55*1000

#Education
ID21600DS5$H2RM1 <- ifelse(ID21600DS5$H2RM1 == "(10) (10) She never went to school",0,
                    ifelse(ID21600DS5$H2RM1 == "(01) (1) 8th grade or less",8,                            
                    ifelse(ID21600DS5$H2RM1 == "(02) (2) >8th grade/didn't graduate high school",10,
                    ifelse(ID21600DS5$H2RM1 == "(04) (4) High school graduate", 12,
                    ifelse(ID21600DS5$H2RM1 == "(05) (5) GED", 12,
                    ifelse(ID21600DS5$H2RM1 == "(07) (7) College/didn't graduate", 13,
                    ifelse(ID21600DS5$H2RM1 == "(08) (8) Graduated from college/university", 16,
                    ifelse(ID21600DS5$H2RM1 == "(09) (9) Prof training beyond 4-year college/university", 17, NA)))))))) 

ID21600DS5$H2RF1 <- ifelse(ID21600DS5$H2RF1 == "(10) (10) He never went to school",0,
                    ifelse(ID21600DS5$H2RF1 == "(01) (1) 8th grade or less",8,                            
                    ifelse(ID21600DS5$H2RF1 == "(02) (2) >8th grade/didn't graduate high school",10,
                    ifelse(ID21600DS5$H2RF1 == "(04) (4) High school graduate", 12,
                    ifelse(ID21600DS5$H2RF1 == "(05) (5) GED", 12,
                    ifelse(ID21600DS5$H2RF1 == "(07) (7) College/didn't graduate", 13,
                    ifelse(ID21600DS5$H2RF1 == "(08) (8) Graduated from college/university", 16,
                    ifelse(ID21600DS5$H2RF1 == "(09) (9) Prof training beyond 4-year college/univ", 17, NA)))))))) 
  
#assign highest educational attainment
ID21600DS5$EDU<-pmax(ID21600DS5$H2RM1,ID21600DS5$H2RF1,na.rm = TRUE)
...
write.csv(ID21600DS5, file = 'ID21600DS5_recoded.csv')

#Exclude participants with more than 50% missing on depressive symtpoms items
ID21600DS5 <- ID21600DS5[which(ID21600DS5$dsmiss==0), ]

##Compute mean and sd across all participants within dataset
library('psych')
#Means & SDs of focal variables
dstatsage<-describe(ID21600DS5$AGECALC)
dstatsdep<-describe(ID21600DS5$DEP)
dstatsachv<-describe(ID21600DS5$ACHV)
dstatsinc<-describe(ID21600DS5$INC)
dstatsedu<-describe(ID21600DS5$EDU)
dstatsoccs<-NA#describe(ID21600DS5$OCCS)
dstatsoccp<-NA#describe(ID21600DS5$OCCP)

#Save descriptive stats
dstats<-rbind(dstatsage,dstatsdep,dstatsachv,dstatsinc,dstatsedu,dstatsoccs,dstatsoccp,make.row.names= FALSE)
write.csv(dstats,file = 'ID21600DS5_dstats.csv',
          row.names=c("dstatsage","dstatsdep","dstatsachv","dstatsinc","dstatsedu","dstatsoccs","dstatsoccp"))

##Histograms 
pdf('ID21600DS5_dephist.pdf')
hist(ID21600DS5$DEP, xlab="Depressive Symptoms", main = NULL, col="grey")
dev.off()
pdf('ID21600DS5_achvhist.pdf')
hist(ID21600DS5$ACHV, xlab="Academic Achievement", main = NULL, col="grey")
dev.off()
pdf('ID21600DS5_inchist.pdf')
hist(ID21600DS5$INC, xlab="Income", main = NULL, col="grey")
dev.off()
pdf('ID21600DS5_educhist.pdf')
hist(ID21600DS5$EDU, xlab="Educational Attainment", main = NULL, col="grey")
dev.off()
#pdf('ID21600DS5_occshist.pdf')
#hist(ID21600DS5$OCCS, xlab="Occupational Status", main = NULL, col="grey")
#dev.off()
#pdf('ID21600DS5_occphist.pdf')
#hist(ID21600DS5$OCCP, xlab="Occupational Prestige", main = NULL, col="grey")
#dev.off()
...
table(ID21600DS5$AGECALC)
#Separate dataset by developmental period, if needed
#CH<-ID21600DS5[which((ID21600DS5$AGECALC >= 5)&(ID21600DS5$AGECALC <= 11)), ]
AD<-ID21600DS5[which((ID21600DS5$AGECALC >= 12)&(ID21600DS5$AGECALC <= 17)), ]
YD<-ID21600DS5[which((ID21600DS5$AGECALC >= 18)&(ID21600DS5$AGECALC <= 25)), ]
#AT-ID21600DS5[which((ID21600DS5$AGECALC >= 26)&(ID21600DS5$AGECALC <= 64)), ]
#OA-ID21600DS5[which(ID21600DS5$AGECALC >= 65), ]
...
matrixvars <- c("INCMC","INC2","EDUMC","EDU2","DEP","DEPPW","ACHV","ACHVPW")
...
##Assign ICPSR ID number (ICPSR Number; e.g., file name = ID21600DS5, then DATAID = 21600)
#DATAID<-'21600'
#names(DATAID)<-'DATAID'
...
#Select variables for correlation matrix
AIYDMCmatrixvars <- matrixvars[-c(3:4)]
...
#Select variables for correlation matrix
MRYDFCmatrixvars<-matrixvars[-c(3:4)]
...
#install.packages('MBESS') #for reliability estimates
library('MBESS')
ALPHAOV <- NA#ci.reliability(data=MRYDF[2:20], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=MRYDF[2:20], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Select variables for correlation matrix
MRYDMCmatrixvars<-matrixvars[-c(3:4)]
...
#install.packages('MBESS') #for reliability estimates
library('MBESS')
ALPHAOV <- NA#ci.reliability(data=MRYDM[2:20], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=MRYDM[2:20], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
ID21600DS5_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
WHTADFAGGRTED,
WHTADMAGGRTED,
...
write.csv(ID21600DS5_aggregated, file = 'ID21600DS5_aggregated.csv',row.names = FALSE)
