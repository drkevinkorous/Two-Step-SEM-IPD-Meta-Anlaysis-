...
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: R3897101 
#Maternal Income: NA
#Paternal Income: NA
#Household Income: R4006600 
#Participant Education: R3710200
...
ID182DS0<-data.frame(R0000100,R3894900,R3895000,R3895100,R3895200,R3895300,R3895400,R3895500,R3895600,R3895700,
                     R3895800,R3895900,R3896000,R3896100,R3896200,R3896300,R3896400,R3896500,R3896600,R3896700,
                     R3896800,R0009600,R0010200,R0214800,R4007600,R3897101,R4006600,R3710200,R3728100) 
detach(merged182)
...
#Recode age 
levels(ID182DS0$R4007600)[levels(ID182DS0$R4007600)=="0 TO 21: < 22"]<-21 #(no participants are in this range)
levels(ID182DS0$R4007600)[levels(ID182DS0$R4007600)=="38 TO 99999: 38+"]<-38 #(no participants are in this range)
ID182DS0$AGECALC<-as.numeric(as.character(ID182DS0$R4007600))
...
write.csv(ID182DS0, file = 'ID182DS0_1992_recoded.csv')
...
#ALPHAOV <- ci.reliability(data=WHTCHF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTCHM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTADF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTADF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTADM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTADM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTYDF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTYDF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTYDM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTYDM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTATF[2:21], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTATF[2:21], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTATM[2:21], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTATM[2:21], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTOAF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTOAF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTOAM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTOAM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#names(DATAYEAR)<-'DATAYEAR'
##Compute reliability estimates
#ALPHAOV <- ci.reliability(data=LATCHF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATCHM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#names(DATAYEAR)<-'DATAYEAR'
##Compute reliability estimates
#ALPHAOV <- ci.reliability(data=LATADF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATADF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATADM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATADM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATYDF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATYDF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATYDM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATYDM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATATF[2:21], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATATF[2:21], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATATM[2:21], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATATM[2:21], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATOAF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATOAF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATOAM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATOAM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKADF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKADF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKADM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKADM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKYDF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKYDF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKYDM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKYDM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKATF[2:21], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKATF[2:21], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKATM[2:21], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKATM[2:21], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKOAF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKOAF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKOAM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKOAM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHMC[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHMC[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADMC[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADMC[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAYDF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAYDF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAYDM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAYDM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AAATF[2:21], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AAATF[2:21], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AAATM[2:21], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AAATM[2:21], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- NA#ci.reliability(data=AIYDF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- NA#ci.reliability(data=AIYDF[2:21], type = "omega", interval.type = "none")
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- NA#ci.reliability(data=AIYDM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- NA#ci.reliability(data=AIYDM[2:21], type = "omega", interval.type = "none")
#ALPHA <- NA#ALPHAOV$est
#OMEGA <- NA#OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AIATF[2:21], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AIATF[2:21], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AIATM[2:21], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AIATM[2:21], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIOAF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIOAF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIOAM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIOAM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRYDF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRYDF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRYDM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRYDM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRATF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRATF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRATM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRATM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MROAF[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MROAF[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MROAM[2:21], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MROAM[2:21], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
write.csv(ID182DS0_aggregated, file = 'ID182DS0_1992_aggregated.csv',row.names = FALSE)
