#load dataset
library('foreign')
demographics<-read.spss('H06B_R.SAV')
depression<-read.spss('H06D_R.SAV')
income<-read.spss('H06Q_H.sav')
employment<-read.spss('H06J_R.SAV')
other<-read.spss('H06A_R.SAV')
preload<-read.spss('H06PR_R.SAV')
education<-read.spss('H04B_R.SAV') #(from prior wave to combine with current wave)
#Merge datasets 
ID68542006<-merge(demographics,income,by="HHID")
ID68542006$HHIDPN<-paste(ID68542006$HHID,ID68542006$PN,sep = "")
depression$HHIDPN<-paste(depression$HHID,depression$PN,sep = "")
ID68542006<-merge(ID68542006,depression,by="HHIDPN")
employment$HHIDPN<-paste(employment$HHID,employment$PN,sep = "")
ID68542006<-merge(ID68542006,employment,by="HHIDPN")
other$HHIDPN<-paste(other$HHID,other$PN,sep = "")
ID68542006<-merge(ID68542006,other,by="HHIDPN")
preload$HHIDPN<-paste(preload$HHID,preload$PN,sep = "")
ID68542006<-merge(ID68542006,preload,by="HHIDPN")
education$HHIDPN<-paste(education$HHID,education$PN,sep = "")
education<-data.frame(education$HHIDPN,education$JB014A)
colnames(education)<-c("HHIDPN","JB014A")
ID68542006<-merge(ID68542006,education,by="HHIDPN",all.x=TRUE)
#Merge prior wave dep symptoms
depressionpw<-read.spss('H04D_R.SAV')
depressionpw$HHIDPN<-paste(depressionpw$HHID,depressionpw$PN,sep = "")
ID68542006<-merge(ID68542006,depressionpw,by="HHIDPN",all.x = TRUE)
#Coded variables
#Participant ID: HHID (household ID); PN (rep ID)
#Measure Name (not a variable in the dataset): CESD
#Depressive symptom items: 
#KD110,KD111,KD112,KD113(RC),KD114,KD115(RC),KD116,KD117
#Depressive symptom items prior wave:
#JD110,JD111,JD112,JD113(RC),JD114,JD115(RC),JD116,JD117
#Academic Achievement: NA
#Academic Achievement prior wave: NA
#Ethnicity: KB028 
#Race: KB089M1M,KB089M2M,KB089M3M  
#White: NA
#Black: NA 
...
#Birth Month: KX004_R
#Birth Day: NA
#Evaluation Year: KA501
#Evaluation Month: KA500
#Evaluation Day: NA
#Participant Income: KQ020  
#Maternal Income: NA
#Paternal Income: NA
#Household Income: KQ020+KQ045(partner)
#Participant Education: KB014, JB014A (from prior wave)
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: KJ062M 
...
ID6854DS0<-data.frame(HHIDPN,KD110,KD111,KD112,KD113,KD114,KD115,KD116,KD117,
                      JD110,JD111,JD112,JD113,JD114,JD115,JD116,JD117,KB028,
                      KB089M1M,KB089M2M,KB089M3M,KX060_R,KA019,KX067_R,
                      KX004_R,KA501,KA500,KQ020,KQ045,KB014,JB014A,KJ062M)
detach(ID68542006)
ID6854DS0$ORIGOBS<-nrow(ID6854DS0)
rm(ID68542006,demographics,depression,employment,income,other,preload,depressionpw,education)
...
#9=RF (refused)
ID6854DS0$KD110<-ifelse(ID6854DS0$KD110==1,1,
                ifelse(ID6854DS0$KD110==5,0,NA))
ID6854DS0$KD111<-ifelse(ID6854DS0$KD111==1,1,
                ifelse(ID6854DS0$KD111==5,0,NA))                 
ID6854DS0$KD112<-ifelse(ID6854DS0$KD112==1,1,
                ifelse(ID6854DS0$KD112==5,0,NA))
ID6854DS0$KD113<-ifelse(ID6854DS0$KD113==1,0,
                ifelse(ID6854DS0$KD113==5,1,NA))#RC
ID6854DS0$KD114<-ifelse(ID6854DS0$KD114==1,1,
                ifelse(ID6854DS0$KD114==5,0,NA))
ID6854DS0$KD115<-ifelse(ID6854DS0$KD115==1,0,
                ifelse(ID6854DS0$KD115==5,1,NA))#RC
ID6854DS0$KD116<-ifelse(ID6854DS0$KD116==1,1,
                ifelse(ID6854DS0$KD116==5,0,NA))
ID6854DS0$KD117<-ifelse(ID6854DS0$KD117==1,1,
                 ifelse(ID6854DS0$KD117==5,0,NA))
...
#8=DK (don't know); NA (not ascertained)
#9=RF (refused)
ID6854DS0$JD110<-ifelse(ID6854DS0$JD110==1,1,
                ifelse(ID6854DS0$JD110==5,0,NA))
ID6854DS0$JD111<-ifelse(ID6854DS0$JD111==1,1,
                ifelse(ID6854DS0$JD111==5,0,NA))                 
ID6854DS0$JD112<-ifelse(ID6854DS0$JD112==1,1,
                ifelse(ID6854DS0$JD112==5,0,NA))
ID6854DS0$JD113<-ifelse(ID6854DS0$JD113==1,0,
                ifelse(ID6854DS0$JD113==5,1,NA))#RC
ID6854DS0$JD114<-ifelse(ID6854DS0$JD114==1,1,
                ifelse(ID6854DS0$JD114==5,0,NA))
ID6854DS0$JD115<-ifelse(ID6854DS0$JD115==1,0,
                ifelse(ID6854DS0$JD115==5,1,NA))#RC
ID6854DS0$JD116<-ifelse(ID6854DS0$JD116==1,1,
                ifelse(ID6854DS0$JD116==5,0,NA))
ID6854DS0$JD117<-ifelse(ID6854DS0$JD117==1,1,
                 ifelse(ID6854DS0$JD117==5,0,NA))

#Assign dataframe that contains all depressive symtpoms (using the column numbers of the items)
dsitems <- ID6854DS0[c(2:9)]
dsitemspw <- ID6854DS0[c(10:17)]
...
ID6854DS0$DEPPW<-rowMeans(x=dsitemspw,na.rm=TRUE)
...
#1=YES
#5=NO
ID6854DS0$LAT<-ifelse(ID6854DS0$KB028==1,1,0)
#1=WHITE/CAUCASIAN
#2=BLACK/AFRICAN AM
#97=OTHER (SPECIFY);
#98=DK (don't know);
#99=RF (refused)
ID6854DS0$BLK<-ifelse(((ID6854DS0$KB089M1M==2)|(ID6854DS0$KB089M2M==2)|(ID6854DS0$KB089M3M==2)),1,0)
ID6854DS0$OTH<-ifelse(((ID6854DS0$KB089M1M==97)|(ID6854DS0$KB089M2M==97)|(ID6854DS0$KB089M3M==97)),1,0)
ID6854DS0$WHT<-ifelse(((ID6854DS0$KB089M1M==1)|(ID6854DS0$KB089M2M==1)|(ID6854DS0$KB089M3M==1)),1,0)

#Compute variable for participants who reported more than one race (mixed/biracial; do not include Latino/Hispanic)
ID6854DS0$MR<-ifelse((rowSums(x=cbind(ID6854DS0$WHT,ID6854DS0$BLK,ID6854DS0$OTH),
                              na.rm=TRUE)) > 1, 1, 0)

##Compute variables for participants who reported a single race (excluding mixed/biracial & Latino/Hispanic)
ID6854DS0$WHT<-ifelse(((ID6854DS0$LAT == 0)&(ID6854DS0$MR == 0)&(ID6854DS0$WHT == 1)), 1, 0)
ID6854DS0$BLK<-ifelse(((ID6854DS0$LAT == 0)&(ID6854DS0$MR == 0)&(ID6854DS0$BLK == 1)), 1, 0)
#ID6854DS0$AI<-ifelse(((ID6854DS0$LAT == 0)&(ID6854DS0$MR == 0)&(ID6854DS0$AI == 1)), 1, 0)
#ID6854DS0$AA<-ifelse(((ID6854DS0$LAT == 0)&(ID6854DS0$MR == 0)&(ID6854DS0$AA == 1)), 1, 0)
ID6854DS0$OTH<-ifelse(((ID6854DS0$LAT == 0)&(ID6854DS0$MR == 0)&(ID6854DS0$OTH == 1)), 1, 0)
ID6854DS0$MR<-ifelse(((ID6854DS0$LAT == 0)&(ID6854DS0$MR == 1)), 1, 0)

#Recode factor into numeric,
#1=MALE
#2=FEMALE
ID6854DS0$SEX<-ifelse(ID6854DS0$KX060_R==1,1,
               ifelse(ID6854DS0$KX060_R==2,0,NA))

#Recode age 
ID6854DS0$AGECALC<-ID6854DS0$KA019

#Income, Education, Occupation ----
##Income
ID6854DS0$KQ020[ID6854DS0$KQ020=="99999998"]<-NA
ID6854DS0$KQ020[ID6854DS0$KQ020=="99999999"]<-NA
ID6854DS0$KQ045[ID6854DS0$KQ045=="99999998"]<-NA
ID6854DS0$KQ045[ID6854DS0$KQ045=="99999999"]<-NA
ID6854DS0$INC<-rowSums(x=cbind(ID6854DS0$KQ020,ID6854DS0$KQ045),na.rm = TRUE)
        
##Education
#prior wave
ID6854DS0$JB014A[ID6854DS0$JB014A=="97"]<-NA
ID6854DS0$JB014A[ID6854DS0$JB014A=="99"]<-NA
#current wave
ID6854DS0$KB014[ID6854DS0$KB014=="97"]<-NA
ID6854DS0$KB014[ID6854DS0$KB014=="98"]<-NA
ID6854DS0$EDU<-pmax(ID6854DS0$KB014,ID6854DS0$JB014A,na.rm=TRUE)
...
write.csv(ID6854DS0, file = 'ID6854DS0_2006_recoded.csv')
...
ID6854DS0_2006_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID6854DS0_2006_aggregated, file = 'ID6854DS0_2006_aggregated.csv',row.names = FALSE)
