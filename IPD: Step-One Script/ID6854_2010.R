#load dataset
library('foreign')
#H10B_R.SAV (demographics) is partial data (a lot missing), merge with prior wave 
#merge with recoded data from 2008 (includes prior wave dep symptoms, race/ethnicity, and education)
demographics<-read.spss('H10B_R.SAV')
demographicspw<-read.csv(file = 'ID6854DS0_2008_recoded.csv')
demographicspw<-demographicspw[,c(2:10,20:23,36)]
...
depression<-read.spss('H10D_R.SAV')
income<-read.spss('H10Q_H.sav')
employment<-read.spss('H10J_R.SAV')
other<-read.spss('H10A_R.SAV')
preload<-read.spss('H10PR_R.SAV')
#Merge datasets
ID68542010<-merge(depression,income,by="HHID",all=TRUE)
ID68542010$HHIDPN<-paste(ID68542010$HHID,ID68542010$PN,sep = "")
demographics$HHIDPN<-paste(demographics$HHID,demographics$PN,sep = "")
ID68542010<-merge(ID68542010,demographics,by="HHIDPN",all=TRUE)
employment$HHIDPN<-paste(employment$HHID,employment$PN,sep = "")
ID68542010<-merge(ID68542010,employment,by="HHIDPN",all=TRUE)
other$HHIDPN<-paste(other$HHID,other$PN,sep = "")
ID68542010<-merge(ID68542010,other,by="HHIDPN",all=TRUE)
preload$HHIDPN<-paste(preload$HHID,preload$PN,sep = "")
ID68542010<-merge(ID68542010,preload,by="HHIDPN",all=TRUE)
#Coded variables
...
#LD110,LD111,LD112,LD113(RC),LD114,LD115(RC),LD116,LD117
#Academic Achievement: NA
#Academic Achievement prior wave: NA
#Ethnicity: MB028 prior wave: LB028
#Race: MB089M1M,MB089M2M,MB089M3M prior wave: LB089M1M,LB089M2M,LB089M3M
#White: NA
#Black: NA 
...
#Birth Month: MX004_R
#Birth Day: NA
#Evaluation Year: MA501
#Evaluation Month: MA500
#Evaluation Day: NA
#Participant Income: MQ020  
#Maternal Income: NA
#Paternal Income: NA
#Household Income: MQ020+MQ045(partner)
#Participant Education: MB014 prior wave: EDU
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: MJ062M 
...
ID6854DS0<-data.frame(HHIDPN,MD110,MD111,MD112,MD113,MD114,MD115,MD116,MD117,
                      LD110,LD111,LD112,LD113,LD114,LD115,LD116,LD117,MB028,LB028,
                      MB089M1M,MB089M2M,MB089M3M,LB089M1M,LB089M2M,LB089M3M,MX060_R,
                      MA019,MX067_R,MX004_R,MA501,MA500,MQ020,MQ045,MB014,EDU,MJ062M)
detach(ID68542010)
ID6854DS0$ORIGOBS<-nrow(ID6854DS0)
rm(ID68542010,demographics,depression,employment,income,other,preload,demographicspw)
...
#9=RF (refused)
ID6854DS0$MD110<-ifelse(ID6854DS0$MD110==1,1,
                ifelse(ID6854DS0$MD110==5,0,NA))
ID6854DS0$MD111<-ifelse(ID6854DS0$MD111==1,1,
                ifelse(ID6854DS0$MD111==5,0,NA))                 
ID6854DS0$MD112<-ifelse(ID6854DS0$MD112==1,1,
                ifelse(ID6854DS0$MD112==5,0,NA))
ID6854DS0$MD113<-ifelse(ID6854DS0$MD113==1,0,
                ifelse(ID6854DS0$MD113==5,1,NA))#RC
ID6854DS0$MD114<-ifelse(ID6854DS0$MD114==1,1,
                ifelse(ID6854DS0$MD114==5,0,NA))
ID6854DS0$MD115<-ifelse(ID6854DS0$MD115==1,0,
                ifelse(ID6854DS0$MD115==5,1,NA))#RC
ID6854DS0$MD116<-ifelse(ID6854DS0$MD116==1,1,
                ifelse(ID6854DS0$MD116==5,0,NA))
ID6854DS0$MD117<-ifelse(ID6854DS0$MD117==1,1,
                 ifelse(ID6854DS0$MD117==5,0,NA))
...
#1=YES
#5=NO
ID6854DS0$MB028<-ifelse(is.na(ID6854DS0$MB028),ID6854DS0$LB028,ID6854DS0$MB028)
ID6854DS0$LAT<-ifelse(ID6854DS0$MB028==1,1,0)
#1=WHITE/CAUCASIAN
#2=BLACK/AFRICAN AM
#97=OTHER (SPECIFY);
#98=DK (don't know);
#99=RF (refused)
ID6854DS0$MB089M1M<-ifelse(is.na(ID6854DS0$MB089M1M),ID6854DS0$LB089M1M,ID6854DS0$MB089M1M)
ID6854DS0$MB089M2M<-ifelse(is.na(ID6854DS0$MB089M2M),ID6854DS0$LB089M2M,ID6854DS0$MB089M2M)
ID6854DS0$MB089M3M<-ifelse(is.na(ID6854DS0$MB089M3M),ID6854DS0$LB089M3M,ID6854DS0$MB089M3M)
ID6854DS0$BLK<-ifelse(((ID6854DS0$MB089M1M==2)|(ID6854DS0$MB089M2M==2)|(ID6854DS0$MB089M3M==2)),1,0)
ID6854DS0$OTH<-ifelse(((ID6854DS0$MB089M1M==97)|(ID6854DS0$MB089M2M==97)|(ID6854DS0$MB089M3M==97)),1,0)
ID6854DS0$WHT<-ifelse(((ID6854DS0$MB089M1M==1)|(ID6854DS0$MB089M2M==1)|(ID6854DS0$MB089M3M==1)),1,0)
...
#1=MALE
#2=FEMALE
ID6854DS0$SEX<-ifelse(ID6854DS0$MX060_R==1,1,
               ifelse(ID6854DS0$MX060_R==2,0,NA))

#Recode age 
ID6854DS0$AGECALC<-ID6854DS0$MA019

#Income, Education, Occupation ----
##Income
ID6854DS0$MQ020[ID6854DS0$MQ020=="99999998"]<-NA
ID6854DS0$MQ020[ID6854DS0$MQ020=="99999999"]<-NA
ID6854DS0$MQ045[ID6854DS0$MQ045=="99999998"]<-NA
ID6854DS0$MQ045[ID6854DS0$MQ045=="99999999"]<-NA
ID6854DS0$INC<-rowSums(x=cbind(ID6854DS0$MQ020,ID6854DS0$MQ045),na.rm = TRUE)
        
##Education
ID6854DS0$MB014[ID6854DS0$MB014=="97"]<-NA
ID6854DS0$MB014[ID6854DS0$MB014=="98"]<-NA
#incorporate prior wave
ID6854DS0$EDU<-pmax(ID6854DS0$EDU,ID6854DS0$MB014,na.rm=TRUE)
...
write.csv(ID6854DS0, file = 'ID6854DS0_2010_recoded.csv')
...
ID6854DS0_2010_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID6854DS0_2010_aggregated, file = 'ID6854DS0_2010_aggregated.csv',row.names = FALSE)
