...
#Depressive symptom items: U1030700,U1030800(RC),U1030900,U1031000(RC),U1031100
#Depressive symptom items prior wave: NA
#Academic Achievement: self-report college GPA
#U0243400,U0243500,U0243600,U0243700
...
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: U0956900 
#Maternal Income: NA
#Paternal Income: NA
#Household Income: U0008900 
#Participant Education: S7683200,T2119900,T5322100,U0137000
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: U1127100 (2002 census codes) 
#Maternal Occupation: NA
#Paternal Occupation: NA
#Household Occupation: NA
#SES: NA
#Year of data collection (not a variable in the dataset): 2015
#Notes: NLSY97

#Create Dataset ----
attach(merged182)
#Extract relevant variables into a dataframe.
ID182DS0<-data.frame(R0000100,U1030700,U1030800,U1030900,U1031000,U1031100,U0243400,U0243500,U0243600,U0243700,
                     S1224800,S1224900,S1224901,S1224902,S1224903,S1224904,S1224905,R0536300,
                     U0001800,R0536402,R0536401,U0956900,U0008900,S7683200,T2119900,T5322100,U0137000,U1127100)
detach(merged182)
...
ID182DS0$U1030700<-ifelse(ID182DS0$U1030700=="All of the time",3,                 
                   ifelse(ID182DS0$U1030700=="Most of the time",2, 
                   ifelse(ID182DS0$U1030700=="Some of the time",1,       
                   ifelse(ID182DS0$U1030700=="None of the time",0,NA))))
ID182DS0$U1030800<-ifelse(ID182DS0$U1030800=="All of the time",0,                 
                   ifelse(ID182DS0$U1030800=="Most of the time",1, 
                   ifelse(ID182DS0$U1030800=="Some of the time",2,       
                   ifelse(ID182DS0$U1030800=="None of the time",3,NA))))#RC
ID182DS0$U1030900<-ifelse(ID182DS0$U1030900=="All of the time",3,                 
                   ifelse(ID182DS0$U1030900=="Most of the time",2, 
                   ifelse(ID182DS0$U1030900=="Some of the time",1,       
                   ifelse(ID182DS0$U1030900=="None of the time",0,NA))))
ID182DS0$U1031000<-ifelse(ID182DS0$U1031000=="All of the time",0,                 
                   ifelse(ID182DS0$U1031000=="Most of the time",1, 
                   ifelse(ID182DS0$U1031000=="Some of the time",2,       
                   ifelse(ID182DS0$U1031000=="None of the time",3,NA))))#RC
ID182DS0$U1031100<-ifelse(ID182DS0$U1031100=="All of the time",3,                 
                   ifelse(ID182DS0$U1031100=="Most of the time",2, 
                   ifelse(ID182DS0$U1031100=="Some of the time",1,       
                   ifelse(ID182DS0$U1031100=="None of the time",0,NA))))
...
ID182DS0$U0243400<-colGPArecode(ID182DS0$U0243400)
ID182DS0$U0243500<-colGPArecode(ID182DS0$U0243500)
ID182DS0$U0243600<-colGPArecode(ID182DS0$U0243600)
ID182DS0$U0243700<-colGPArecode(ID182DS0$U0243700)
ID182DS0$ACHV<-rowMeans(x=cbind(ID182DS0$U0243400,ID182DS0$U0243500,ID182DS0$U0243600,
                                ID182DS0$U0243700),na.rm = TRUE)
...
#Recode age 
ID182DS0$AGECALC<-ID182DS0$U0001800

#Income, Education, Occupation ----
##Income
#Take highest income reported
ID182DS0$INC<-pmax(ID182DS0$U0956900,ID182DS0$U0008900,na.rm = TRUE)
...
ID182DS0$U0137000<-ifelse(ID182DS0$U0137000=="1ST GRADE",1,         
                   ifelse(ID182DS0$U0137000=="2ND GRADE",2,          
                   ifelse(ID182DS0$U0137000=="3RD GRADE",3,         
                   ifelse(ID182DS0$U0137000=="4TH GRADE",4,          
                   ifelse(ID182DS0$U0137000=="5TH GRADE",5,         
                   ifelse(ID182DS0$U0137000=="6TH GRADE",6,          
                   ifelse(ID182DS0$U0137000=="7TH GRADE",7,         
                   ifelse(ID182DS0$U0137000=="8TH GRADE",8,          
                   ifelse(ID182DS0$U0137000=="9TH GRADE",9,         
                   ifelse(ID182DS0$U0137000=="10TH GRADE",10,         
                   ifelse(ID182DS0$U0137000=="11TH GRADE",11,        
                   ifelse(ID182DS0$U0137000=="12TH GRADE",12,         
                   ifelse(ID182DS0$U0137000=="1ST YEAR COLLEGE",13,        
                   ifelse(ID182DS0$U0137000=="2ND YEAR COLLEGE",14,         
                   ifelse(ID182DS0$U0137000=="3RD YEAR COLLEGE",15,        
                   ifelse(ID182DS0$U0137000=="4TH YEAR COLLEGE",16,         
                   ifelse(ID182DS0$U0137000=="5TH YEAR COLLEGE",17,        
                   ifelse(ID182DS0$U0137000=="6TH YEAR COLLEGE",18,         
                   ifelse(ID182DS0$U0137000=="7TH YEAR COLLEGE",19,        
                   ifelse(ID182DS0$U0137000=="8TH YEAR COLLEGE OR MORE",20,NA))))))))))))))))))))
#Not all participants answered education, use prior waves for missing data
ID182DS0$EDU<-pmax(ID182DS0$S7683200,ID182DS0$T2119900,ID182DS0$T5322100,ID182DS0$U0137000,na.rm = TRUE)
...
occ_codes<-read.csv('IPD182DS0_NLSY97_2015_Occupational codes.csv')
...
ID182DS0$U1127100<-factor(ID182DS0$U1127100)
ID182DS0$OCCS<-as.numeric(as.character(occstatusvalues[ match(ID182DS0$U1127100, occvalues) ]))
...
ID182DS0$U1127100<-factor(ID182DS0$U1127100)
ID182DS0$OCCP<-as.numeric(as.character(occprestvalues[ match(ID182DS0$U1127100, occvalues) ]))

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID182DS0, file = 'ID182NLSY97_2015_recoded.csv')
...
#Select variables for correlation matrix
AAATFCmatrixvars<-matrixvars[-10]
...
#Select variables for correlation matrix
AIATFCmatrixvars<-matrixvars[-c(10)]
...
#Select variables for correlation matrix
AIATMCmatrixvars<-matrixvars[-c(10)]
...
write.csv(ID182DS0_aggregated, file = 'ID182NLSY97_2015_aggregated.csv',row.names = FALSE)
