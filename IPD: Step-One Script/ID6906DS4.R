...
load('06906-0001-Data.rda')
load('06906-0004-Data.rda')
merged6906<-merge(da06906.0001,da06906.0004,by="MCASEID")
...
#DS4 for DS
#DS10 for income
#ID6041DS1 for race, prior wave dep symptoms, & education (W1 data)
...
#E202A,E202B,E202C,E202D,E202E,E202F,E202G,E202H,E202I,E202J,E202K,E202L
...
#Birth Month: MA2
#Birth Day: MA3
#Evaluation Year: MR35
#Evaluation Month: MR33
#Evaluation Day: MR34
#Participant Income: MQ2,MUBWR   
#Maternal Income: NA
#Paternal Income: NA
#Household Income: MUBHHTOT
#Participant Education: EDUCAT
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: MP10A 
...
#Notes: NSFH Wave 2 (Main Respondent Data) 

#Create Dataset ----
attach(merged6906)
#Extract relevant variables into a dataframe.
ID6906DS4<-data.frame(MCASEID,MT206A,MT206B,MT206C,MT206D,MT206E,MT206F,MT206G,MT206H,MT206I,MT206J,MT206K,MT206L,
                      E202A,E202B,E202C,E202D,E202E,E202F,E202G,E202H,E202I,E202J,E202K,E202L,
                      M484,MA7,MA8,MA4,MA2,MA3,MR35,MR33,MR34,MQ2,MUBWR,MUBHHTOT,EDUCAT,MP10A,MP10B) 
detach(merged6906)
ID6906DS4$ORIGOBS<-nrow(ID6906DS4)
rm(merged6906,da06041.0001,da06906.0001,da06906.0004,da06906.0010)
...
ID6906DS4$MT206A<-ifelse(ID6906DS4$MT206A==0,0,
                  ifelse(((ID6906DS4$MT206A==1)|(ID6906DS4$MT206A==2)),1,
                  ifelse(((ID6906DS4$MT206A==3)|(ID6906DS4$MT206A==4)),2,
                  ifelse(ID6906DS4$MT206A>=5,3,NA))))
ID6906DS4$MT206B<-ifelse(ID6906DS4$MT206B==0,0,
                  ifelse(((ID6906DS4$MT206B==1)|(ID6906DS4$MT206B==2)),1,
                  ifelse(((ID6906DS4$MT206B==3)|(ID6906DS4$MT206B==4)),2,
                  ifelse(ID6906DS4$MT206B>=5,3,NA))))
ID6906DS4$MT206C<-ifelse(ID6906DS4$MT206C==0,0,
                  ifelse(((ID6906DS4$MT206C==1)|(ID6906DS4$MT206C==2)),1,
                  ifelse(((ID6906DS4$MT206C==3)|(ID6906DS4$MT206C==4)),2,
                  ifelse(ID6906DS4$MT206C>=5,3,NA))))
ID6906DS4$MT206D<-ifelse(ID6906DS4$MT206D==0,0,
                  ifelse(((ID6906DS4$MT206D==1)|(ID6906DS4$MT206D==2)),1,
                  ifelse(((ID6906DS4$MT206D==3)|(ID6906DS4$MT206D==4)),2,
                  ifelse(ID6906DS4$MT206D>=5,3,NA))))
ID6906DS4$MT206E<-ifelse(ID6906DS4$MT206E==0,0,
                  ifelse(((ID6906DS4$MT206E==1)|(ID6906DS4$MT206E==2)),1,
                  ifelse(((ID6906DS4$MT206E==3)|(ID6906DS4$MT206E==4)),2,
                  ifelse(ID6906DS4$MT206E>=5,3,NA))))
ID6906DS4$MT206F<-ifelse(ID6906DS4$MT206F==0,0,
                  ifelse(((ID6906DS4$MT206F==1)|(ID6906DS4$MT206F==2)),1,
                  ifelse(((ID6906DS4$MT206F==3)|(ID6906DS4$MT206F==4)),2,
                  ifelse(ID6906DS4$MT206F>=5,3,NA))))
ID6906DS4$MT206G<-ifelse(ID6906DS4$MT206G==0,0,
                  ifelse(((ID6906DS4$MT206G==1)|(ID6906DS4$MT206G==2)),1,
                  ifelse(((ID6906DS4$MT206G==3)|(ID6906DS4$MT206G==4)),2,
                  ifelse(ID6906DS4$MT206G>=5,3,NA))))
ID6906DS4$MT206H<-ifelse(ID6906DS4$MT206H==0,0,
                  ifelse(((ID6906DS4$MT206H==1)|(ID6906DS4$MT206H==2)),1,
                  ifelse(((ID6906DS4$MT206H==3)|(ID6906DS4$MT206H==4)),2,
                  ifelse(ID6906DS4$MT206H>=5,3,NA))))
ID6906DS4$MT206I<-ifelse(ID6906DS4$MT206I==0,0,
                  ifelse(((ID6906DS4$MT206I==1)|(ID6906DS4$MT206I==2)),1,
                  ifelse(((ID6906DS4$MT206I==3)|(ID6906DS4$MT206I==4)),2,
                  ifelse(ID6906DS4$MT206I>=5,3,NA))))
ID6906DS4$MT206J<-ifelse(ID6906DS4$MT206J==0,0,
                  ifelse(((ID6906DS4$MT206J==1)|(ID6906DS4$MT206J==2)),1,
                  ifelse(((ID6906DS4$MT206J==3)|(ID6906DS4$MT206J==4)),2,
                  ifelse(ID6906DS4$MT206J>=5,3,NA))))
ID6906DS4$MT206K<-ifelse(ID6906DS4$MT206K==0,0,
                  ifelse(((ID6906DS4$MT206K==1)|(ID6906DS4$MT206K==2)),1,
                  ifelse(((ID6906DS4$MT206K==3)|(ID6906DS4$MT206K==4)),2,
                  ifelse(ID6906DS4$MT206K>=5,3,NA))))
ID6906DS4$MT206L<-ifelse(ID6906DS4$MT206L==0,0,
                  ifelse(((ID6906DS4$MT206L==1)|(ID6906DS4$MT206L==2)),1,
                  ifelse(((ID6906DS4$MT206L==3)|(ID6906DS4$MT206L==4)),2,
                  ifelse(ID6906DS4$MT206L>=5,3,NA))))
...
#Occasionally or a moderate amount of time: 3-4 days (code as 2)
#Most or all of the time: 5 - 7 days (Code as 3)
ID6906DS4$E202A<-ifelse(ID6906DS4$E202A==0,0,
                  ifelse(((ID6906DS4$E202A==1)|(ID6906DS4$E202A==2)),1,
                  ifelse(((ID6906DS4$E202A==3)|(ID6906DS4$E202A==4)),2,
                  ifelse(ID6906DS4$E202A>=5,3,NA))))
ID6906DS4$E202B<-ifelse(ID6906DS4$E202B==0,0,
                  ifelse(((ID6906DS4$E202B==1)|(ID6906DS4$E202B==2)),1,
                  ifelse(((ID6906DS4$E202B==3)|(ID6906DS4$E202B==4)),2,
                  ifelse(ID6906DS4$E202B>=5,3,NA))))
ID6906DS4$E202C<-ifelse(ID6906DS4$E202C==0,0,
                  ifelse(((ID6906DS4$E202C==1)|(ID6906DS4$E202C==2)),1,
                  ifelse(((ID6906DS4$E202C==3)|(ID6906DS4$E202C==4)),2,
                  ifelse(ID6906DS4$E202C>=5,3,NA))))
ID6906DS4$E202D<-ifelse(ID6906DS4$E202D==0,0,
                  ifelse(((ID6906DS4$E202D==1)|(ID6906DS4$E202D==2)),1,
                  ifelse(((ID6906DS4$E202D==3)|(ID6906DS4$E202D==4)),2,
                  ifelse(ID6906DS4$E202D>=5,3,NA))))
ID6906DS4$E202E<-ifelse(ID6906DS4$E202E==0,0,
                  ifelse(((ID6906DS4$E202E==1)|(ID6906DS4$E202E==2)),1,
                  ifelse(((ID6906DS4$E202E==3)|(ID6906DS4$E202E==4)),2,
                  ifelse(ID6906DS4$E202E>=5,3,NA))))
ID6906DS4$E202F<-ifelse(ID6906DS4$E202F==0,0,
                  ifelse(((ID6906DS4$E202F==1)|(ID6906DS4$E202F==2)),1,
                  ifelse(((ID6906DS4$E202F==3)|(ID6906DS4$E202F==4)),2,
                  ifelse(ID6906DS4$E202F>=5,3,NA))))
ID6906DS4$E202G<-ifelse(ID6906DS4$E202G==0,0,
                  ifelse(((ID6906DS4$E202G==1)|(ID6906DS4$E202G==2)),1,
                  ifelse(((ID6906DS4$E202G==3)|(ID6906DS4$E202G==4)),2,
                  ifelse(ID6906DS4$E202G>=5,3,NA))))
ID6906DS4$E202H<-ifelse(ID6906DS4$E202H==0,0,
                  ifelse(((ID6906DS4$E202H==1)|(ID6906DS4$E202H==2)),1,
                  ifelse(((ID6906DS4$E202H==3)|(ID6906DS4$E202H==4)),2,
                  ifelse(ID6906DS4$E202H>=5,3,NA))))
ID6906DS4$E202I<-ifelse(ID6906DS4$E202I==0,0,
                  ifelse(((ID6906DS4$E202I==1)|(ID6906DS4$E202I==2)),1,
                  ifelse(((ID6906DS4$E202I==3)|(ID6906DS4$E202I==4)),2,
                  ifelse(ID6906DS4$E202I>=5,3,NA))))
ID6906DS4$E202J<-ifelse(ID6906DS4$E202J==0,0,
                  ifelse(((ID6906DS4$E202J==1)|(ID6906DS4$E202J==2)),1,
                  ifelse(((ID6906DS4$E202J==3)|(ID6906DS4$E202J==4)),2,
                  ifelse(ID6906DS4$E202J>=5,3,NA))))
ID6906DS4$E202K<-ifelse(ID6906DS4$E202K==0,0,
                  ifelse(((ID6906DS4$E202K==1)|(ID6906DS4$E202K==2)),1,
                  ifelse(((ID6906DS4$E202K==3)|(ID6906DS4$E202K==4)),2,
                  ifelse(ID6906DS4$E202K>=5,3,NA))))
ID6906DS4$E202L<-ifelse(ID6906DS4$E202L==0,0,
                  ifelse(((ID6906DS4$E202L==1)|(ID6906DS4$E202L==2)),1,
                  ifelse(((ID6906DS4$E202L==3)|(ID6906DS4$E202L==4)),2,
                  ifelse(ID6906DS4$E202L>=5,3,NA))))


#Assign dataframe that contains all depressive symtpoms (using the column numbers of the items)
dsitems <- ID6906DS4[c(2:13)]
dsitemspw <- ID6906DS4[c(14:25)]
#Identify participants missing more than half of dsitems (not dsitemsW1) (1=missing > 50%) - to be used later
ID6906DS4$dsmiss<-ifelse(rowSums(is.na(dsitems))>((ncol(dsitems)/2)),1,0)
#Compute mean symptom score 
ID6906DS4$DEP<-rowMeans(x=dsitems,na.rm=TRUE)
ID6906DS4$DEPPW<-rowMeans(x=dsitemspw,na.rm=TRUE)
...
ID6906DS4$LAT<-ifelse(((ID6906DS4$M484 == "(3) MEX/CHICANO/MEX.AM")|
                       (ID6906DS4$M484 == "(4) PUERTO RICAN")|
                       (ID6906DS4$M484 == "(5) CUBAN")|
                       (ID6906DS4$M484 == "(6) OTHER HISPANIC")),1,0)
ID6906DS4$WHT<-ifelse(ID6906DS4$M484=="(2) WHITE/NOT HISPANIC",1,0)
ID6906DS4$BLK<-ifelse(ID6906DS4$M484=="(1) BLACK",1,0)
ID6906DS4$AI<-ifelse(ID6906DS4$M484=="(7) AMERICAN INDIAN",1,0)
ID6906DS4$AA<-ifelse(ID6906DS4$M484=="(8) ASIAN",1,0)
ID6906DS4$OTH<-ifelse(ID6906DS4$M484=="(9) OTHER",1,0)
#Compute variable for participants who reported more than one race (mixed/biracial; do not include Latino/Hispanic)
ID6906DS4$MR<- NA#ifelse((rowSums(x=cbind(ID6906DS4$WHT,ID6906DS4$BLK,ID6906DS4$OTH),
                             #na.rm=TRUE)) > 1, 1, 0)

##Compute variables for participants who reported a single race (excluding mixed/biracial & Latino/Hispanic)
#ID6906DS4$WHT<-ifelse(((ID6906DS4$LAT == 0)&(ID6906DS4$MR == 0)&(ID6906DS4$WHT == 1)), 1, 0)
#ID6906DS4$BLK<-ifelse(((ID6906DS4$LAT == 0)&(ID6906DS4$MR == 0)&(ID6906DS4$BLK == 1)), 1, 0)
#ID6906DS4$AI<-ifelse(((ID6906DS4$LAT == 0)&(ID6906DS4$MR == 0)&(ID6906DS4$AI == 1)), 1, 0)
#ID6906DS4$AA<-ifelse(((ID6906DS4$LAT == 0)&(ID6906DS4$MR == 0)&(ID6906DS4$AA == 1)), 1, 0)
#ID6906DS4$OTH<-ifelse(((ID6906DS4$LAT == 0)&(ID6906DS4$MR == 0)&(ID6906DS4$OTH == 1)), 1, 0)
#ID6906DS4$MR<-ifelse(((ID6906DS4$LAT == 0)&(ID6906DS4$MR == 1)), 1, 0)

#Recode factor into numeric,
ID6906DS4$SEX<-ifelse(ID6906DS4$MA7=="(1) MALE",1,0)

#Recode age 
ID6906DS4$AGECALC<-ID6906DS4$MA8

#Income, Education, Occupation ----
##Income
ID6906DS4$INC<-pmax(ID6906DS4$MQ2,ID6906DS4$MUBWR,ID6906DS4$MUBHHTOT,na.rm = TRUE)
        
##Education
ID6906DS4$EDU<-ifelse(ID6906DS4$EDUCAT=="(00) NO FORML EDUCATION",0, 
               ifelse(ID6906DS4$EDUCAT=="(01) FIRST GRADE",1,       
               ifelse(ID6906DS4$EDUCAT=="(02) SECOND GRADE",2,       
               ifelse(ID6906DS4$EDUCAT=="(03) THIRD GRADE",3,       
               ifelse(ID6906DS4$EDUCAT=="(04) FOURTH GRADE",4,       
               ifelse(ID6906DS4$EDUCAT=="(05) FIFTH GRADE",5,       
               ifelse(ID6906DS4$EDUCAT=="(06) SIXTH GRADE",6,        
               ifelse(ID6906DS4$EDUCAT=="(07) SEVENTH GRADE",7,     
               ifelse(ID6906DS4$EDUCAT=="(08) EIGHT GRADE",8,        
               ifelse(ID6906DS4$EDUCAT=="(09) NINTH GRADE",9,       
               ifelse(ID6906DS4$EDUCAT=="(10) TENTH GRADE",10,        
               ifelse(ID6906DS4$EDUCAT=="(11) ELEVENTH GRADE",11,    
               ifelse(ID6906DS4$EDUCAT=="(12) HIGH SCHL GRADUATE",12, 
               ifelse(ID6906DS4$EDUCAT=="(13) ATTND COLL/NO DGR",13, 
               ifelse(ID6906DS4$EDUCAT=="(14) ASSOC DEGREE-2YR",14,   
               ifelse(ID6906DS4$EDUCAT=="(15) ENROLLED 3 YRS",15,    
               ifelse(ID6906DS4$EDUCAT=="(16) BACHELOR'S DEGREE",16,  
               ifelse(ID6906DS4$EDUCAT=="(17) ENROLLED POST GRAD",17,
               ifelse(ID6906DS4$EDUCAT=="(18) MASTER'S DEGREE",18,    
               ifelse(ID6906DS4$EDUCAT=="(19) ENROLLD POST-MASTR",19,
               ifelse(ID6906DS4$EDUCAT=="(20) DOCTORATE/PROF DGR",20,NA)))))))))))))))))))))

##Occupation
#Recode factor into numeric (occupational status)
#Nam-Powers-Boyd scale (Nam & Boyd, 2008)
occ_codes<-read.csv('ID6906DS4_Occupational codes.csv')
...
ID6906DS4$OCCS<-as.numeric(as.character(occstatusvalues[ match(ID6906DS4$MP10A, occvalues) ]))
...
ID6906DS4$OCCP<-as.numeric(as.character(occprestvalues[ match(ID6906DS4$MP10A, occvalues) ]))

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID6906DS4, file = 'ID6906DS4_recoded.csv')

#Descriptives and Correlations -----
#Exclude participants with more than 50% missing on depressive symptoms items
ID6906DS4 <- ID6906DS4[which(ID6906DS4$dsmiss==0), ]

##Compute mean and sd across all participants within dataset
library('psych')
#Means & SDs of focal variables
dstatsage<-describe(ID6906DS4$AGECALC)
dstatsdep<-describe(ID6906DS4$DEP)
dstatsachv<-NA#describe(ID6906DS4$ACHV)
dstatsinc<-describe(ID6906DS4$INC)
dstatsedu<-describe(ID6906DS4$EDU)
dstatsoccs<-describe(ID6906DS4$OCCS)
dstatsoccp<-describe(ID6906DS4$OCCP)

#Save descriptive stats
dstats<-rbind(dstatsage,dstatsdep,dstatsachv,dstatsinc,dstatsedu,dstatsoccs,dstatsoccp,make.row.names= FALSE)
write.csv(dstats,file = 'ID6906DS4_dstats.csv',
          row.names=c("dstatsage","dstatsdep","dstatsachv","dstatsinc","dstatsedu","dstatsoccs","dstatsoccp"))

##Histograms 
pdf('ID6906DS4_dephist.pdf')
hist(ID6906DS4$DEP, xlab="Depressive Symptoms", main = NULL, col="grey")
dev.off()
#pdf('ID6906DS4_achvhist.pdf')
#hist(ID6906DS4$ACHV, xlab="Academic Achievement", main = NULL, col="grey")
#dev.off()
pdf('ID6906DS4_inchist.pdf')
hist(ID6906DS4$INC, xlab="Income", main = NULL, col="grey")
dev.off()
pdf('ID6906DS4_educhist.pdf')
hist(ID6906DS4$EDU, xlab="Educational Attainment", main = NULL, col="grey")
dev.off()
pdf('ID6906DS4_occshist.pdf')
hist(ID6906DS4$OCCS, xlab="Occupational Status", main = NULL, col="grey")
dev.off()
pdf('ID6906DS4_occphist.pdf')
hist(ID6906DS4$OCCP, xlab="Occupational Prestige", main = NULL, col="grey")
dev.off()
...
table(ID6906DS4$AGECALC)
#Separate dataset by developmental period, if needed
#CH<-ID6906DS4[which((ID6906DS4$AGECALC >= 5)&(ID6906DS4$AGECALC <= 11)), ] 
#AD<-ID6906DS4[which((ID6906DS4$AGECALC >= 12)&(ID6906DS4$AGECALC <= 17)), ]
YD<-ID6906DS4[which((ID6906DS4$AGECALC >= 18)&(ID6906DS4$AGECALC <= 25)), ]
AT<-ID6906DS4[which((ID6906DS4$AGECALC >= 26)&(ID6906DS4$AGECALC <= 64)), ]
OA<-ID6906DS4[which(ID6906DS4$AGECALC >= 65), ]
...
##Assign ICPSR ID number (ICPSR Number; e.g., file name = ID6906DS4, then DATAID = 21600)
#DATAID<-'6906'
#names(DATAID)<-'DATAID'
...
ID6906DS4_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID6906DS4_aggregated, file = 'ID6906DS4_aggregated.csv',row.names = FALSE)
