...
merged21600<-merge(da21600.0008,da21600.0005,by="AID",all.x=TRUE)
#Coded variables
#Participant ID: AID
#Measure Name (not a variable in the dataset): CESD 
#Depressive symptom items: H3SP5,H3SP6,H3SP7(RC),H3SP8,H3SP9,H3SP10,H3SP11(RC),
#                          H3SP12,H3SP13
#Depressive symptom items prior wave: H2FS1,H2FS2,H2FS3,H2FS4,H2FS5,H2FS6,H2FS7,H2FS8,H2FS9,H2FS10,H2FS11,
#                                H2FS12,H2FS13,H2FS14,H2FS15,H2FS16,H2FS17,H2FS18,H2FS19
#Academic Acehievement: NA
#Academic Acehievement prior wave: NA
#Ethnicity: H3OD2
#Race: H3OD6
#White: H3OD4A
#Black: H3OD4B 
#Asian or Pacific Islander: H3OD4D
#Native American: H3OD4C
...
#Birth Month: H3OD1M
#Birth Day: NA
#Evaluation Year: IYEAR3
#Evaluation Month: IMONTH3
#Evaluation Day: IDAY3
#Participant Income: H3EC2 
#Maternal Income: NA
#Paternal Income: NA
#Household Income: H3EC6 (if living with parents), H3EC8 (if not living with parents)
#Participant Education: H3ED1
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: H3LM26C 
#Maternal Occupation: NA
#Paternal Occupation: NA
#Household Occupation: NA
#SES: NA
#Year of data collection (not a variable in the dataset): 2001 (IYEAR3)
#Notes: In-home questionnaire

attach(merged21600)
#Extract relevant variables into a dataframe.
ID21600DS8<-data.frame(AID,H3SP5,H3SP6,H3SP7,H3SP8,H3SP9,H3SP10,H3SP11,H3SP12,H3SP13,H2FS1,H2FS2,H2FS3,H2FS4,H2FS5,
                       H2FS6,H2FS7,H2FS8,H2FS9,H2FS10,H2FS11,H2FS12,H2FS13,H2FS14,H2FS15,H2FS16,H2FS17,H2FS18,H2FS19,
                       H3OD2,H3OD6,H3OD4A,H3OD4B,H3OD4D,H3OD4C,BIO_SEX3,CALCAGE3,H3OD1Y,H3OD1M,IYEAR3,IMONTH3,IDAY3,
                       H3EC2,H3ED1,H3EC6,H3EC8,H3LM26C)

detach(merged21600)
ID21600DS8$ORIGOBS<-nrow(da21600.0008)
rm(da21600.0008,da21600.0005,merged21600)
...
ID21600DS8$H3SP5<-ifelse(ID21600DS8$H3SP5 == "(0) (0) Never/rarely",0, 
                  ifelse(ID21600DS8$H3SP5 == "(1) (1) Sometimes",1, 
                  ifelse(ID21600DS8$H3SP5 == "(2) (2) A lot of the time",2,
                  ifelse(ID21600DS8$H3SP5 == "(3) (3) Most of the time/all of the time",3,NA))))
ID21600DS8$H3SP6<-ifelse(ID21600DS8$H3SP6 == "(0) (0) Never/rarely",0, 
                  ifelse(ID21600DS8$H3SP6 == "(1) (1) Sometimes",1, 
                  ifelse(ID21600DS8$H3SP6 == "(2) (2) A lot of the time",2,
                  ifelse(ID21600DS8$H3SP6 == "(3) (3) Most of the time/all of the time",3,NA))))
ID21600DS8$H3SP7<-ifelse(ID21600DS8$H3SP7 == "(0) (0) Never/rarely",3, 
                  ifelse(ID21600DS8$H3SP7 == "(1) (1) Sometimes",2, 
                  ifelse(ID21600DS8$H3SP7 == "(2) (2) A lot of the time",1,
                  ifelse(ID21600DS8$H3SP7 == "(3) (3) Most of the time/all of the time",0,NA)))) #reverse coded
ID21600DS8$H3SP8<-ifelse(ID21600DS8$H3SP8 == "(0) (0) Never/rarely",0, 
                  ifelse(ID21600DS8$H3SP8 == "(1) (1) Sometimes",1, 
                  ifelse(ID21600DS8$H3SP8 == "(2) (2) A lot of the time",2,
                  ifelse(ID21600DS8$H3SP8 == "(3) (3) Most of the time/all of the time",3,NA))))
ID21600DS8$H3SP9<-ifelse(ID21600DS8$H3SP9 == "(0) (0) Never/rarely",0, 
                  ifelse(ID21600DS8$H3SP9 == "(1) (1) Sometimes",1, 
                  ifelse(ID21600DS8$H3SP9 == "(2) (2) A lot of the time",2,
                  ifelse(ID21600DS8$H3SP9 == "(3) (3) Most of the time/all of the time",3,NA))))
ID21600DS8$H3SP10<-ifelse(ID21600DS8$H3SP10 == "(0) (0) Never/rarely",0, 
                  ifelse(ID21600DS8$H3SP10 == "(1) (1) Sometimes",1, 
                  ifelse(ID21600DS8$H3SP10 == "(2) (2) A lot of the time",2,
                  ifelse(ID21600DS8$H3SP10 == "(3) (3) Most of the time/all of the time",3,NA))))
ID21600DS8$H3SP11<-ifelse(ID21600DS8$H3SP11 == "(0) (0) Never/rarely",3, 
                   ifelse(ID21600DS8$H3SP11 == "(1) (1) Sometimes",2, 
                   ifelse(ID21600DS8$H3SP11 == "(2) (2) A lot of the time",1,
                   ifelse(ID21600DS8$H3SP11 == "(3) (3) Most of the time/all of the time",0,NA)))) #reverse coded
ID21600DS8$H3SP12<-ifelse(ID21600DS8$H3SP12 == "(0) (0) Never/rarely",0, 
                  ifelse(ID21600DS8$H3SP12 == "(1) (1) Sometimes",1, 
                  ifelse(ID21600DS8$H3SP12 == "(2) (2) A lot of the time",2,
                  ifelse(ID21600DS8$H3SP12 == "(3) (3) Most of the time/all of the time",3,NA))))
ID21600DS8$H3SP13<-ifelse(ID21600DS8$H3SP13 == "(0) (0) Never/rarely",0, 
                  ifelse(ID21600DS8$H3SP13 == "(1) (1) Sometimes",1, 
                  ifelse(ID21600DS8$H3SP13 == "(2) (2) A lot of the time",2,
                  ifelse(ID21600DS8$H3SP13 == "(3) (3) Most of the time/all of the time",3,NA))))

#Recode depressive symptoms prior wave
ID21600DS8$H2FS1<-ifelse(ID21600DS8$H2FS1 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS1 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS8$H2FS1 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS8$H2FS1 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS2<-ifelse(ID21600DS8$H2FS2 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS2 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS8$H2FS2 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS8$H2FS2 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS3<-ifelse(ID21600DS8$H2FS3 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS3 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS8$H2FS3 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS8$H2FS3 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS4<-ifelse(ID21600DS8$H2FS4 == "(0) (0) Never/rarely", 3, ifelse(ID21600DS8$H2FS4 == "(1) (1) Sometimes", 2, 
                  ifelse(ID21600DS8$H2FS4 == "(2) (2) A lot of the time", 1,
                  ifelse(ID21600DS8$H2FS4 == "(3) (3) Most/all of the time",0,NA))))#reverse coded item
ID21600DS8$H2FS5<-ifelse(ID21600DS8$H2FS5 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS5 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS8$H2FS5 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS8$H2FS5 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS6<-ifelse(ID21600DS8$H2FS6 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS6 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS8$H2FS6 == "(2) (2) A lot of the time", 2, 
                  ifelse(ID21600DS8$H2FS6 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS7<-ifelse(ID21600DS8$H2FS7 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS7 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS8$H2FS7 == "(2) (2) A lot of the time", 2,
                  ifelse(ID21600DS8$H2FS7 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS8<-ifelse(ID21600DS8$H2FS8 == "(0) (0) Never/rarely", 3, ifelse(ID21600DS8$H2FS8 == "(1) (1) Sometimes", 2, 
                  ifelse(ID21600DS8$H2FS8 == "(2) (2) A lot of the time", 1, 
                  ifelse(ID21600DS8$H2FS8 == "(3) (3) Most/all of the time",0,NA))))#reverse coded item
ID21600DS8$H2FS9<-ifelse(ID21600DS8$H2FS9 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS9 == "(1) (1) Sometimes", 1, 
                  ifelse(ID21600DS8$H2FS9 == "(2) (2) A lot of the time", 2, 
                  ifelse(ID21600DS8$H2FS9 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS10<-ifelse(ID21600DS8$H2FS10 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS10 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS8$H2FS10 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS8$H2FS10 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS11<-ifelse(ID21600DS8$H2FS11 == "(0) (0) Never/rarely", 3, ifelse(ID21600DS8$H2FS11 == "(1) (1) Sometimes", 2, 
                   ifelse(ID21600DS8$H2FS11 == "(2) (2) A lot of the time", 1, 
                   ifelse(ID21600DS8$H2FS11 == "(3) (3) Most/all of the time",0,NA))))#reverse coded item
ID21600DS8$H2FS12<-ifelse(ID21600DS8$H2FS12 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS12 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS8$H2FS12 == "(2) (2) A lot of the time", 2,
                   ifelse(ID21600DS8$H2FS12 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS13<-ifelse(ID21600DS8$H2FS13 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS13 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS8$H2FS13 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS8$H2FS13 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS14<-ifelse(ID21600DS8$H2FS14 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS14 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS8$H2FS14 == "(2) (2) A lot of the time", 2,
                   ifelse(ID21600DS8$H2FS14 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS15<-ifelse(ID21600DS8$H2FS15 == "(0) (0) Never/rarely", 3, ifelse(ID21600DS8$H2FS15 == "(1) (1) Sometimes", 2, 
                   ifelse(ID21600DS8$H2FS15 == "(2) (2) A lot of the time", 1, 
                   ifelse(ID21600DS8$H2FS15 == "(3) (3) Most/all of the time",0,NA))))#reverse coded item
ID21600DS8$H2FS16<-ifelse(ID21600DS8$H2FS16 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS16 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS8$H2FS16 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS8$H2FS16 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS17<-ifelse(ID21600DS8$H2FS17 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS17 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS8$H2FS17 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS8$H2FS17 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS18<-ifelse(ID21600DS8$H2FS18 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS18 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS8$H2FS18 == "(2) (2) A lot of the time", 2, 
                   ifelse(ID21600DS8$H2FS18 == "(3) (3) Most/all of the time",3,NA))))
ID21600DS8$H2FS19<-ifelse(ID21600DS8$H2FS19 == "(0) (0) Never/rarely", 0, ifelse(ID21600DS8$H2FS19 == "(1) (1) Sometimes", 1, 
                   ifelse(ID21600DS8$H2FS19 == "(2) (2) A lot of the time", 2,
                   ifelse(ID21600DS8$H2FS19 == "(3) (3) Most/all of the time",3,NA))))


#Assign dataframe that contains all depressive symtpoms (using the column numbers of the items)
dsitems <- ID21600DS8[c(2:10)]
dsitemspw <- ID21600DS8[c(11:29)]
#Identify participants missing more than half of dsitems (not dsitemsW1) (1=missing > 50%) - to be used later
ID21600DS8$dsmiss<-ifelse(rowSums(is.na(dsitems))>((ncol(dsitems)/2)),1,0)
#Compute mean symptom score 
ID21600DS8$DEP<-rowMeans(x=dsitems,na.rm=TRUE)
ID21600DS8$DEPPW<-rowMeans(x=dsitemspw,na.rm=TRUE)
...
ID21600DS8$LAT<-ifelse(ID21600DS8$H3OD2 == "(1) (1) Yes", 1, 0)

#Recode factor into numeric (individual race items)
ID21600DS8$WHT<-ifelse(ID21600DS8$H3OD4A == "(1) (1) Marked", 1, 0)
ID21600DS8$BLK<-ifelse(ID21600DS8$H3OD4B == "(1) (1) Marked", 1, 0)
ID21600DS8$AI<-ifelse(ID21600DS8$H3OD4C == "(1) (1) Marked", 1, 0)
ID21600DS8$AA<-ifelse(ID21600DS8$H3OD4D == "(1) (1) Marked", 1, 0)

#Compute variable for participants who reported more than one race (mixed/biracial; do not include Latino/Hispanic)
ID21600DS8$MR<-ifelse((rowSums(x=cbind(ID21600DS8$WHT,ID21600DS8$BLK,ID21600DS8$AI,ID21600DS8$AA),
                               na.rm=TRUE)) > 1, 1, 0)

#Compute variables for participants who reported a single race (excluding mixed/biracial & Latino/Hispanic)
ID21600DS8$WHT<-ifelse(((ID21600DS8$LAT == 0)&(ID21600DS8$MR == 0)&(ID21600DS8$WHT == 1)), 1, 0)
ID21600DS8$BLK<-ifelse(((ID21600DS8$LAT == 0)&(ID21600DS8$MR == 0)&(ID21600DS8$BLK == 1)), 1, 0)
ID21600DS8$AI<-ifelse(((ID21600DS8$LAT == 0)&(ID21600DS8$MR == 0)&(ID21600DS8$AI == 1)), 1, 0)
ID21600DS8$AA<-ifelse(((ID21600DS8$LAT == 0)&(ID21600DS8$MR == 0)&(ID21600DS8$AA == 1)), 1, 0)
ID21600DS8$MR<-ifelse(((ID21600DS8$LAT == 0)&(ID21600DS8$MR == 1)), 1, 0)

#Recode factor into numeric (sex)
ID21600DS8$SEX<-ifelse(ID21600DS8$BIO_SEX3 == "(1) (1) Male", 1, 0)

#Rename Age
ID21600DS8$AGECALC<-ID21600DS8$CALCAGE3

#Code highest income reported 
ID21600DS8$hshldinc<-ifelse(((ID21600DS8$H3EC6>=ID21600DS8$H3EC8)|(is.na(ID21600DS8$H3EC8))),ID21600DS8$H3EC6,ID21600DS8$H3EC8)
ID21600DS8$INC<-ifelse(((ID21600DS8$H3EC2>=ID21600DS8$hshldinc)|(is.na(ID21600DS8$hshldinc))),ID21600DS8$H3EC2,ID21600DS8$hshldinc)

#Recode education
ID21600DS8$EDU<-ifelse(ID21600DS8$H3ED1=="(06) (6) 6th grade",6, 
                ifelse(ID21600DS8$H3ED1=="(07) (7) 7th grade",7, 
                ifelse(ID21600DS8$H3ED1=="(08) (8) 8th grade",8, 
                ifelse(ID21600DS8$H3ED1=="(09) (9) 9th grade",9, 
                ifelse(ID21600DS8$H3ED1=="(10) (10) 10th grade",10, 
                ifelse(ID21600DS8$H3ED1=="(11) (11) 11th grade",11, 
                ifelse(ID21600DS8$H3ED1=="(12) (12) 12th grade",12, 
                ifelse(ID21600DS8$H3ED1=="(13) (13) 1 year of college",13, 
                ifelse(ID21600DS8$H3ED1=="(14) (14) 2 years of college",14, 
                ifelse(ID21600DS8$H3ED1=="(15) (15) 3 years of college",15, 
                ifelse(ID21600DS8$H3ED1=="(16) (16) 4 years of college",16, 
                ifelse(ID21600DS8$H3ED1=="(17) (17) 5 or more years of college",17, 
                ifelse(ID21600DS8$H3ED1=="(18) (18) 1 year of graduate school",18, 
                ifelse(ID21600DS8$H3ED1=="(19) (19) 2 years of graduate school",19, 
                ifelse(ID21600DS8$H3ED1=="(20) (20) 3 years of graduate school",20, 
                ifelse(ID21600DS8$H3ED1=="(21) (21) 4 years of graduate school",21, 
                ifelse(ID21600DS8$H3ED1=="(22) (22) 5 or more years of graduate school",22,0)))))))))))))))))

#Recode factor into numeric (occupational status)
#Nam-Powers-Boyd scale (Nam & Boyd, 2008)
#read in .xlsx because .csv converts scores into date
library(readxl)
occ_codes<-read_excel('IPD21600DS8_Occupational status codes.xlsx')
#match codes with each row in data   
occ_codes$OCC_CODE<-as.factor(occ_codes$OCC_CODE)
occvalues<-c(levels(occ_codes$OCC_CODE))
occstatusvalues<-factor(c(occ_codes$OCC_STATUS))  # Make this a factor
ID21600DS8$OCCS<-as.numeric(as.character(occstatusvalues[ match(ID21600DS8$H3LM26C, occvalues) ]))

#Recode factor into numeric (occupational prestige)
#Nakao & Tres scale (1994)
#read in .xlsx because .csv converts scores into date
library(readxl)
occ_codes<-read_excel('IPD21600DS8_Occupational prestige codes.xlsx')
#match codes with each row in data   
occ_codes$OCC_CODE<-as.factor(occ_codes$OCC_CODE)
occvalues<-c(levels(occ_codes$OCC_CODE))
occstatusvalues<-factor(c(occ_codes$OCC_PREST))  # Make this a factor
ID21600DS8$OCCP<-as.numeric(as.character(occstatusvalues[ match(ID21600DS8$H3LM26C, occvalues) ]))

#Save database as .csv for OSF 
write.csv(ID21600DS8, file = 'ID21600DS8_recoded.csv')

#Exclude participants with more than 50% missing on depressive symtpoms items
ID21600DS8 <- ID21600DS8[which(ID21600DS8$dsmiss==0), ]

##Compute mean and sd across all participants within dataset
library('psych')
#Means & SDs of focal variables
dstatsage<-describe(ID21600DS8$AGECALC)
dstatsdep<-describe(ID21600DS8$DEP)
dstatsachv<-NA#describe(ID21600DS8$ACHV)
dstatsinc<-describe(ID21600DS8$INC)
dstatsedu<-describe(ID21600DS8$EDU)
dstatsoccs<-describe(ID21600DS8$OCCS)
dstatsoccp<-describe(ID21600DS8$OCCP)

#Save descriptive stats
dstats<-rbind(dstatsage,dstatsdep,dstatsachv,dstatsinc,dstatsedu,dstatsoccs,dstatsoccp,make.row.names= FALSE)
write.csv(dstats,file = 'ID21600DS8_dstats.csv',
          row.names=c("dstatsage","dstatsdep","dstatsachv","dstatsinc","dstatsedu","dstatsoccs","dstatsoccp"))

##Histograms 
pdf('ID21600DS8_dephist.pdf')
hist(ID21600DS8$DEP, xlab="Depressive Symptoms", main = NULL, col="grey")
dev.off()
#pdf('ID21600DS8_achvhist.pdf')
#hist(ID21600DS8$ACHV, xlab="Academic Achievement", main = NULL, col="grey")
#dev.off()
pdf('ID21600DS8_inchist.pdf')
hist(ID21600DS8$INC, xlab="Income", main = NULL, col="grey")
dev.off()
pdf('ID21600DS8_educhist.pdf')
hist(ID21600DS8$EDU, xlab="Educational Attainment", main = NULL, col="grey")
dev.off()
pdf('ID21600DS8_occshist.pdf')
hist(ID21600DS8$OCCS, xlab="Occupational Status", main = NULL, col="grey")
dev.off()
pdf('ID21600DS8_occphist.pdf')
hist(ID21600DS8$OCCP, xlab="Occupational Prestige", main = NULL, col="grey")
dev.off()
...
table(ID21600DS8$AGECALC)
#Separate dataset by developmental period, if needed
#CH<-ID21600DS8[which((ID21600DS8$AGECALC >= 5)&(ID21600DS8$AGECALC <= 11)), ]
#AD<-ID21600DS8[which((ID21600DS8$AGECALC >= 12)&(ID21600DS8$AGECALC <= 17)), ]
YD<-ID21600DS8[which((ID21600DS8$AGECALC >= 18)&(ID21600DS8$AGECALC <= 25)), ]
#AT<-ID21600DS8[which((ID21600DS8$AGECALC >= 26)&(ID21600DS8$AGECALC <= 64)), ] INCLUDES AT BUT TOO FEW (53)
#OA<-ID21600DS8[which(ID21600DS8$AGECALC >= 65), ]
...
##Assign ICPSR ID number (ICPSR Number; e.g., file name = ID21600DS8, then DATAID = 21600)
#DATAID<-'21600'
#names(DATAID)<-'DATAID'
...
#ALPHAOV <- ci.reliability(data=WHTCHF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTCHM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTADF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTADF[2:10], type = "omega", interval.type = "none")
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTADM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTADM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTYDF[2:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTYDF[2:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTYDM[2:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTYDM[2:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTATF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTATF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTATM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTATM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTOAF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTOAF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTOAM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTOAM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#names(DATAYEAR)<-'DATAYEAR'
##Compute reliability estimates
#ALPHAOV <- ci.reliability(data=LATCHF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATCHM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#names(DATAYEAR)<-'DATAYEAR'
##Compute reliability estimates
#ALPHAOV <- ci.reliability(data=LATADF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATADF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATADM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATADM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATYDF[2:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATYDF[2:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATYDM[2:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATYDM[2:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATATF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATATF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATATM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATATM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATOAF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATOAF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATOAM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATOAM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKADF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKADF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKADM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKADM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKYDF[2:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKYDF[2:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKYDM[2:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKYDM[2:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKATF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKATF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKATM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKATM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKOAF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKOAF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKOAM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKOAM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHMC[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHMC[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADMC[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADMC[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAYDF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAYDF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAYDM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAYDM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAATF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAATF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAATM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAATM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- NA#ci.reliability(data=AIADF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- NA#ci.reliability(data=AIADF[2:10], type = "omega", interval.type = "none")
#ALPHA <- NA#ALPHAOV$est
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- NA#ci.reliability(data=AIADM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- NA#ci.reliability(data=AIADM[2:10], type = "omega", interval.type = "none")
#ALPHA <- NA#ALPHAOV$est
#OMEGA <- NA#OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=AIYDF[2:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AIYDF[2:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AIYDM[2:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=AIYDM[2:10], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIATF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIATF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIATM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIATM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIOAF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIOAF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIOAM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIOAM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=MRYDF[2:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=MRYDF[2:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=MRYDM[2:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=MRYDM[2:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRATF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRATF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRATM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRATM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MROAF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MROAF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MROAM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MROAM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
write.csv(ID21600DS8_aggregated, file = 'ID21600DS8_aggregated.csv',row.names = FALSE)
