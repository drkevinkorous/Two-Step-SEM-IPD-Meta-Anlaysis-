...
#Depressive symptom items: R4978300,R4978400,R4978500,R4978600,R4978700,R4978800,R4978900
#Depressive symptom items prior wave:
#R3894900,R3895000,R3895100,R3895200(RC),R3895300,R3895400,R3895500,R3895600(RC),R3895700,R3895800
#R3895900,R3896000(RC),R3896100,R3896200,R3896300,R3896400(RC),R3896500,R3896600,R3896700,R3896800
...
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: R4982801 
#Maternal Income: NA
#Paternal Income: NA
#Household Income: R5080700 
#Participant Education: R4526500
...
ID182DS0<-data.frame(R0000100,R4978300,R4978400,R4978500,R4978600,R4978700,R4978800,R4978900,R3894900,
                     R3895000,R3895100,R3895200,R3895300,R3895400,R3895500,R3895600,R3895700,R3895800,
                     R3895900,R3896000,R3896100,R3896200,R3896300,R3896400,R3896500,R3896600,R3896700,
                     R3896800,R0009600,R0010200,R0214800,R5081700,R4982801,R5080700,R4526500,R4587901) 
detach(merged182)
...
ID182DS0$R4978300<-ifelse(ID182DS0$R4978300=="Rarely/None of the Time/1 Day",0,                 
                   ifelse(ID182DS0$R4978300=="Some/A Little of the Time/1-2 Days",1,            
                   ifelse(ID182DS0$R4978300=="Occasionally/Moderate Amount of the Time/3-4 Days",2,
                   ifelse(ID182DS0$R4978300=="Most/All of the Time/5-7 Days",3,NA))))
ID182DS0$R4978400<-ifelse(ID182DS0$R4978400=="Rarely/None of the Time/1 Day",0,                 
                   ifelse(ID182DS0$R4978400=="Some/A Little of the Time/1-2 Days",1,            
                   ifelse(ID182DS0$R4978400=="Occasionally/Moderate Amount of the Time/3-4 Days",2,
                   ifelse(ID182DS0$R4978400=="Most/All of the Time/5-7 Days",3,NA))))  
ID182DS0$R4978500<-ifelse(ID182DS0$R4978500=="Rarely/None of the Time/1 Day",0,                 
                   ifelse(ID182DS0$R4978500=="Some/A Little of the Time/1-2 Days",1,            
                   ifelse(ID182DS0$R4978500=="Occasionally/Moderate Amount of the Time/3-4 Days",2,
                   ifelse(ID182DS0$R4978500=="Most/All of the Time/5-7 Days",3,NA))))  
ID182DS0$R4978600<-ifelse(ID182DS0$R4978600=="Rarely/None of the Time/1 Day",0,                 
                   ifelse(ID182DS0$R4978600=="Some/A Little of the Time/1-2 Days",1,            
                   ifelse(ID182DS0$R4978600=="Occasionally/Moderate Amount of the Time/3-4 Days",2,
                   ifelse(ID182DS0$R4978600=="Most/All of the Time/5-7 Days",3,NA))))  
ID182DS0$R4978700<-ifelse(ID182DS0$R4978700=="Rarely/None of the Time/1 Day",0,                 
                   ifelse(ID182DS0$R4978700=="Some/A Little of the Time/1-2 Days",1,            
                   ifelse(ID182DS0$R4978700=="Occasionally/Moderate Amount of the Time/3-4 Days",2,
                   ifelse(ID182DS0$R4978700=="Most/All of the Time/5-7 Days",3,NA))))  
ID182DS0$R4978800<-ifelse(ID182DS0$R4978800=="Rarely/None of the Time/1 Day",0,                 
                   ifelse(ID182DS0$R4978800=="Some/A Little of the Time/1-2 Days",1,            
                   ifelse(ID182DS0$R4978800=="Occasionally/Moderate Amount of the Time/3-4 Days",2,
                   ifelse(ID182DS0$R4978800=="Most/All of the Time/5-7 Days",3,NA))))  
ID182DS0$R4978900<-ifelse(ID182DS0$R4978900=="Rarely/None of the Time/1 Day",0,                 
                   ifelse(ID182DS0$R4978900=="Some/A Little of the Time/1-2 Days",1,            
                   ifelse(ID182DS0$R4978900=="Occasionally/Moderate Amount of the Time/3-4 Days",2,
                   ifelse(ID182DS0$R4978900=="Most/All of the Time/5-7 Days",3,NA))))  

#Depressive symptoms prior wave 
ID182DS0$R3894900<-ifelse(ID182DS0$R3894900=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3894900=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3894900=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3894900=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))
ID182DS0$R3895000<-ifelse(ID182DS0$R3895000=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3895000=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3895000=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3895000=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3895100<-ifelse(ID182DS0$R3895100=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3895100=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3895100=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3895100=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3895200<-ifelse(ID182DS0$R3895200=="RARELY/NONE OF THE TIME/1 DAY",3,                 
                   ifelse(ID182DS0$R3895200=="SOME/A LITTLE OF THE TIME/1-2 DAYS",2,            
                   ifelse(ID182DS0$R3895200=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",1,
                   ifelse(ID182DS0$R3895200=="MOST/ALL OF THE TIME/5-7 DAYS",0,NA))))#Reversed coded item
ID182DS0$R3895300<-ifelse(ID182DS0$R3895300=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3895300=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3895300=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3895300=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3895400<-ifelse(ID182DS0$R3895400=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3895400=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3895400=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3895400=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3895500<-ifelse(ID182DS0$R3895500=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3895500=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3895500=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3895500=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3895600<-ifelse(ID182DS0$R3895600=="RARELY/NONE OF THE TIME/1 DAY",3,                 
                   ifelse(ID182DS0$R3895600=="SOME/A LITTLE OF THE TIME/1-2 DAYS",2,            
                   ifelse(ID182DS0$R3895600=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",1,
                   ifelse(ID182DS0$R3895600=="MOST/ALL OF THE TIME/5-7 DAYS",0,NA))))#Reversed coded item 
ID182DS0$R3895700<-ifelse(ID182DS0$R3895700=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3895700=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3895700=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3895700=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3895800<-ifelse(ID182DS0$R3895800=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3895800=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3895800=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3895800=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3895900<-ifelse(ID182DS0$R3895900=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3895900=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3895900=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3895900=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3896000<-ifelse(ID182DS0$R3896000=="RARELY/NONE OF THE TIME/1 DAY",3,                 
                   ifelse(ID182DS0$R3896000=="SOME/A LITTLE OF THE TIME/1-2 DAYS",2,            
                   ifelse(ID182DS0$R3896000=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",1,
                   ifelse(ID182DS0$R3896000=="MOST/ALL OF THE TIME/5-7 DAYS",0,NA))))#Reversed coded item  
ID182DS0$R3896100<-ifelse(ID182DS0$R3896100=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3896100=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3896100=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3896100=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3896200<-ifelse(ID182DS0$R3896200=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3896200=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3896200=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3896200=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3896300<-ifelse(ID182DS0$R3896300=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3896300=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3896300=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3896300=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3896400<-ifelse(ID182DS0$R3896400=="RARELY/NONE OF THE TIME/1 DAY",3,                 
                   ifelse(ID182DS0$R3896400=="SOME/A LITTLE OF THE TIME/1-2 DAYS",2,            
                   ifelse(ID182DS0$R3896400=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",1,
                   ifelse(ID182DS0$R3896400=="MOST/ALL OF THE TIME/5-7 DAYS",0,NA))))#Reversed coded item
ID182DS0$R3896500<-ifelse(ID182DS0$R3896500=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3896500=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3896500=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3896500=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3896600<-ifelse(ID182DS0$R3896600=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3896600=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3896600=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3896600=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3896700<-ifelse(ID182DS0$R3896700=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3896700=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3896700=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3896700=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA))))  
ID182DS0$R3896800<-ifelse(ID182DS0$R3896800=="RARELY/NONE OF THE TIME/1 DAY",0,                 
                   ifelse(ID182DS0$R3896800=="SOME/A LITTLE OF THE TIME/1-2 DAYS",1,            
                   ifelse(ID182DS0$R3896800=="OCCASIONALLY/MODERATE AMT OF THE TIME/3-4 DAYS",2,
                   ifelse(ID182DS0$R3896800=="MOST/ALL OF THE TIME/5-7 DAYS",3,NA)))) 

#Assign dataframe that contains all depressive symtpoms (using the column numbers of the items)
dsitems <- ID182DS0[c(2:8)]
dsitemspw <- ID182DS0[c(9:28)]
...
#Recode age 
levels(ID182DS0$R5081700)[levels(ID182DS0$R5081700)=="0 TO 26: < 26"]<-26 #(no participants are in this range)
levels(ID182DS0$R5081700)[levels(ID182DS0$R5081700)=="40 TO 99: 40+"]<-38 #(no participants are in this range)
ID182DS0$AGECALC<-as.numeric(as.character(ID182DS0$R5081700))
...
write.csv(ID182DS0, file = 'ID182DS0_1994_recoded.csv')
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADF[2:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADF[2:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADM[2:8], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADM[2:8], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
write.csv(ID182DS0_aggregated, file = 'ID182DS0_1994_aggregated.csv',row.names = FALSE)
