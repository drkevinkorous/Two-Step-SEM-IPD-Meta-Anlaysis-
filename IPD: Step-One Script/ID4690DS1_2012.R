...
#V16001,V16002,V16003,V16004(RC),V16005,V16006,V16007(RC),V16008,V16009,V16010,V16011
#Depressive symptom items prior wave: 
#V12325,V12326,V12327,V12328(RC),V12329,V12330,V12331(RC),V12332,V12333,V12334,V12335
#Academic Achievement: NA
#Academic Achievement prior wave: NA
#Ethnicity: V1620
#Race: V2004 (this variable is computed and does not account for MR)
#White: V1628
#Black: V1629 
#Asian or Pacific Islander: V1631
#Native American: V1630
#More than one race: NA
#Other Race (to determine more than one race): V1632
#Sex: V1801
#Age: NA
#Birth Year: V2001 
#Birth Month: NA
#Birth Day: NA
#Evaluation Year: V15010
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: NA  
#Maternal Income: NA
#Paternal Income: NA
#Household Income: V17110
#Participant Education: V2007 (prior wave best estimate of education)
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: V16115 
...
#Notes: Americans' Changing Lives - Wave 4

#Create Dataset ----
attach(da04690.0001)
#Extract relevant variables into a dataframe.
ID4690DS1<-data.frame(V16001,V16002,V16003,V16004,V16005,V16006,V16007,V16008,V16009,V16010,V16011,
                      V12325,V12326,V12327,V12328,V12329,V12330,V12331,V12332,V12333,V12334,V12335,
                      V1620,V2004,V1628,V1629,V1631,V1630,V1632,V1801,V2001,V15010,V17110,V2007,V16115) 
detach(da04690.0001)
ID4690DS1$ORIGOBS<-nrow(ID4690DS1)
rm(da04690.0001)
...
#Depressive Symptoms ---------
ID4690DS1$V16001<-ifelse(ID4690DS1$V16001=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V16001=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V16001=="(3) Most of the time",2,NA)))
ID4690DS1$V16002<-ifelse(ID4690DS1$V16002=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V16002=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V16002=="(3) Most of the time",2,NA)))
ID4690DS1$V16003<-ifelse(ID4690DS1$V16003=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V16003=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V16003=="(3) Most of the time",2,NA)))
ID4690DS1$V16004<-ifelse(ID4690DS1$V16004=="(1) Never or hardly ever",2,
                  ifelse(ID4690DS1$V16004=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V16004=="(3) Most of the time",0,NA))) #RC
ID4690DS1$V16005<-ifelse(ID4690DS1$V16005=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V16005=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V16005=="(3) Most of the time",2,NA)))
ID4690DS1$V16006<-ifelse(ID4690DS1$V16006=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V16006=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V16006=="(3) Most of the time",2,NA)))
ID4690DS1$V16007<-ifelse(ID4690DS1$V16007=="(1) Never or hardly ever",2,
                  ifelse(ID4690DS1$V16007=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V16007=="(3) Most of the time",0,NA))) #RC
ID4690DS1$V16008<-ifelse(ID4690DS1$V16008=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V16008=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V16008=="(3) Most of the time",2,NA)))
ID4690DS1$V16009<-ifelse(ID4690DS1$V16009=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V16009=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V16009=="(3) Most of the time",2,NA)))
ID4690DS1$V16010<-ifelse(ID4690DS1$V16010=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V16010=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V16010=="(3) Most of the time",2,NA)))
ID4690DS1$V16011<-ifelse(ID4690DS1$V16011=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V16011=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V16011=="(3) Most of the time",2,NA)))

#Depressive symptoms prior wave 
ID4690DS1$V12325<-ifelse(ID4690DS1$V12325=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V12325=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V12325=="(3) Most of the time",2,NA)))
ID4690DS1$V12326<-ifelse(ID4690DS1$V12326=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V12326=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V12326=="(3) Most of the time",2,NA)))
ID4690DS1$V12327<-ifelse(ID4690DS1$V12327=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V12327=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V12327=="(3) Most of the time",2,NA)))
ID4690DS1$V12328<-ifelse(ID4690DS1$V12328=="(1) Never or hardly ever",2,
                  ifelse(ID4690DS1$V12328=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V12328=="(3) Most of the time",0,NA))) #RC
ID4690DS1$V12329<-ifelse(ID4690DS1$V12329=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V12329=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V12329=="(3) Most of the time",2,NA)))
ID4690DS1$V12330<-ifelse(ID4690DS1$V12330=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V12330=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V12330=="(3) Most of the time",2,NA)))
ID4690DS1$V12331<-ifelse(ID4690DS1$V12331=="(1) Never or hardly ever",2,
                  ifelse(ID4690DS1$V12331=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V12331=="(3) Most of the time",0,NA))) #RC
ID4690DS1$V12332<-ifelse(ID4690DS1$V12332=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V12332=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V12332=="(3) Most of the time",2,NA)))
ID4690DS1$V12333<-ifelse(ID4690DS1$V12333=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V12333=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V12333=="(3) Most of the time",2,NA)))
ID4690DS1$V12334<-ifelse(ID4690DS1$V12334=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V12334=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V12334=="(3) Most of the time",2,NA)))
ID4690DS1$V12335<-ifelse(ID4690DS1$V12335=="(1) Never or hardly ever",0,
                  ifelse(ID4690DS1$V12335=="(2) Some of the time",1,
                  ifelse(ID4690DS1$V12335=="(3) Most of the time",2,NA)))

#Assign dataframe that contains all depressive symtpoms (using the column numbers of the items)
dsitems <- ID4690DS1[c(1:11)]
dsitemspw <- ID4690DS1[c(12:22)]
#Identify participants missing more than half of dsitems (not dsitemsW1) (1=missing > 50%) - to be used later
ID4690DS1$dsmiss<-ifelse(rowSums(is.na(dsitems))>((ncol(dsitems)/2)),1,0)
#Compute mean symptom score 
ID4690DS1$DEP<-rowMeans(x=dsitems,na.rm=TRUE)
ID4690DS1$DEPPW<-rowMeans(x=dsitemspw,na.rm=TRUE)
...
ID4690DS1$LAT<-ifelse(ID4690DS1$V1620=="(01) MEXICAN",1,
               ifelse(ID4690DS1$V1620=="(02) MEXICAN AMERICAN",1,
               ifelse(ID4690DS1$V1620=="(03) CHICANO",1,
               ifelse(ID4690DS1$V1620=="(04) PUERTO RICAN",1,
               ifelse(ID4690DS1$V1620=="(05) CUBAN",1,
               ifelse(ID4690DS1$V1620=="(06) CENTRAL AMERICAN OR SOUTH AMERICAN COUNTRY",1,
               ifelse(ID4690DS1$V1620=="(07) SPANISH; CASTILLIAN; SPANISH AMERICAN",1,
               ifelse(ID4690DS1$V1620=="(97) OTHER SPANISH (SPECIFY)...(Make Card)",1,0))))))))
ID4690DS1$LAT[is.na(ID4690DS1$LAT)]<-0
ID4690DS1$WHT<-ifelse(ID4690DS1$V1628 == "(1) CHECKED", 1, 0)
ID4690DS1$BLK<-ifelse(ID4690DS1$V1629 == "(1) CHECKED", 1, 0)
ID4690DS1$AI<-ifelse(ID4690DS1$V1630 == "(1) CHECKED", 1, 0)
ID4690DS1$AA<-ifelse(ID4690DS1$V1631 == "(1) CHECKED", 1, 0)
ID4690DS1$OTH<-ifelse(ID4690DS1$V1632 == "(1) CHECKED", 1, 0)
#Compute variable for participants who reported more than one race (mixed/biracial; do not include Latino/Hispanic)
ID4690DS1$MR<- ifelse((rowSums(x=cbind(ID4690DS1$WHT,ID4690DS1$BLK,ID4690DS1$AI,ID4690DS1$AA,
                                       ID4690DS1$OTH),na.rm=TRUE)) > 1, 1, 0)

##Compute variables for participants who reported a single race (excluding mixed/biracial & Latino/Hispanic)
ID4690DS1$WHT<-ifelse(((ID4690DS1$LAT == 0)&(ID4690DS1$MR == 0)&(ID4690DS1$WHT == 1)), 1, 0)
ID4690DS1$BLK<-ifelse(((ID4690DS1$LAT == 0)&(ID4690DS1$MR == 0)&(ID4690DS1$BLK == 1)), 1, 0)
ID4690DS1$AI<-ifelse(((ID4690DS1$LAT == 0)&(ID4690DS1$MR == 0)&(ID4690DS1$AI == 1)), 1, 0)
ID4690DS1$AA<-ifelse(((ID4690DS1$LAT == 0)&(ID4690DS1$MR == 0)&(ID4690DS1$AA == 1)), 1, 0)
ID4690DS1$OTH<-ifelse(((ID4690DS1$LAT == 0)&(ID4690DS1$MR == 0)&(ID4690DS1$OTH == 1)), 1, 0)
ID4690DS1$MR<-ifelse(((ID4690DS1$LAT == 0)&(ID4690DS1$MR == 1)), 1, 0)

#Recode sex
ID4690DS1$SEX<-ifelse(ID4690DS1$V1801 == "(1) MALE", 1, 0)

#Recode age 
ID4690DS1$AGECALC<-2012-ID4690DS1$V2001

#Income, Education, Occupation ----
##Income
ID4690DS1$INC<-ID4690DS1$V17110 

##Education
ID4690DS1$EDU<-ID4690DS1$V2007

##Occupation
#Nam-Powers-Boyd scale (Nam & Boyd, 2008)
occ_codes<-read.csv(file = 'ID4690DS1_2012_Occupational codes.csv')
#match codes with each row in data
ID4690DS1$OCCS<-occ_codes$OCC_STATUS[ match(ID4690DS1$V16115,occ_codes$OCC_CODE)]

#Recode factor into numeric (occupational prestige)
#Nakao & Tres scale (1994)
ID4690DS1$OCCP<-occ_codes$OCC_PREST[ match(ID4690DS1$V16115,occ_codes$OCC_CODE)]

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID4690DS1, file = 'ID4690DS1_2012_recoded.csv')

#Descriptives and Correlations -----
#Exclude participants with more than 50% missing on depressive symptoms items
ID4690DS1 <- ID4690DS1[which(ID4690DS1$dsmiss==0), ]

##Compute mean and sd across all participants within dataset
library('psych')
#Means & SDs of focal variables
dstatsage<-describe(ID4690DS1$AGECALC)
dstatsdep<-describe(ID4690DS1$DEP)
dstatsachv<-NA#describe(ID4690DS1$ACHV)
dstatsinc<-describe(ID4690DS1$INC)
dstatsedu<-describe(ID4690DS1$EDU)
dstatsoccs<-describe(ID4690DS1$OCCS)
dstatsoccp<-describe(ID4690DS1$OCCP)

#Save descriptive stats
dstats<-rbind(dstatsage,dstatsdep,dstatsachv,dstatsinc,dstatsedu,dstatsoccs,dstatsoccp,make.row.names= FALSE)
write.csv(dstats,file = 'ID4690DS1_2012_dstats.csv',
          row.names=c("dstatsage","dstatsdep","dstatsachv","dstatsinc","dstatsedu","dstatsoccs","dstatsoccp"))

##Histograms 
pdf('ID4690DS1_2012_dephist.pdf')
hist(ID4690DS1$DEP, xlab="Depressive Symptoms", main = NULL, col="grey")
dev.off()
#pdf('ID4690DS1_2012_achvhist.pdf')
#hist(ID4690DS1$ACHV, xlab="Academic Achievement", main = NULL, col="grey")
#dev.off()
pdf('ID4690DS1_2012_inchist.pdf')
hist(ID4690DS1$INC, xlab="Income", main = NULL, col="grey")
dev.off()
pdf('ID4690DS1_2012_educhist.pdf')
hist(ID4690DS1$EDU, xlab="Educational Attainment", main = NULL, col="grey")
dev.off()
pdf('ID4690DS1_2012_occshist.pdf')
hist(ID4690DS1$OCCS, xlab="Occupational Status", main = NULL, col="grey")
dev.off()
pdf('ID4690DS1_2012_occphist.pdf')
hist(ID4690DS1$OCCP, xlab="Occupational Prestige", main = NULL, col="grey")
dev.off()
...
table(ID4690DS1$AGECALC)
#Separate dataset by developmental period, if needed
#CH<-ID4690DS1[which((ID4690DS1$AGECALC >= 5)&(ID4690DS1$AGECALC <= 11)), ] 
#AD<-ID4690DS1[which((ID4690DS1$AGECALC >= 12)&(ID4690DS1$AGECALC <= 17)), ]
#YD<-ID4690DS1[which((ID4690DS1$AGECALC >= 18)&(ID4690DS1$AGECALC <= 25)), ]
AT<-ID4690DS1[which((ID4690DS1$AGECALC >= 26)&(ID4690DS1$AGECALC <= 64)), ]
OA<-ID4690DS1[which(ID4690DS1$AGECALC >= 65), ]
...
##Assign ICPSR ID number (ICPSR Number; e.g., file name = ID4690DS1, then DATAID = 21600)
#DATAID<-'4690'
#names(DATAID)<-'DATAID'
...
#ALPHAOV <- ci.reliability(data=WHTCHF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTCHM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTADF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTADF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTADM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTADM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTYDF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTYDF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTYDM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTYDM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTATF[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTATF[1:11], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTATM[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTATM[1:11], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTOAF[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTOAF[1:11], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTOAM[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTOAM[1:11], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#names(DATAYEAR)<-'DATAYEAR'
##Compute reliability estimates
#ALPHAOV <- ci.reliability(data=LATCHF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATCHM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#names(DATAYEAR)<-'DATAYEAR'
##Compute reliability estimates
#ALPHAOV <- ci.reliability(data=LATADF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATADF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATADM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATADM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATYDF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATYDF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATYDM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATYDM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATATF[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATATF[1:11], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATATM[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATATM[1:11], type = "omega", interval.type = "none")
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=LATOAF[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=LATOAF[1:11], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=LATOAM[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=LATOAM[1:11], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKADF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKADF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKADM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKADM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKYDF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKYDF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKYDM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKYDM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKATF[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKATF[1:11], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKATM[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKATM[1:11], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKOAF[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKOAF[1:11], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKOAM[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKOAM[1:11], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHMC[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHMC[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAYDF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAYDF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAYDM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAYDM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AAATF[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AAATF[1:11], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAATM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAATM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIYDF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIYDF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIYDM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIYDM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIATF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIATF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIATM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIATM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIOAF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIOAF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIOAM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIOAM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRYDF[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRYDF[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRYDM[1:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRYDM[1:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=MRATF[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=MRATF[1:11], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=MRATM[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=MRATM[1:11], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=MROAF[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=MROAF[1:11], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=MROAM[1:11], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=MROAM[1:11], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
ID4690DS1_2012_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID4690DS1_2012_aggregated, file = 'ID4690DS1_2012_aggregated.csv',row.names = FALSE)
