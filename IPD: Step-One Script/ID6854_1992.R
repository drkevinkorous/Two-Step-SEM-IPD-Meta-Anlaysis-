#load dataset
library('foreign')
health<-read.spss('HEALTH.SAV')
household<-read.spss('HOUSEHLD.SAV')
employer<-read.spss('EMPLOYER.SAV')
#Merge datasets by Case ID (V1)
ID68541992<-merge(health,household,by="V1")
ID68541992<-merge(ID68541992,employer,by="V1")
#Coded variables
#Participant ID: V1
#Measure Name (not a variable in the dataset): CESD
#Depressive symptom items: 
#V519,V520,V521,V522(RC),V523,V524,V525(RC),V526,V527,V528,V529
...
#Birth Day: NA
#Evaluation Year: V25
#Evaluation Month: V23
#Evaluation Day: V24
#Participant Income: V5403  
#Maternal Income: NA
#Paternal Income: NA
#Household Income: V6559 
#Participant Education: V207
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: V2720 
...
ID6854DS0<-data.frame(V1,V519,V520,V521,V522,V523,V524,V525,V526,V527,V528,V529,V216,V221M,
                      V47,V46,V44,V42,V25,V23,V24,V5403,V6559,V207,V2720)
detach(ID68541992)
ID6854DS0$ORIGOBS<-nrow(ID6854DS0)
rm(ID68541992)
...
#Depressive Symptoms ---------
#Response categories equal:
#1.  All or almost all
#2.  Most of the time
#3.  Some of the time
#4.  None or almost none
ID6854DS0$V519<-ifelse(ID6854DS0$V519==1,3,
                ifelse(ID6854DS0$V519==2,2,
                ifelse(ID6854DS0$V519==3,1,
                ifelse(ID6854DS0$V519==4,0,NA))))
ID6854DS0$V520<-ifelse(ID6854DS0$V520==1,3,
                ifelse(ID6854DS0$V520==2,2,
                ifelse(ID6854DS0$V520==3,1,
                ifelse(ID6854DS0$V520==4,0,NA))))
ID6854DS0$V521<-ifelse(ID6854DS0$V521==1,3,
                ifelse(ID6854DS0$V521==2,2,
                ifelse(ID6854DS0$V521==3,1,
                ifelse(ID6854DS0$V521==4,0,NA))))
ID6854DS0$V522<-ifelse(ID6854DS0$V522==1,0,
                ifelse(ID6854DS0$V522==2,1,
                ifelse(ID6854DS0$V522==3,2,
                ifelse(ID6854DS0$V522==4,3,NA))))#RC
ID6854DS0$V523<-ifelse(ID6854DS0$V523==1,3,
                ifelse(ID6854DS0$V523==2,2,
                ifelse(ID6854DS0$V523==3,1,
                ifelse(ID6854DS0$V523==4,0,NA))))
ID6854DS0$V524<-ifelse(ID6854DS0$V524==1,3,
                ifelse(ID6854DS0$V524==2,2,
                ifelse(ID6854DS0$V524==3,1,
                ifelse(ID6854DS0$V524==4,0,NA))))
ID6854DS0$V525<-ifelse(ID6854DS0$V525==1,0,
                ifelse(ID6854DS0$V525==2,1,
                ifelse(ID6854DS0$V525==3,2,
                ifelse(ID6854DS0$V525==4,3,NA))))#RC
ID6854DS0$V526<-ifelse(ID6854DS0$V526==1,3,
                ifelse(ID6854DS0$V526==2,2,
                ifelse(ID6854DS0$V526==3,1,
                ifelse(ID6854DS0$V526==4,0,NA))))
ID6854DS0$V527<-ifelse(ID6854DS0$V527==1,3,
                ifelse(ID6854DS0$V527==2,2,
                ifelse(ID6854DS0$V527==3,1,
                ifelse(ID6854DS0$V527==4,0,NA))))
ID6854DS0$V528<-ifelse(ID6854DS0$V528==1,3,
                ifelse(ID6854DS0$V528==2,2,
                ifelse(ID6854DS0$V528==3,1,
                ifelse(ID6854DS0$V528==4,0,NA))))
ID6854DS0$V529<-ifelse(ID6854DS0$V529==1,3,
                ifelse(ID6854DS0$V529==2,2,
                ifelse(ID6854DS0$V529==3,1,
                ifelse(ID6854DS0$V529==4,0,NA))))
...
dsitems <- ID6854DS0[c(2:12)]
#dsitemspw <- ID6854DS0[c(:)]
#Identify participants missing more than half of dsitems (not dsitemsW1) (1=missing > 50%) - to be used later
ID6854DS0$dsmiss<-ifelse(rowSums(is.na(dsitems))>((ncol(dsitems)/2)),1,0)
#Compute mean symptom score 
ID6854DS0$DEP<-rowMeans(x=dsitems,na.rm=TRUE)
ID6854DS0$DEPPW<-NA#rowMeans(x=dsitemspw,na.rm=TRUE)
...
#1.Yes
#5.No [Inap in
#8.DK [Inap in V217-V220]
#9.NA [Inap in V217-V220]
ID6854DS0$LAT<-ifelse(ID6854DS0$V216==1,1,0)
#1.White/Caucasian
#2.Black/African American
#3.Other
ID6854DS0$BLK<-ifelse(ID6854DS0$V221M==2,1,0)
ID6854DS0$OTH<-ifelse(ID6854DS0$V221M==3,1,0)
ID6854DS0$WHT<-ifelse(ID6854DS0$V221M==1,1,0)
ID6854DS0$AI<-NA
ID6854DS0$AA<-NA
ID6854DS0$MR<-NA

#Compute variable for participants who reported more than one race (mixed/biracial; do not include Latino/Hispanic)
#ID6854DS0$MR<-ifelse((rowSums(x=cbind(ID6854DS0$WHT,ID6854DS0$BLK,ID6854DS0$AI,ID6854DS0$AA,ID6854DS0$OTH),
#                              na.rm=TRUE)) > 1, 1, 0)

##Compute variables for participants who reported a single race (excluding mixed/biracial & Latino/Hispanic)
ID6854DS0$WHT<-ifelse(((ID6854DS0$LAT == 0)&(ID6854DS0$WHT == 1)), 1, 0)
ID6854DS0$BLK<-ifelse(((ID6854DS0$LAT == 0)&(ID6854DS0$BLK == 1)), 1, 0)
#ID6854DS0$AI<-ifelse(((ID6854DS0$LAT == 0)&(ID6854DS0$AI == 1)), 1, 0)
#ID6854DS0$AA<-ifelse(((ID6854DS0$LAT == 0)&(ID6854DS0$AA == 1)), 1, 0)
ID6854DS0$OTH<-ifelse(((ID6854DS0$LAT == 0)&(ID6854DS0$OTH == 1)), 1, 0)
#ID6854DS0$MR<-ifelse(((ID6854DS0$LAT == 0)&(ID6854DS0$MR == 1)), 1, 0)
...
#8.DK
#9.NA
ID6854DS0$SEX<-ifelse(ID6854DS0$V47==1,1,
               ifelse(ID6854DS0$V47==2,0,NA))

#Recode age 
ID6854DS0$AGECALC<-ID6854DS0$V46

#Income, Education, Occupation ----
##Income
ID6854DS0$INC<-pmax(ID6854DS0$V6559,ID6854DS0$V5403,na.rm = TRUE)
        
##Education
ID6854DS0$EDU<-ID6854DS0$V207
...
write.csv(ID6854DS0, file = 'ID6854DS0_1992_recoded.csv')

#Descriptives and Correlations -----
#Exclude participants with more than 50% missing on depressive symptoms items
ID6854DS0 <- ID6854DS0[which(ID6854DS0$dsmiss==0), ]

##Compute mean and sd across all participants within dataset
library('psych')
#Means & SDs of focal variables
dstatsage<-describe(ID6854DS0$AGECALC)
dstatsdep<-describe(ID6854DS0$DEP)
dstatsachv<-NA#describe(ID6854DS0$ACHV)
dstatsinc<-describe(ID6854DS0$INC)
dstatsedu<-describe(ID6854DS0$EDU)
dstatsoccs<-NA#describe(ID6854DS0$OCCS)
dstatsoccp<-NA#describe(ID6854DS0$OCCP)

#Save descriptive stats
dstats<-rbind(dstatsage,dstatsdep,dstatsachv,dstatsinc,dstatsedu,dstatsoccs,dstatsoccp,make.row.names= FALSE)
write.csv(dstats,file = 'ID6854DS0_1992_dstats.csv',
          row.names=c("dstatsage","dstatsdep","dstatsachv","dstatsinc","dstatsedu","dstatsoccs","dstatsoccp"))

##Histograms 
pdf('ID6854DS0_1992_dephist.pdf')
hist(ID6854DS0$DEP, xlab="Depressive Symptoms", main = NULL, col="grey")
dev.off()
#pdf('ID6854DS0_1992_achvhist.pdf')
#hist(ID6854DS0$ACHV, xlab="Academic Achievement", main = NULL, col="grey")
#dev.off()
pdf('ID6854DS0_1992_inchist.pdf')
hist(ID6854DS0$INC, xlab="Income", main = NULL, col="grey")
dev.off()
pdf('ID6854DS0_1992_educhist.pdf')
hist(ID6854DS0$EDU, xlab="Educational Attainment", main = NULL, col="grey")
dev.off()
#pdf('ID6854DS0_1992_occshist.pdf')
#hist(ID6854DS0$OCCS, xlab="Occupational Status", main = NULL, col="grey")
#dev.off()
#pdf('ID6854DS0_1992_occphist.pdf')
#hist(ID6854DS0$OCCP, xlab="Occupational Prestige", main = NULL, col="grey")
#dev.off()
...
table(ID6854DS0$AGECALC)
#Separate dataset by developmental period, if needed
#CH<-ID6854DS0[which((ID6854DS0$AGECALC >= 5)&(ID6854DS0$AGECALC <= 11)), ] 
#AD<-ID6854DS0[which((ID6854DS0$AGECALC >= 12)&(ID6854DS0$AGECALC <= 17)), ]
#YD<-ID6854DS0[which((ID6854DS0$AGECALC >= 18)&(ID6854DS0$AGECALC <= 25)), ]
AT<-ID6854DS0[which((ID6854DS0$AGECALC >= 26)&(ID6854DS0$AGECALC <= 64)), ]
OA<-ID6854DS0[which(ID6854DS0$AGECALC >= 65), ]
...
##Assign ICPSR ID number (ICPSR Number; e.g., file name = ID6854DS0, then DATAID = 21600)
#DATAID<-'6854'
#names(DATAID)<-'DATAID'
...
ID6854DS0_1992_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID6854DS0_1992_aggregated, file = 'ID6854DS0_1992_aggregated.csv',row.names = FALSE)
