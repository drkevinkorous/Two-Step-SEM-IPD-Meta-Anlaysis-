...
#Depressive symptom items: U2964800,U2964900(RC),U2965000,U2965100(RC),U2965200
#Depressive symptom items prior wave: U1030700,U1030800(RC),U1030900,U1031000(RC),U1031100
#Academic Achievement: self-report college GPA
#U2159900,U2160000,U2160100,U2160200,U2160300
#Academic Achievement prior wave: self-report college GPA
...
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: U2857200 
#Maternal Income: NA
#Paternal Income: NA
#Household Income: U1845500 
#Participant Education: Z9083800
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: U1719400 (2002 census codes) 
#Maternal Occupation: NA
#Paternal Occupation: NA
#Household Occupation: NA
#SES: NA
#Year of data collection (not a variable in the dataset): 2017
#Notes: NLSY97

#Create Dataset ----
attach(merged182)
#Extract relevant variables into a dataframe.
ID182DS0<-data.frame(R0000100,U2964800,U2964900,U2965000,U2965100,U2965200,U1030700,U1030800,U1030900,U1031000,U1031100,
                     U2159900,U2160000,U2160100,U2160200,U2160300,U0243400,U0243500,U0243600,U0243700,
                     S1224800,S1224900,S1224901,S1224902,S1224903,S1224904,S1224905,R0536300,
                     U1838500,R0536402,R0536401,U2857200,U1845500,Z9083800,U1719400)
detach(merged182)
...
ID182DS0$U2964800<-ifelse(ID182DS0$U2964800=="ALL OF THE TIME",3,                 
                   ifelse(ID182DS0$U2964800=="MOST OF THE TIME",2, 
                   ifelse(ID182DS0$U2964800=="SOME OF THE TIME",1,       
                   ifelse(ID182DS0$U2964800=="NONE OF THE TIME",0,NA))))
ID182DS0$U2964900<-ifelse(ID182DS0$U2964900=="ALL OF THE TIME",0,                 
                   ifelse(ID182DS0$U2964900=="MOST OF THE TIME",1, 
                   ifelse(ID182DS0$U2964900=="SOME OF THE TIME",2,       
                   ifelse(ID182DS0$U2964900=="NONE OF THE TIME",3,NA))))#RC
ID182DS0$U2965000<-ifelse(ID182DS0$U2965000=="ALL OF THE TIME",3,                 
                   ifelse(ID182DS0$U2965000=="MOST OF THE TIME",2, 
                   ifelse(ID182DS0$U2965000=="SOME OF THE TIME",1,       
                   ifelse(ID182DS0$U2965000=="NONE OF THE TIME",0,NA))))
ID182DS0$U2965100<-ifelse(ID182DS0$U2965100=="ALL OF THE TIME",0,                 
                   ifelse(ID182DS0$U2965100=="MOST OF THE TIME",1, 
                   ifelse(ID182DS0$U2965100=="SOME OF THE TIME",2,       
                   ifelse(ID182DS0$U2965100=="NONE OF THE TIME",3,NA))))#RC
ID182DS0$U2965200<-ifelse(ID182DS0$U2965200=="ALL OF THE TIME",3,                 
                   ifelse(ID182DS0$U2965200=="MOST OF THE TIME",2, 
                   ifelse(ID182DS0$U2965200=="SOME OF THE TIME",1,       
                   ifelse(ID182DS0$U2965200=="NONE OF THE TIME",0,NA))))
...
ID182DS0$U2159900<-colGPArecode(ID182DS0$U2159900)
ID182DS0$U2160000<-colGPArecode(ID182DS0$U2160000)
ID182DS0$U2160100<-colGPArecode(ID182DS0$U2160100)
ID182DS0$U2160200<-colGPArecode(ID182DS0$U2160200)
ID182DS0$U2160300<-colGPArecode(ID182DS0$U2160300)
ID182DS0$ACHV<-rowMeans(x=cbind(ID182DS0$U2159900,ID182DS0$U2160000,ID182DS0$U2160100,
                                ID182DS0$U2160200,ID182DS0$U2160300),na.rm = TRUE)
...
ID182DS0$ACHVPW<-rowMeans(x=cbind(ID182DS0$U0243400,ID182DS0$U0243500,ID182DS0$U0243600,
...
#Recode age 
ID182DS0$AGECALC<-ID182DS0$U1838500

#Income, Education, Occupation ----
##Income
#Take highest income reported
ID182DS0$INC<-pmax(ID182DS0$U2857200,ID182DS0$U1845500,na.rm = TRUE)

##Education
ID182DS0$EDU<-ifelse(ID182DS0$Z9083800=="1st grade",1,         
              ifelse(ID182DS0$Z9083800=="2nd grade",2,          
              ifelse(ID182DS0$Z9083800=="3rd grade",3,         
              ifelse(ID182DS0$Z9083800=="4th grade",4,          
              ifelse(ID182DS0$Z9083800=="5th grade",5,         
              ifelse(ID182DS0$Z9083800=="6th grade",6,          
              ifelse(ID182DS0$Z9083800=="7th grade",7,         
              ifelse(ID182DS0$Z9083800=="8th grade",8,          
              ifelse(ID182DS0$Z9083800=="9th grade",9,         
              ifelse(ID182DS0$Z9083800=="10th grade",10,         
              ifelse(ID182DS0$Z9083800=="11th grade",11,        
              ifelse(ID182DS0$Z9083800=="12th grade",12,         
              ifelse(ID182DS0$Z9083800=="1st year college",13,        
              ifelse(ID182DS0$Z9083800=="2nd year college",14,         
              ifelse(ID182DS0$Z9083800=="3rd year college",15,        
              ifelse(ID182DS0$Z9083800=="4th year college",16,         
              ifelse(ID182DS0$Z9083800=="5th year college",17,        
              ifelse(ID182DS0$Z9083800=="6th year college",18,         
              ifelse(ID182DS0$Z9083800=="7th year college",19,        
              ifelse(ID182DS0$Z9083800=="8th year college or more",20,NA))))))))))))))))))))
...
occ_codes<-read.csv('IPD182DS0_NLSY97_2017_Occupational codes.csv')
...
ID182DS0$U1719400<-factor(ID182DS0$U1719400)
ID182DS0$OCCS<-as.numeric(as.character(occstatusvalues[ match(ID182DS0$U1719400, occvalues) ]))
...
ID182DS0$U1719400<-factor(ID182DS0$U1719400)
ID182DS0$OCCP<-as.numeric(as.character(occprestvalues[ match(ID182DS0$U1719400, occvalues) ]))

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID182DS0, file = 'ID182NLSY97_2017_recoded.csv')
...
#Select variables for correlation matrix
AAATMCmatrixvars<-matrixvars[-c(11:12)]
AAATMC <- AAATM[AAATMCmatrixvars]
...
write.csv(ID182DS0_aggregated, file = 'ID182NLSY97_2017_aggregated.csv',row.names = FALSE)
