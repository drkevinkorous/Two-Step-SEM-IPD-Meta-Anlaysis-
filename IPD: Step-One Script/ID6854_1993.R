#load dataset
library('foreign')
resp<-read.spss('BR21.SAV')
household<-read.spss('BHH21.SAV')
#Merge datasets by HHID
ID68541993<-merge(resp,household,by="HHID")
#Coded variables
#Participant ID: HHID (household ID); PN (rep ID)
#Measure Name (not a variable in the dataset): CESD
#Depressive symptom items: 
#V307,V309,V310,V311(RC),V312,V314(RC),V315,V316
...
#Notes: HRS AHEAD CORE

#Create Dataset ----
attach(ID68541993)
#Extract relevant variables into a dataframe.
ID6854DS0<-data.frame(HHID,PN,V307,V309,V310,V311,V312,V314,V315,V316,V140,V143,SEX,AGE,
                      V114,V159,V160,V161,HHINC,V125,OCCG3B)
detach(ID68541993)
...
#8=DK
#9=RF
ID6854DS0$V307<-ifelse(ID6854DS0$V307==1,1,
                ifelse(ID6854DS0$V307==5,0,NA))
ID6854DS0$V309<-ifelse(ID6854DS0$V309==1,1,
                ifelse(ID6854DS0$V309==5,0,NA))
ID6854DS0$V310<-ifelse(ID6854DS0$V310==1,1,
                ifelse(ID6854DS0$V310==5,0,NA))
ID6854DS0$V311<-ifelse(ID6854DS0$V311==1,0,
                ifelse(ID6854DS0$V311==5,1,NA))#RC
ID6854DS0$V312<-ifelse(ID6854DS0$V312==1,1,
                ifelse(ID6854DS0$V312==5,0,NA))
ID6854DS0$V314<-ifelse(ID6854DS0$V314==1,0,
                ifelse(ID6854DS0$V314==5,1,NA))#RC 
ID6854DS0$V315<-ifelse(ID6854DS0$V315==1,1,
                ifelse(ID6854DS0$V315==5,0,NA))
ID6854DS0$V316<-ifelse(ID6854DS0$V316==1,1,
                ifelse(ID6854DS0$V316==5,0,NA))      
...
#.D=DK 
#.R=RF 
ID6854DS0$LAT<-ifelse(ID6854DS0$V140==1,1,0)
#1=WHITE/CAUCASIAN
#2=BLACK/AFRICAN AMERICAN
#3=OTHER (SPECIFY)
#8=DK 
#.R=RF
ID6854DS0$BLK<-ifelse(ID6854DS0$V143==2,1,0)
ID6854DS0$OTH<-ifelse(ID6854DS0$V143==3,1,0)
ID6854DS0$WHT<-ifelse(ID6854DS0$V143==1,1,0)
ID6854DS0$AI<-NA
ID6854DS0$AA<-NA
ID6854DS0$MR<-NA
...
#1.Male
#2.Female
ID6854DS0$SEX<-ifelse(ID6854DS0$SEX==1,1,
               ifelse(ID6854DS0$SEX==2,0,NA))

#Recode age 
ID6854DS0$AGECALC<-ID6854DS0$AGE

#Income, Education, Occupation ----
##Income
ID6854DS0$INC<-ID6854DS0$HHINC
        
##Education
ID6854DS0$EDU<-ID6854DS0$V125
...
write.csv(ID6854DS0, file = 'ID6854DS0_1993_recoded.csv')
...
#ALPHAOV <- ci.reliability(data=WHTCHF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTCHM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTCHM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTADF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTADF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTADM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTADM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTYDF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTYDF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=WHTYDM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=WHTYDM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTATF[3:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTATF[3:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTATM[3:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTATM[3:10], type = "omega", interval.type = "none")
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTOAF[3:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTOAF[3:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=WHTOAM[3:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=WHTOAM[3:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#names(DATAYEAR)<-'DATAYEAR'
##Compute reliability estimates
#ALPHAOV <- ci.reliability(data=LATCHF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATCHM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATCHM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#names(DATAYEAR)<-'DATAYEAR'
##Compute reliability estimates
#ALPHAOV <- ci.reliability(data=LATADF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATADF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATADM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATADM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATYDF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATYDF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATYDM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATYDM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATATF[3:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATATF[3:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATATM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATATM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATOAF[3:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATOAF[3:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=LATOAM[3:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=LATOAM[3:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKCHM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKCHM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKADF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKADF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKADM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKADM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKYDF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKYDF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKYDM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKYDM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKATF[3:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKATF[3:10], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=BLKATM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=BLKATM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKOAF[3:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKOAF[3:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKOAM[3:10], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKOAM[3:10], type = "omega", interval.type = "none")
ALPHA <- ALPHAOV$est
OMEGA <- OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AACHMC[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AACHMC[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAYDF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAYDF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAYDM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAYDM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAATF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAATF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAATM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAATM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AICHM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AICHM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIYDF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIYDF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIYDM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIYDM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIATF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIATF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIATM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIATM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIOAF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIOAF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIOAM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIOAM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRCHM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRCHM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRADM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRADM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRYDF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRYDF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRYDM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRYDM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRATF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRATF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MRATM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MRATM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MROAF[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MROAF[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=MROAM[3:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=MROAM[3:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
ID6854DS0_1993_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID6854DS0_1993_aggregated, file = 'ID6854DS0_1993_aggregated.csv',row.names = FALSE)
