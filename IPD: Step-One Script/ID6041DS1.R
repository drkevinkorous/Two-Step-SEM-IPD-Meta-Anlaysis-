...
#Birth Month: NA
#Birth Day: NA
#Evaluation Year: MYEAR	
#Evaluation Month: MMONTH
#Evaluation Day: MDAY
#Participant Income: IREARN  
#Maternal Income: NA
#Paternal Income: NA
#Household Income: IHEARN
#Participant Education: EDUCAT
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: M540A 
...
#Notes: NSFH Wave 1 (Main Respondent Data) 

#Create Dataset ----
attach(da06041.0001)
#Extract relevant variables into a dataframe.
ID6041DS1<-data.frame(MCASEID,E202A,E202B,E202C,E202D,E202E,E202F,E202G,E202H,E202I,E202J,E202K,E202L,
                      M484,M2DP01,M2BP01,M485M,MYEAR,MMONTH,MDAY,IREARN,IHEARN,EDUCAT,M540A,M540B) 
detach(da06041.0001)
ID6041DS1$ORIGOBS<-nrow(ID6041DS1)
rm(da06041.0001)
...
ID6041DS1$E202A<-ifelse(ID6041DS1$E202A==0,0,
                  ifelse(((ID6041DS1$E202A==1)|(ID6041DS1$E202A==2)),1,
                  ifelse(((ID6041DS1$E202A==3)|(ID6041DS1$E202A==4)),2,
                  ifelse(ID6041DS1$E202A>=5,3,NA))))
ID6041DS1$E202B<-ifelse(ID6041DS1$E202B==0,0,
                  ifelse(((ID6041DS1$E202B==1)|(ID6041DS1$E202B==2)),1,
                  ifelse(((ID6041DS1$E202B==3)|(ID6041DS1$E202B==4)),2,
                  ifelse(ID6041DS1$E202B>=5,3,NA))))
ID6041DS1$E202C<-ifelse(ID6041DS1$E202C==0,0,
                  ifelse(((ID6041DS1$E202C==1)|(ID6041DS1$E202C==2)),1,
                  ifelse(((ID6041DS1$E202C==3)|(ID6041DS1$E202C==4)),2,
                  ifelse(ID6041DS1$E202C>=5,3,NA))))
ID6041DS1$E202D<-ifelse(ID6041DS1$E202D==0,0,
                  ifelse(((ID6041DS1$E202D==1)|(ID6041DS1$E202D==2)),1,
                  ifelse(((ID6041DS1$E202D==3)|(ID6041DS1$E202D==4)),2,
                  ifelse(ID6041DS1$E202D>=5,3,NA))))
ID6041DS1$E202E<-ifelse(ID6041DS1$E202E==0,0,
                  ifelse(((ID6041DS1$E202E==1)|(ID6041DS1$E202E==2)),1,
                  ifelse(((ID6041DS1$E202E==3)|(ID6041DS1$E202E==4)),2,
                  ifelse(ID6041DS1$E202E>=5,3,NA))))
ID6041DS1$E202F<-ifelse(ID6041DS1$E202F==0,0,
                  ifelse(((ID6041DS1$E202F==1)|(ID6041DS1$E202F==2)),1,
                  ifelse(((ID6041DS1$E202F==3)|(ID6041DS1$E202F==4)),2,
                  ifelse(ID6041DS1$E202F>=5,3,NA))))
ID6041DS1$E202G<-ifelse(ID6041DS1$E202G==0,0,
                  ifelse(((ID6041DS1$E202G==1)|(ID6041DS1$E202G==2)),1,
                  ifelse(((ID6041DS1$E202G==3)|(ID6041DS1$E202G==4)),2,
                  ifelse(ID6041DS1$E202G>=5,3,NA))))
ID6041DS1$E202H<-ifelse(ID6041DS1$E202H==0,0,
                  ifelse(((ID6041DS1$E202H==1)|(ID6041DS1$E202H==2)),1,
                  ifelse(((ID6041DS1$E202H==3)|(ID6041DS1$E202H==4)),2,
                  ifelse(ID6041DS1$E202H>=5,3,NA))))
ID6041DS1$E202I<-ifelse(ID6041DS1$E202I==0,0,
                  ifelse(((ID6041DS1$E202I==1)|(ID6041DS1$E202I==2)),1,
                  ifelse(((ID6041DS1$E202I==3)|(ID6041DS1$E202I==4)),2,
                  ifelse(ID6041DS1$E202I>=5,3,NA))))
ID6041DS1$E202J<-ifelse(ID6041DS1$E202J==0,0,
                  ifelse(((ID6041DS1$E202J==1)|(ID6041DS1$E202J==2)),1,
                  ifelse(((ID6041DS1$E202J==3)|(ID6041DS1$E202J==4)),2,
                  ifelse(ID6041DS1$E202J>=5,3,NA))))
ID6041DS1$E202K<-ifelse(ID6041DS1$E202K==0,0,
                  ifelse(((ID6041DS1$E202K==1)|(ID6041DS1$E202K==2)),1,
                  ifelse(((ID6041DS1$E202K==3)|(ID6041DS1$E202K==4)),2,
                  ifelse(ID6041DS1$E202K>=5,3,NA))))
ID6041DS1$E202L<-ifelse(ID6041DS1$E202L==0,0,
                  ifelse(((ID6041DS1$E202L==1)|(ID6041DS1$E202L==2)),1,
                  ifelse(((ID6041DS1$E202L==3)|(ID6041DS1$E202L==4)),2,
                  ifelse(ID6041DS1$E202L>=5,3,NA))))
...
dsitems <- ID6041DS1[c(2:13)]
#dsitemspw <- ID6041DS1[c(:)]
#Identify participants missing more than half of dsitems (not dsitemsW1) (1=missing > 50%) - to be used later
ID6041DS1$dsmiss<-ifelse(rowSums(is.na(dsitems))>((ncol(dsitems)/2)),1,0)
#Compute mean symptom score 
ID6041DS1$DEP<-rowMeans(x=dsitems,na.rm=TRUE)
ID6041DS1$DEPPW<-NA#rowMeans(x=dsitemspw,na.rm=TRUE)
...
ID6041DS1$LAT<-ifelse(((ID6041DS1$M484 == "(3) MEX/CHICANO/MEX.AM")|
                       (ID6041DS1$M484 == "(4) PUERTO RICAN")|
                       (ID6041DS1$M484 == "(5) CUBAN")|
                       (ID6041DS1$M484 == "(6) OTHER HISPANIC")),1,0)
ID6041DS1$WHT<-ifelse(ID6041DS1$M484=="(2) WHITE/NOT HISPANIC",1,0)
ID6041DS1$BLK<-ifelse(ID6041DS1$M484=="(1) BLACK",1,0)
ID6041DS1$AI<-ifelse(ID6041DS1$M484=="(7) AMERICAN INDIAN",1,0)
ID6041DS1$AA<-ifelse(ID6041DS1$M484=="(8) ASIAN",1,0)
ID6041DS1$OTH<-ifelse(ID6041DS1$M484=="(9) OTHER",1,0)
#Compute variable for participants who reported more than one race (mixed/biracial; do not include Latino/Hispanic)
ID6041DS1$MR<- NA#ifelse((rowSums(x=cbind(ID6041DS1$WHT,ID6041DS1$BLK,ID6041DS1$OTH),
                             #na.rm=TRUE)) > 1, 1, 0)

##Compute variables for participants who reported a single race (excluding mixed/biracial & Latino/Hispanic)
#ID6041DS1$WHT<-ifelse(((ID6041DS1$LAT == 0)&(ID6041DS1$MR == 0)&(ID6041DS1$WHT == 1)), 1, 0)
#ID6041DS1$BLK<-ifelse(((ID6041DS1$LAT == 0)&(ID6041DS1$MR == 0)&(ID6041DS1$BLK == 1)), 1, 0)
#ID6041DS1$AI<-ifelse(((ID6041DS1$LAT == 0)&(ID6041DS1$MR == 0)&(ID6041DS1$AI == 1)), 1, 0)
#ID6041DS1$AA<-ifelse(((ID6041DS1$LAT == 0)&(ID6041DS1$MR == 0)&(ID6041DS1$AA == 1)), 1, 0)
#ID6041DS1$OTH<-ifelse(((ID6041DS1$LAT == 0)&(ID6041DS1$MR == 0)&(ID6041DS1$OTH == 1)), 1, 0)
#ID6041DS1$MR<-ifelse(((ID6041DS1$LAT == 0)&(ID6041DS1$MR == 1)), 1, 0)

#Recode factor into numeric,
ID6041DS1$SEX<-ifelse(ID6041DS1$M2DP01=="(1) MALE",1,0)

#Recode age 
ID6041DS1$AGECALC<-ID6041DS1$M2BP01

#Income, Education, Occupation ----
##Income
ID6041DS1$INC<-pmax(ID6041DS1$IREARN,ID6041DS1$IHEARN,na.rm = TRUE)
        
##Education
ID6041DS1$EDU<-ifelse(ID6041DS1$EDUCAT=="(00) NO FORML EDUCATION",0, 
               ifelse(ID6041DS1$EDUCAT=="(01) FIRST GRADE",1,       
               ifelse(ID6041DS1$EDUCAT=="(02) SECOND GRADE",2,       
               ifelse(ID6041DS1$EDUCAT=="(03) THIRD GRADE",3,       
               ifelse(ID6041DS1$EDUCAT=="(04) FOURTH GRADE",4,       
               ifelse(ID6041DS1$EDUCAT=="(05) FIFTH GRADE",5,       
               ifelse(ID6041DS1$EDUCAT=="(06) SIXTH GRADE",6,        
               ifelse(ID6041DS1$EDUCAT=="(07) SEVENTH GRADE",7,     
               ifelse(ID6041DS1$EDUCAT=="(08) EIGHT GRADE",8,        
               ifelse(ID6041DS1$EDUCAT=="(09) NINTH GRADE",9,       
               ifelse(ID6041DS1$EDUCAT=="(10) TENTH GRADE",10,        
               ifelse(ID6041DS1$EDUCAT=="(11) ELEVENTH GRADE",11,    
               ifelse(ID6041DS1$EDUCAT=="(12) HIGH SCHL GRADUATE",12, 
               ifelse(ID6041DS1$EDUCAT=="(13) ATTND COLL/NO DGR",13, 
               ifelse(ID6041DS1$EDUCAT=="(14) ASSOC DEGREE-2YR",14,   
               ifelse(ID6041DS1$EDUCAT=="(15) ENROLLED 3 YRS",15,    
               ifelse(ID6041DS1$EDUCAT=="(16) BACHELOR'S DEGREE",16,  
               ifelse(ID6041DS1$EDUCAT=="(17) ENROLLED POST GRAD",17,
               ifelse(ID6041DS1$EDUCAT=="(18) MASTER'S DEGREE",18,    
               ifelse(ID6041DS1$EDUCAT=="(19) ENROLLD POST-MASTR",19,
               ifelse(ID6041DS1$EDUCAT=="(20) DOCTORATE/PROF DGR",20,NA)))))))))))))))))))))

##Occupation
#Recode factor into numeric (occupational status)
#Nam-Powers-Boyd scale (Nam & Boyd, 2008)
occ_codes<-read.csv('ID6041DS1_Occupational codes.csv')
...
ID6041DS1$OCCS<-as.numeric(as.character(occstatusvalues[ match(ID6041DS1$M540A, occvalues) ]))
...
ID6041DS1$OCCP<-as.numeric(as.character(occprestvalues[ match(ID6041DS1$M540A, occvalues) ]))

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID6041DS1, file = 'ID6041DS1_recoded.csv')

#Descriptives and Correlations -----
#Exclude participants with more than 50% missing on depressive symptoms items
ID6041DS1 <- ID6041DS1[which(ID6041DS1$dsmiss==0), ]

##Compute mean and sd across all participants within dataset
library('psych')
#Means & SDs of focal variables
dstatsage<-describe(ID6041DS1$AGECALC)
dstatsdep<-describe(ID6041DS1$DEP)
dstatsachv<-NA#describe(ID6041DS1$ACHV)
dstatsinc<-describe(ID6041DS1$INC)
dstatsedu<-describe(ID6041DS1$EDU)
dstatsoccs<-describe(ID6041DS1$OCCS)
dstatsoccp<-describe(ID6041DS1$OCCP)

#Save descriptive stats
dstats<-rbind(dstatsage,dstatsdep,dstatsachv,dstatsinc,dstatsedu,dstatsoccs,dstatsoccp,make.row.names= FALSE)
write.csv(dstats,file = 'ID6041DS1_dstats.csv',
          row.names=c("dstatsage","dstatsdep","dstatsachv","dstatsinc","dstatsedu","dstatsoccs","dstatsoccp"))

##Histograms 
pdf('ID6041DS1_dephist.pdf')
hist(ID6041DS1$DEP, xlab="Depressive Symptoms", main = NULL, col="grey")
dev.off()
#pdf('ID6041DS1_achvhist.pdf')
#hist(ID6041DS1$ACHV, xlab="Academic Achievement", main = NULL, col="grey")
#dev.off()
pdf('ID6041DS1_inchist.pdf')
hist(ID6041DS1$INC, xlab="Income", main = NULL, col="grey")
dev.off()
pdf('ID6041DS1_educhist.pdf')
hist(ID6041DS1$EDU, xlab="Educational Attainment", main = NULL, col="grey")
dev.off()
pdf('ID6041DS1_occshist.pdf')
hist(ID6041DS1$OCCS, xlab="Occupational Status", main = NULL, col="grey")
dev.off()
pdf('ID6041DS1_occphist.pdf')
hist(ID6041DS1$OCCP, xlab="Occupational Prestige", main = NULL, col="grey")
dev.off()
...
table(ID6041DS1$AGECALC)
#Separate dataset by developmental period, if needed
#CH<-ID6041DS1[which((ID6041DS1$AGECALC >= 5)&(ID6041DS1$AGECALC <= 11)), ] 
#AD<-ID6041DS1[which((ID6041DS1$AGECALC >= 12)&(ID6041DS1$AGECALC <= 17)), ]
YD<-ID6041DS1[which((ID6041DS1$AGECALC >= 18)&(ID6041DS1$AGECALC <= 25)), ]
AT<-ID6041DS1[which((ID6041DS1$AGECALC >= 26)&(ID6041DS1$AGECALC <= 64)), ]
OA<-ID6041DS1[which(ID6041DS1$AGECALC >= 65), ]
...
##Assign ICPSR ID number (ICPSR Number; e.g., file name = ID6041DS1, then DATAID = 21600)
#DATAID<-'6041'
#names(DATAID)<-'DATAID'
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AAYDM[2:13], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AAYDM[2:13], type = "omega", interval.type = "none")
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AIYDM[2:13], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AIYDM[2:13], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
ID6041DS1_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID6041DS1_aggregated, file = 'ID6041DS1_aggregated.csv',row.names = FALSE)
