#Load data
library('foreign')
data<-read.spss('03334-0001-Data.sav')
#Coded variables
#Participant ID: ID
...
#SLEEP,EFFORT,GETGO,MIND,SAD,LONELY,BLUES,ENJOY,HOPEFUL,HAPPY
...
#Birth Month: NA
#Birth Day: NA
#Evaluation Year: INTYR2
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: EARN12  
#Maternal Income: NA
#Paternal Income: NA
#Household Income: FAMIN12
#Participant Education: ED2
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: OCCW2R 
...
#Notes: Aging, Status, and Sense of Control (ASOC) - Wave 2

#Create Dataset ----
attach(data)
#Extract relevant variables into a dataframe.
ID3334DS1<-data.frame(ID,SLEEP2,EFFORT2,GETGO2,MIND2,SAD2,LONELY2,BLUES2,ENJOY2,HOPEFUL2,HAPPY2,
                      SLEEP,EFFORT,GETGO,MIND,SAD,LONELY,BLUES,ENJOY,HOPEFUL,HAPPY,
                      HISPANI2,RACE2,SEX2,YEARBOR2,INTYR2,EARN12,FAMIN12,ED2,OCCW2R) 
detach(data)
ID3334DS1$ORIGOBS<-nrow(ID3334DS1)
rm(data)
...
ID3334DS1$SLEEP2<-ifelse(ID3334DS1$SLEEP2=="None",0,
                 ifelse(((ID3334DS1$SLEEP2=="Day")|(ID3334DS1$SLEEP2=="2")),1,
                 ifelse(((ID3334DS1$SLEEP2=="3")|(ID3334DS1$SLEEP2=="4")),2,
                 ifelse(((ID3334DS1$SLEEP2=="5")|(ID3334DS1$SLEEP2=="6")|
                 (ID3334DS1$SLEEP2=="Days")),3,NA))))
ID3334DS1$EFFORT2<-ifelse(ID3334DS1$EFFORT2=="None",0,
                  ifelse(((ID3334DS1$EFFORT2=="Day")|(ID3334DS1$EFFORT2=="2")),1,
                  ifelse(((ID3334DS1$EFFORT2=="3")|(ID3334DS1$EFFORT2=="4")),2,
                  ifelse(((ID3334DS1$EFFORT2=="5")|(ID3334DS1$EFFORT2=="6")|
                  (ID3334DS1$EFFORT2=="Days")),3,NA))))
ID3334DS1$GETGO2<-ifelse(ID3334DS1$GETGO2=="None",0,
                 ifelse(((ID3334DS1$GETGO2=="Day")|(ID3334DS1$GETGO2=="2")),1,
                 ifelse(((ID3334DS1$GETGO2=="3")|(ID3334DS1$GETGO2=="4")),2,
                 ifelse(((ID3334DS1$GETGO2=="5")|(ID3334DS1$GETGO2=="6")|
                 (ID3334DS1$GETGO2=="Days")),3,NA))))
ID3334DS1$MIND2<-ifelse(ID3334DS1$MIND2=="None",0,
                ifelse(((ID3334DS1$MIND2=="Day")|(ID3334DS1$MIND2=="2")),1,
                ifelse(((ID3334DS1$MIND2=="3")|(ID3334DS1$MIND2=="4")),2,
                ifelse(((ID3334DS1$MIND2=="5")|(ID3334DS1$MIND2=="6")|
                (ID3334DS1$MIND2=="Days")),3,NA))))
ID3334DS1$SAD2<-ifelse(ID3334DS1$SAD2=="None",0,
               ifelse(((ID3334DS1$SAD2=="Day")|(ID3334DS1$SAD2=="2")),1,
               ifelse(((ID3334DS1$SAD2=="3")|(ID3334DS1$SAD2=="4")),2,
               ifelse(((ID3334DS1$SAD2=="5")|(ID3334DS1$SAD2=="6")|
               (ID3334DS1$SAD2=="Days")),3,NA))))
ID3334DS1$LONELY2<-ifelse(ID3334DS1$LONELY2=="None",0,
                  ifelse(((ID3334DS1$LONELY2=="Day")|(ID3334DS1$LONELY2=="2")),1,
                  ifelse(((ID3334DS1$LONELY2=="3")|(ID3334DS1$LONELY2=="4")),2,
                  ifelse(((ID3334DS1$LONELY2=="5")|(ID3334DS1$LONELY2=="6")|
                  (ID3334DS1$LONELY2=="Days")),3,NA))))
ID3334DS1$BLUES2<-ifelse(ID3334DS1$BLUES2=="None",0,
                 ifelse(((ID3334DS1$BLUES2=="Day")|(ID3334DS1$BLUES2=="2")),1,
                 ifelse(((ID3334DS1$BLUES2=="3")|(ID3334DS1$BLUES2=="4")),2,
                 ifelse(((ID3334DS1$BLUES2=="5")|(ID3334DS1$BLUES2=="6")|
                 (ID3334DS1$BLUES2=="Days")),3,NA))))
ID3334DS1$ENJOY2<-ifelse(ID3334DS1$ENJOY2=="None",3,
                 ifelse(((ID3334DS1$ENJOY2=="Day")|(ID3334DS1$ENJOY2=="2")),2,
                 ifelse(((ID3334DS1$ENJOY2=="3")|(ID3334DS1$ENJOY2=="4")),1,
                 ifelse(((ID3334DS1$ENJOY2=="5")|(ID3334DS1$ENJOY2=="6")|
                 (ID3334DS1$ENJOY2=="Days")),0,NA))))
ID3334DS1$HOPEFUL2<-ifelse(ID3334DS1$HOPEFUL2=="None",3,
                   ifelse(((ID3334DS1$HOPEFUL2=="Day")|(ID3334DS1$HOPEFUL2=="2")),2,
                   ifelse(((ID3334DS1$HOPEFUL2=="3")|(ID3334DS1$HOPEFUL2=="4")),1,
                   ifelse(((ID3334DS1$HOPEFUL2=="5")|(ID3334DS1$HOPEFUL2=="6")|
                   (ID3334DS1$HOPEFUL2=="Days")),0,NA))))
ID3334DS1$HAPPY2<-ifelse(ID3334DS1$HAPPY2=="None",3,
                 ifelse(((ID3334DS1$HAPPY2=="Day")|(ID3334DS1$HAPPY2=="2")),2,
                 ifelse(((ID3334DS1$HAPPY2=="3")|(ID3334DS1$HAPPY2=="4")),1,
                 ifelse(((ID3334DS1$HAPPY2=="5")|(ID3334DS1$HAPPY2=="6")|
                 (ID3334DS1$HAPPY2=="Days")),0,NA))))
...
#Occasionally or a moderate amount of time: 3-4 days (code as 2)
#Most or all of the time: 5 - 7 days (Code as 3)
ID3334DS1$SLEEP<-ifelse(ID3334DS1$SLEEP=="None",0,
                 ifelse(((ID3334DS1$SLEEP=="Days")|(ID3334DS1$SLEEP=="2")),1,
                 ifelse(((ID3334DS1$SLEEP=="3")|(ID3334DS1$SLEEP=="4")),2,
                 ifelse(((ID3334DS1$SLEEP=="5")|(ID3334DS1$SLEEP=="6")|
                 (ID3334DS1$SLEEP=="Days_duplicated_7")),3,NA))))
ID3334DS1$EFFORT<-ifelse(ID3334DS1$EFFORT=="None",0,
                  ifelse(((ID3334DS1$EFFORT=="Days")|(ID3334DS1$EFFORT=="2")),1,
                  ifelse(((ID3334DS1$EFFORT=="3")|(ID3334DS1$EFFORT=="4")),2,
                  ifelse(((ID3334DS1$EFFORT=="5")|(ID3334DS1$EFFORT=="6")|
                  (ID3334DS1$EFFORT=="Days_duplicated_7")),3,NA))))
ID3334DS1$GETGO<-ifelse(ID3334DS1$GETGO=="None",0,
                 ifelse(((ID3334DS1$GETGO=="Days")|(ID3334DS1$GETGO=="2")),1,
                 ifelse(((ID3334DS1$GETGO=="3")|(ID3334DS1$GETGO=="4")),2,
                 ifelse(((ID3334DS1$GETGO=="5")|(ID3334DS1$GETGO=="6")|
                 (ID3334DS1$GETGO=="Days_duplicated_7")),3,NA))))
ID3334DS1$MIND<-ifelse(ID3334DS1$MIND=="None",0,
                ifelse(((ID3334DS1$MIND=="Days")|(ID3334DS1$MIND=="2")),1,
                ifelse(((ID3334DS1$MIND=="3")|(ID3334DS1$MIND=="4")),2,
                ifelse(((ID3334DS1$MIND=="5")|(ID3334DS1$MIND=="6")|
                (ID3334DS1$MIND=="Days_duplicated_7")),3,NA))))
ID3334DS1$SAD<-ifelse(ID3334DS1$SAD=="None",0,
               ifelse(((ID3334DS1$SAD=="Days")|(ID3334DS1$SAD=="2")),1,
               ifelse(((ID3334DS1$SAD=="3")|(ID3334DS1$SAD=="4")),2,
               ifelse(((ID3334DS1$SAD=="5")|(ID3334DS1$SAD=="6")|
               (ID3334DS1$SAD=="Days_duplicated_7")),3,NA))))
ID3334DS1$LONELY<-ifelse(ID3334DS1$LONELY=="None",0,
                  ifelse(((ID3334DS1$LONELY=="Days")|(ID3334DS1$LONELY=="2")),1,
                  ifelse(((ID3334DS1$LONELY=="3")|(ID3334DS1$LONELY=="4")),2,
                  ifelse(((ID3334DS1$LONELY=="5")|(ID3334DS1$LONELY=="6")|
                  (ID3334DS1$LONELY=="Days_duplicated_7")),3,NA))))
ID3334DS1$BLUES<-ifelse(ID3334DS1$BLUES=="None",0,
                 ifelse(((ID3334DS1$BLUES=="Days")|(ID3334DS1$BLUES=="2")),1,
                 ifelse(((ID3334DS1$BLUES=="3")|(ID3334DS1$BLUES=="4")),2,
                 ifelse(((ID3334DS1$BLUES=="5")|(ID3334DS1$BLUES=="6")|
                 (ID3334DS1$BLUES=="Days_duplicated_7")),3,NA))))
ID3334DS1$ENJOY<-ifelse(ID3334DS1$ENJOY=="None",3,
                 ifelse(((ID3334DS1$ENJOY=="Days")|(ID3334DS1$ENJOY=="2")),2,
                 ifelse(((ID3334DS1$ENJOY=="3")|(ID3334DS1$ENJOY=="4")),1,
                 ifelse(((ID3334DS1$ENJOY=="5")|(ID3334DS1$ENJOY=="6")|
                 (ID3334DS1$ENJOY=="Days_duplicated_7")),0,NA))))
ID3334DS1$HOPEFUL<-ifelse(ID3334DS1$HOPEFUL=="None",3,
                   ifelse(((ID3334DS1$HOPEFUL=="Days")|(ID3334DS1$HOPEFUL=="2")),2,
                   ifelse(((ID3334DS1$HOPEFUL=="3")|(ID3334DS1$HOPEFUL=="4")),1,
                   ifelse(((ID3334DS1$HOPEFUL=="5")|(ID3334DS1$HOPEFUL=="6")|
                   (ID3334DS1$HOPEFUL=="Days_duplicated_7")),0,NA))))
ID3334DS1$HAPPY<-ifelse(ID3334DS1$HAPPY=="None",3,
                 ifelse(((ID3334DS1$HAPPY=="Days")|(ID3334DS1$HAPPY=="2")),2,
                 ifelse(((ID3334DS1$HAPPY=="3")|(ID3334DS1$HAPPY=="4")),1,
                 ifelse(((ID3334DS1$HAPPY=="5")|(ID3334DS1$HAPPY=="6")|
                 (ID3334DS1$HAPPY=="Days_duplicated_7")),0,NA))))

#Assign dataframe that contains all depressive symtpoms (using the column numbers of the items)
dsitems <- ID3334DS1[c(2:11)]
dsitemspw <- ID3334DS1[c(12:21)]
#Identify participants missing more than half of dsitems (not dsitemsW1) (1=missing > 50%) - to be used later
ID3334DS1$dsmiss<-ifelse(rowSums(is.na(dsitems))>((ncol(dsitems)/2)),1,0)
#Compute mean symptom score 
ID3334DS1$DEP<-rowMeans(x=dsitems,na.rm=TRUE)
ID3334DS1$DEPPW<-rowMeans(x=dsitemspw,na.rm=TRUE)
...
ID3334DS1$LAT<-ifelse(ID3334DS1$HISPANI2 == "Yes", 1, 0)
ID3334DS1$WHT<-ifelse(ID3334DS1$RACE2 == "White", 1, 0)
ID3334DS1$BLK<-ifelse(ID3334DS1$RACE2 == "Black, Afrcn Americn", 1, 0)
ID3334DS1$AI<-ifelse(ID3334DS1$RACE2 == "Asian, Pacifc Islndr", 1, 0)
ID3334DS1$AA<-ifelse(ID3334DS1$RACE2 == "Native Amercn, Alskn", 1, 0)
ID3334DS1$OTH<-ifelse(ID3334DS1$RACE2 == "Something else", 1, 0)
#Compute variable for participants who reported more than one race (mixed/biracial; do not include Latino/HISPANI2)
ID3334DS1$MR<- ifelse((rowSums(x=cbind(ID3334DS1$WHT,ID3334DS1$BLK,ID3334DS1$AI,ID3334DS1$AA,
                                       ID3334DS1$OTH),na.rm=TRUE)) > 1, 1, 0)

##Compute variables for participants who reported a single race (excluding mixed/biracial & Latino/HISPANI2)
ID3334DS1$WHT<-ifelse(((ID3334DS1$LAT == 0)&(ID3334DS1$MR == 0)&(ID3334DS1$WHT == 1)), 1, 0)
ID3334DS1$BLK<-ifelse(((ID3334DS1$LAT == 0)&(ID3334DS1$MR == 0)&(ID3334DS1$BLK == 1)), 1, 0)
ID3334DS1$AI<-ifelse(((ID3334DS1$LAT == 0)&(ID3334DS1$MR == 0)&(ID3334DS1$AI == 1)), 1, 0)
ID3334DS1$AA<-ifelse(((ID3334DS1$LAT == 0)&(ID3334DS1$MR == 0)&(ID3334DS1$AA == 1)), 1, 0)
ID3334DS1$OTH<-ifelse(((ID3334DS1$LAT == 0)&(ID3334DS1$MR == 0)&(ID3334DS1$OTH == 1)), 1, 0)
ID3334DS1$MR<-ifelse(((ID3334DS1$LAT == 0)&(ID3334DS1$MR == 1)), 1, 0)

#Recode sex
ID3334DS1$SEX<-ifelse(ID3334DS1$SEX2 == "MALE", 1, 
               ifelse(ID3334DS1$SEX2 == "FEMALE", 0, NA))

#Recode age 
levels(ID3334DS1$YEARBOR2)[levels(ID3334DS1$YEARBOR2)=="_duplicated_1977"]<-"1977"
ID3334DS1$YEARBOR2<-as.numeric(as.character(ID3334DS1$YEARBOR2))
ID3334DS1$INTYR2[ID3334DS1$INTYR2 == -99]<-NA
ID3334DS1$INTYR2 <-ID3334DS1$INTYR2 + 1900
ID3334DS1$AGECALC<-ID3334DS1$INTYR2-ID3334DS1$YEARBOR2

#Income, Education, Occupation ----
##Income 
levels(ID3334DS1$EARN12)[levels(ID3334DS1$EARN12)=="-9"]<-"NA"
levels(ID3334DS1$EARN12)[levels(ID3334DS1$EARN12)=="Dollars"]<-"0"
levels(ID3334DS1$EARN12)[levels(ID3334DS1$EARN12)=="1e+05"]<-"100000"
levels(ID3334DS1$EARN12)[levels(ID3334DS1$EARN12)=="2e+05"]<-"200000"
levels(ID3334DS1$EARN12)[levels(ID3334DS1$EARN12)=="3e+05"]<-"300000"
levels(ID3334DS1$EARN12)[levels(ID3334DS1$EARN12)=="4e+05"]<-"400000"
levels(ID3334DS1$EARN12)[levels(ID3334DS1$EARN12)=="Dollars_duplicated_5e+05" ]<-"500000"
levels(ID3334DS1$EARN12)[levels(ID3334DS1$EARN12)=="$500,001 or more"]<-"500001"
ID3334DS1$EARN12<-as.numeric(as.character(ID3334DS1$EARN12))

levels(ID3334DS1$FAMIN12)[levels(ID3334DS1$FAMIN12)=="-9"]<-"NA"
levels(ID3334DS1$FAMIN12)[levels(ID3334DS1$FAMIN12)=="Dollars"]<-"0"
levels(ID3334DS1$FAMIN12)[levels(ID3334DS1$FAMIN12)=="1e+05"]<-"100000"
levels(ID3334DS1$FAMIN12)[levels(ID3334DS1$FAMIN12)=="2e+05"]<-"200000"
levels(ID3334DS1$FAMIN12)[levels(ID3334DS1$FAMIN12)=="3e+05"]<-"300000"
levels(ID3334DS1$FAMIN12)[levels(ID3334DS1$FAMIN12)=="4e+05"]<-"400000"
levels(ID3334DS1$FAMIN12)[levels(ID3334DS1$FAMIN12)=="5e+05"]<-"500000"
levels(ID3334DS1$FAMIN12)[levels(ID3334DS1$FAMIN12)=="6e+05"]<-"600000"
levels(ID3334DS1$FAMIN12)[levels(ID3334DS1$FAMIN12)=="7e+05"]<-"700000"
levels(ID3334DS1$FAMIN12)[levels(ID3334DS1$FAMIN12)=="Dollars_duplicated_8e+05" ]<-"800000"
levels(ID3334DS1$FAMIN12)[levels(ID3334DS1$FAMIN12)=="$800,001 or more"]<-"800001"
ID3334DS1$FAMIN12<-as.numeric(as.character(ID3334DS1$FAMIN12))

ID3334DS1$INC<-pmax(ID3334DS1$FAMIN12,ID3334DS1$EARN12,na.rm = TRUE)

##Education
ID3334DS1$EDU<-ifelse(ID3334DS1$ED2=="None", 0,              
               ifelse(ID3334DS1$ED2=="Elementary", 1,                 
               ifelse(ID3334DS1$ED2=="2", 2,                 
               ifelse(ID3334DS1$ED2=="3", 3,                 
               ifelse(ID3334DS1$ED2=="4", 4,               
               ifelse(ID3334DS1$ED2=="5", 5,                 
               ifelse(ID3334DS1$ED2=="6", 6,                  
               ifelse(ID3334DS1$ED2=="7", 7,
               ifelse(ID3334DS1$ED2=="Elementary_duplicated_8", 8,              
               ifelse(ID3334DS1$ED2=="Some High school", 9,                 
               ifelse(ID3334DS1$ED2=="Some High school_duplicated_10", 10,                 
               ifelse(ID3334DS1$ED2=="Some High school_duplicated_11", 11,                 
               ifelse(ID3334DS1$ED2=="H.S. grad or GED", 12,               
               ifelse(ID3334DS1$ED2=="Some college", 13,                 
               ifelse(ID3334DS1$ED2=="Some college_duplicated_14", 14,                  
               ifelse(ID3334DS1$ED2=="Some college_duplicated_15", 15,
               ifelse(ID3334DS1$ED2=="College degree", 16,                 
               ifelse(ID3334DS1$ED2=="Some graduate school", 17,                 
               ifelse(ID3334DS1$ED2=="Masters level degree", 18,               
               ifelse(ID3334DS1$ED2=="Doctoral degree", 20,                 
               ifelse(ID3334DS1$ED2=="Professional degree", 20, NA)))))))))))))))))))))


##Occupation
#Nam-Powers-Boyd scale (Nam & Boyd, 2008)
occ_codes<-read.csv(file = 'ID3334DS1_1998_Occupational codes.csv')
#match codes with each row in data
ID3334DS1$OCCS<-occ_codes$OCC_STATUS[ match(ID3334DS1$OCCW2R,occ_codes$OCC_CODE)]

#Recode factor into numeric (occupational prestige)
#Nakao & Tres scale (1994)
ID3334DS1$OCCP<-occ_codes$OCC_PREST[ match(ID3334DS1$OCCW2R,occ_codes$OCC_CODE)]

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID3334DS1, file = 'ID3334DS1_1998_recoded.csv')

#Descriptives and Correlations -----
#Exclude participants with more than 50% missing on depressive symptoms items
ID3334DS1 <- ID3334DS1[which(ID3334DS1$dsmiss==0), ]

##Compute mean and sd across all participants within dataset
library('psych')
#Means & SDs of focal variables
dstatsage<-describe(ID3334DS1$AGECALC)
dstatsdep<-describe(ID3334DS1$DEP)
dstatsachv<-NA#describe(ID3334DS1$ACHV)
dstatsinc<-describe(ID3334DS1$INC)
dstatsedu<-describe(ID3334DS1$EDU)
dstatsoccs<-describe(ID3334DS1$OCCS)
dstatsoccp<-describe(ID3334DS1$OCCP)

#Save descriptive stats
dstats<-rbind(dstatsage,dstatsdep,dstatsachv,dstatsinc,dstatsedu,dstatsoccs,dstatsoccp,make.row.names= FALSE)
write.csv(dstats,file = 'ID3334DS1_1998_dstats.csv',
          row.names=c("dstatsage","dstatsdep","dstatsachv","dstatsinc","dstatsedu","dstatsoccs","dstatsoccp"))

##Histograms 
pdf('ID3334DS1_1998_dephist.pdf')
hist(ID3334DS1$DEP, xlab="Depressive Symptoms", main = NULL, col="grey")
dev.off()
#pdf('ID3334DS1_1998_achvhist.pdf')
#hist(ID3334DS1$ACHV, xlab="Academic Achievement", main = NULL, col="grey")
#dev.off()
pdf('ID3334DS1_1998_inchist.pdf')
hist(ID3334DS1$INC, xlab="Income", main = NULL, col="grey")
dev.off()
pdf('ID3334DS1_1998_educhist.pdf')
hist(ID3334DS1$EDU, xlab="Educational Attainment", main = NULL, col="grey")
dev.off()
pdf('ID3334DS1_1998_occshist.pdf')
hist(ID3334DS1$OCCS, xlab="Occupational Status", main = NULL, col="grey")
dev.off()
pdf('ID3334DS1_1998_occphist.pdf')
hist(ID3334DS1$OCCP, xlab="Occupational Prestige", main = NULL, col="grey")
dev.off()
...
table(ID3334DS1$AGECALC)
#Separate dataset by developmental period, if needed
#CH<-ID3334DS1[which((ID3334DS1$AGECALC >= 5)&(ID3334DS1$AGECALC <= 11)), ] 
#AD<-ID3334DS1[which((ID3334DS1$AGECALC >= 12)&(ID3334DS1$AGECALC <= 17)), ]
YD<-ID3334DS1[which((ID3334DS1$AGECALC >= 18)&(ID3334DS1$AGECALC <= 25)), ]
AT<-ID3334DS1[which((ID3334DS1$AGECALC >= 26)&(ID3334DS1$AGECALC <= 64)), ]
OA<-ID3334DS1[which(ID3334DS1$AGECALC >= 65), ]
...
##Assign ICPSR ID number (ICPSR Number; e.g., file name = ID3334DS1, then DATAID = 21600)
#DATAID<-'3334'
#names(DATAID)<-'DATAID'
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=LATOAF[2:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=LATOAF[2:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKATM[2:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKATM[2:11], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAOAF[2:11], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAOAF[2:11], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AIATM[2:11], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AIATM[2:11], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
ID3334DS1_1998_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID3334DS1_1998_aggregated, file = 'ID3334DS1_1998_aggregated.csv',row.names = FALSE)
