...
#missed one variable in initial download, merge datasets
load('00182-NLSY79-Data-2.rda')
merged182<-merge(da00182.0000,da00182.0002,by='R0000100')
#Coded variables
#H40CESD top year of 2006 (XRND year)
#H50CESD top year of 2016 (XRND year)
#also 1992 and 1994 specific DS
#Participant ID: R0000100
#Measure Name (not a variable in the dataset): CESD
#Depressive symptom items: H0013400,H0013401,H0013402,H0013403,H0013404,H0013405,H0013406,H0013407,H0013408
#Depressive symptom items prior wave: NA
#Academic Achievement: NA
#Academic Achievement prior wave: NA
#Ethnicity: NA
#Race: R0009600,R0010200
#White: NA
#Black: NA 
...
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: T5619500 
#Maternal Income: NA
#Paternal Income: NA
#Household Income: T5770800 
#Participant Education: T4201100 (2014 education),T5176100 (2016 education skipped some participants)
...
#Household Occupation: T5256900 (2000 census codes)
#SES: NA
#Year of data collection (not a variable in the dataset): 2016
#Notes: NLSY79

#Create Dataset ----
attach(merged182)
#Extract relevant variables into a dataframe.
ID182DS0<-data.frame(R0000100,H0013400,H0013401,H0013402,H0013403,H0013404,H0013405,H0013406,H0013407,H0013408,
                     R0009600,R0010200,R0214800,T5771500,T5619500,T5770800,T4201100,T5176100,T5256900) 
detach(merged182)
ID182DS0$ORIGOBS<-nrow(ID182DS0)
rm(da00182.0000,da00182.0002,merged182)
...
ID182DS0$H0013400<-ifelse(ID182DS0$H0013400=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0013400=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0013400=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0013400=="Most/All of the time/5-7 Days",3,NA))))
ID182DS0$H0013401<-ifelse(ID182DS0$H0013401=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0013401=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0013401=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0013401=="Most/All of the time/5-7 Days",3,NA))))  
ID182DS0$H0013402<-ifelse(ID182DS0$H0013402=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0013402=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0013402=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0013402=="Most/All of the time/5-7 Days",3,NA))))  
ID182DS0$H0013403<-ifelse(ID182DS0$H0013403=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0013403=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0013403=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0013403=="Most/All of the time/5-7 Days",3,NA))))  
ID182DS0$H0013404<-ifelse(ID182DS0$H0013404=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0013404=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0013404=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0013404=="Most/All of the time/5-7 Days",3,NA))))  
ID182DS0$H0013405<-ifelse(ID182DS0$H0013405=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0013405=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0013405=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0013405=="Most/All of the time/5-7 Days",3,NA))))  
ID182DS0$H0013406<-ifelse(ID182DS0$H0013406=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0013406=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0013406=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0013406=="Most/All of the time/5-7 Days",3,NA))))
ID182DS0$H0013407<-ifelse(ID182DS0$H0013407=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0013407=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0013407=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0013407=="Most/All of the time/5-7 Days",3,NA))))
ID182DS0$H0013408<-ifelse(ID182DS0$H0013408=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0013408=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0013408=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0013408=="Most/All of the time/5-7 Days",3,NA))))
...
dsitems <- ID182DS0[c(2:10)]
dsitemspw <- NA#ID182DS0[c(:)]
...
#Race/ethnicity was coded based on two answers in the screening survey:
#R0009600 (for first or only race/ethnicity); R0010200 (for most close identification if greater than 2 races/ethnicities)
#Combine codes to be consistent with NLSY79 
ID182DS0$RETH<-ifelse((is.na(ID182DS0$R0010200)),as.character(ID182DS0$R0009600),as.character(ID182DS0$R0010200))
ID182DS0$RETH<-as.factor(ID182DS0$RETH)
ID182DS0$LAT<-ifelse(((ID182DS0$RETH == "CUBAN")|
                      (ID182DS0$RETH == "CHICANO")|
                      (ID182DS0$RETH == "MEXICAN")|
                      (ID182DS0$RETH == "MEXICAN-AMER")|
                      (ID182DS0$RETH == "PUERTO RICAN")|
                      (ID182DS0$RETH == "OTHER HISPANIC")|
                      (ID182DS0$RETH == "OTHER SPANISH")),1,0)
ID182DS0$BLK<-ifelse(ID182DS0$RETH=="BLACK",1,0)
ID182DS0$AI<-ifelse(ID182DS0$RETH=="INDIAN-AMERICAN OR NATIVE AMERICAN",1,0)
ID182DS0$AA<-ifelse(((ID182DS0$RETH=="ASIAN INDIAN")|
                   (ID182DS0$RETH=="CHINESE")|
                   (ID182DS0$RETH=="FILIPINO")|
                   (ID182DS0$RETH=="JAPANESE")|
                   (ID182DS0$RETH=="KOREAN")|
                   (ID182DS0$RETH=="VIETNAMESE")|
                   (ID182DS0$RETH=="HAWAIIAN, P.I.")),1,0)
ID182DS0$OTH<-ifelse(ID182DS0$RETH=="OTHER",1,0)
ID182DS0$WHT<-ifelse(((ID182DS0$RETH=="AMERICAN")|
                      (ID182DS0$RETH=="FRENCH")|
                      (ID182DS0$RETH=="GERMAN")|
                      (ID182DS0$RETH=="GREEK")|
                      (ID182DS0$RETH=="IRISH")|
                      (ID182DS0$RETH=="POLISH")|
                      (ID182DS0$RETH=="PORTUGUESE")|
                      (ID182DS0$RETH=="RUSSIAN")|
                      (ID182DS0$RETH=="SCOTTISH")|
                      (ID182DS0$RETH=="WELSH")|
                      (ID182DS0$RETH=="ENGLISH")|
                      (ID182DS0$RETH=="ITALIAN")),1,0)

#Compute variable for participants who reported more than one race (mixed/biracial; do not include Latino/Hispanic)
ID182DS0$MR<-NA#ifelse((rowSums(x=cbind(ID182DS0$WHT,ID182DS0$BLK,ID182DS0$AI,ID182DS0$AA,ID182DS0$OTH),
                             #na.rm=TRUE)) > 1, 1, 0)
...
ID182DS0$SEX<-ifelse(ID182DS0$R0214800=="MALE",1,0)

#Recode age 
ID182DS0$AGECALC<-as.numeric(as.character(ID182DS0$T5771500))

#Income, Education, Occupation ----
##Income
#Take highest income reported
ID182DS0$INC<-pmax(ID182DS0$T5619500,ID182DS0$T5770800,na.rm = TRUE)
...
ID182DS0$T5176100<-ifelse(ID182DS0$T5176100=="1ST GRADE",1,         
                    ifelse(ID182DS0$T5176100=="2ND GRADE",2,          
                    ifelse(ID182DS0$T5176100=="3RD GRADE",3,         
                    ifelse(ID182DS0$T5176100=="4TH GRADE",4,          
                    ifelse(ID182DS0$T5176100=="5TH GRADE",5,         
                    ifelse(ID182DS0$T5176100=="6TH GRADE",6,          
                    ifelse(ID182DS0$T5176100=="7TH GRADE",7,         
                    ifelse(ID182DS0$T5176100=="8TH GRADE",8,          
                    ifelse(ID182DS0$T5176100=="9TH GRADE",9,         
                    ifelse(ID182DS0$T5176100=="10TH GRADE",10,         
                    ifelse(ID182DS0$T5176100=="11TH GRADE",11,        
                    ifelse(ID182DS0$T5176100=="12TH GRADE",12,         
                    ifelse(ID182DS0$T5176100=="1ST YEAR COLLEGE",13,        
                    ifelse(ID182DS0$T5176100=="2ND YEAR COLLEGE",14,         
                    ifelse(ID182DS0$T5176100=="3RD YEAR COLLEGE",15,        
                    ifelse(ID182DS0$T5176100=="4TH YEAR COLLEGE",16,         
                    ifelse(ID182DS0$T5176100=="5TH YEAR COLLEGE",17,        
                    ifelse(ID182DS0$T5176100=="6TH YEAR COLLEGE",18,         
                    ifelse(ID182DS0$T5176100=="7TH YEAR COLLEGE",19,        
                    ifelse(ID182DS0$T5176100=="8TH YEAR COLLEGE OR MORE",20,NA))))))))))))))))))))
#Take highest education reported
ID182DS0$EDU<-pmax(ID182DS0$T4201100,ID182DS0$T5176100,na.rm=TRUE)
...
occ_codes<-read.csv('IPD182DS0_2016_Occupational codes.csv')
...
ID182DS0$T5256900<-factor(ID182DS0$T5256900)
ID182DS0$OCCS<-as.numeric(as.character(occstatusvalues[ match(ID182DS0$T5256900, occvalues) ]))
...
ID182DS0$T5256900<-factor(ID182DS0$T5256900)
ID182DS0$OCCP<-as.numeric(as.character(occprestvalues[ match(ID182DS0$T5256900, occvalues) ]))

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID182DS0, file = 'ID182DS0_2016_recoded.csv')
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADF[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADM[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADM[2:10], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- NA#ci.reliability(data=AIYDF[2:10], type = "alpha", interval.type = "none")
#OMEGAOV <- NA#ci.reliability(data=AIYDF[2:10], type = "omega", interval.type = "none")
...
#OMEGAOV <- NA#ci.reliability(data=AIYDM[2:10], type = "omega", interval.type = "none")
#ALPHA <- NA#ALPHAOV$est
#OMEGA <- NA#OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
write.csv(ID182DS0_aggregated, file = 'ID182DS0_2016_aggregated.csv',row.names = FALSE)
