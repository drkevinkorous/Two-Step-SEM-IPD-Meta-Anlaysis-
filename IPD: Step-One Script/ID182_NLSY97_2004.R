#load dataset
load('00182-NLSY97-Data.rda')
#merge achievement data
load('182_NLSY97_ACH.rda')
merged182<-merge(da00182.0000,da00182.ach,by='R0000100')
names(merged182)[names(merged182)=='R0536300.x']<-'R0536300'
names(merged182)[names(merged182)=='R0536402.x']<-'R0536402'
names(merged182)[names(merged182)=='R0536401.x']<-'R0536401'
#Coded variables
#Participant ID: R0000100
#Measure Name (not a variable in the dataset): Mental Health Inventory (MHI-5)
#Depressive symptom items: S4681900,S4682000(RC),S4682100,S4682200(RC),S4682300
#Depressive symptom items prior wave: S0920800,S0920900(RC),S0921000,S0921100(RC),S0921200
#Academic Achievement: self-report college GPA 
#S4208300,S4208400,S4208500,S4208600
#Transcript grades for participants recently graduated from high school (use R9859600 to distinguish years Wave 1: 2000, Wave 2: 2004)
#R9750000,R9750100,R9750200,R9750300,R9750400,R9750500,R9750600,R9750700,R9750800,R9750900,R9751000,
#R9751100,R9751200,R9751300,R9751400,R9751500,R9751600,R9751700,R9751800,R9751900,R9752000,R9752100,
#R9752200,R9752300,R9752400,R9752500,R9752600,R9752700,R9752800,R9752900,R9753000,R9753100,R9753200,	
#R9753300,R9753400,R9753500,R9753600,R9753700,R9753800,R9753900,R9754000,R9754100,R9754200,R9754300,	
#R9754400,R9754500,R9754600,R9754700,R9754800,R9754900,R9755000,R9755100,R9755200,R9755300,R9755400,	
#R9755500,R9755600,R9755700,R9755800,R9755900,R9756000,R9756100,R9756200,R9756300,R9756400,R9756500,	
#R9756600,R9756700,R9756800,R9756900,R9757000,R9757100,R9757200,R9757300,R9757400,R9757500,R9757600,	
#R9757700,R9757800,R9757900,R9758000,R9758100,R9758200,R9758300,R9758400,R9758500,R9758600,R9758700,	
#R9758800,R9758900,R9759000,R9759100,R9759200,R9759300,R9759400,R9759500,R9759600,R9759700,R9759800,	
#R9759900,R9760000,R9760100,R9760200,R9760300,R9760400,R9760500,R9760600,R9760700,R9760800,R9760900,	
#R9761000,R9761100,R9761200,R9761300,R9761400,R9761500,R9761600,R9761700,R9761800,R9761900,R9762000,	
#R9762100,R9762200,R9762300
#Academic Achievement prior wave:
#Self-report grade for participants in college
#S0438700,S0438800,S0438900,S0439000,S0439100
#Ethnicity: S1224800
#Race: NA
#White: S1224900
#Black: S1224901 
#Asian or Pacific Islander: S1224902,S1224903
#Native American: S1224904
#More than one race: NA
#Other Race (to determine more than one race): S1224905
#Sex: R0536300
#Age: S3801100
#Birth Year: R0536402	
#Birth Month: R0536401
#Birth Day: NA
#Evaluation Year: NA
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: S4799600 
#Maternal Income: NA
#Paternal Income: NA
#Household Income: S3812400 
#Participant Education: S4032500 
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: S5041700 (2002 census codes) 
...
ID182DS0<-data.frame(R0000100,S4681900,S4682000,S4682100,S4682200,S4682300,S0920800,S0920900,S0921000,S0921100,S0921200,
                     S4208300,S4208400,S4208500,S4208600,S0438700,S0438800,S0438900,S0439000,S0439100,R9859600,
                     R9750000,R9750100,R9750200,R9750300,R9750400,R9750500,R9750600,R9750700,R9750800,R9750900,R9751000,
                     R9751100,R9751200,R9751300,R9751400,R9751500,R9751600,R9751700,R9751800,R9751900,R9752000,R9752100,
                     R9752200,R9752300,R9752400,R9752500,R9752600,R9752700,R9752800,R9752900,R9753000,R9753100,R9753200,
                     R9753300,R9753400,R9753500,R9753600,R9753700,R9753800,R9753900,R9754000,R9754100,R9754200,R9754300,
                     ...
                     R9759900,R9760000,R9760100,R9760200,R9760300,R9760400,R9760500,R9760600,R9760700,R9760800,R9760900,
                     R9761000,R9761100,R9761200,R9761300,R9761400,R9761500,R9761600,R9761700,R9761800,R9761900,R9762000,
                     R9762100,R9762200,R9762300,S1224800,S1224900,S1224901,S1224902,S1224903,S1224904,S1224905,R0536300,
                     S3801100,R0536402,R0536401,S4799600,S3812400,S4032500,S5041700)
detach(merged182)
ID182DS0$ORIGOBS<-nrow(ID182DS0)
rm(da00182.0000,da00182.ach,merged182)
...
ID182DS0$S4681900<-ifelse(ID182DS0$S4681900=="All of the time",3,                 
                   ifelse(ID182DS0$S4681900=="Most of the time",2, 
                   ifelse(ID182DS0$S4681900=="Some of the time",1,       
                   ifelse(ID182DS0$S4681900=="None of the time",0,NA))))
ID182DS0$S4682000<-ifelse(ID182DS0$S4682000=="All of the time",0,                 
                   ifelse(ID182DS0$S4682000=="Most of the time",1, 
                   ifelse(ID182DS0$S4682000=="Some of the time",2,       
                   ifelse(ID182DS0$S4682000=="None of the time",3,NA))))#RC
ID182DS0$S4682100<-ifelse(ID182DS0$S4682100=="All of the time",3,                 
                   ifelse(ID182DS0$S4682100=="Most of the time",2, 
                   ifelse(ID182DS0$S4682100=="Some of the time",1,       
                   ifelse(ID182DS0$S4682100=="None of the time",0,NA))))
ID182DS0$S4682200<-ifelse(ID182DS0$S4682200=="All of the time",0,                 
                   ifelse(ID182DS0$S4682200=="Most of the time",1, 
                   ifelse(ID182DS0$S4682200=="Some of the time",2,       
                   ifelse(ID182DS0$S4682200=="None of the time",3,NA))))#RC
ID182DS0$S4682300<-ifelse(ID182DS0$S4682300=="All of the time",3,                 
                   ifelse(ID182DS0$S4682300=="Most of the time",2, 
                   ifelse(ID182DS0$S4682300=="Some of the time",1,       
                   ifelse(ID182DS0$S4682300=="None of the time",0,NA))))

#Depressive symptoms prior wave 
ID182DS0$S0920800<-ifelse(ID182DS0$S0920800=="All of the time",3,                 
                   ifelse(ID182DS0$S0920800=="Most of the time",2, 
                   ifelse(ID182DS0$S0920800=="Some of the time",1,       
                   ifelse(ID182DS0$S0920800=="None of the time",0,NA))))
ID182DS0$S0920900<-ifelse(ID182DS0$S0920900=="All of the time",0,                 
                   ifelse(ID182DS0$S0920900=="Most of the time",1, 
                   ifelse(ID182DS0$S0920900=="Some of the time",2,       
                   ifelse(ID182DS0$S0920900=="None of the time",3,NA))))#RC
ID182DS0$S0921000<-ifelse(ID182DS0$S0921000=="All of the time",3,                 
                   ifelse(ID182DS0$S0921000=="Most of the time",2, 
                   ifelse(ID182DS0$S0921000=="Some of the time",1,       
                   ifelse(ID182DS0$S0921000=="None of the time",0,NA))))
ID182DS0$S0921100<-ifelse(ID182DS0$S0921100=="All of the time",0,                 
                   ifelse(ID182DS0$S0921100=="Most of the time",1, 
                   ifelse(ID182DS0$S0921100=="Some of the time",2,       
                   ifelse(ID182DS0$S0921100=="None of the time",3,NA))))#RC
ID182DS0$S0921200<-ifelse(ID182DS0$S0921200=="All of the time",3,                 
                   ifelse(ID182DS0$S0921200=="Most of the time",2, 
                   ifelse(ID182DS0$S0921200=="Some of the time",1,       
                   ifelse(ID182DS0$S0921200=="None of the time",0,NA))))

#Assign dataframe that contains all depressive symtpoms (using the column numbers of the items)
dsitems <- ID182DS0[c(2:6)]
dsitemspw <- ID182DS0[c(7:11)]
...
colGPArecode<-function(colGPA){ifelse(colGPA<500,colGPA/100,NA)}
ID182DS0$S4208300<-colGPArecode(ID182DS0$S4208300)
ID182DS0$S4208400<-colGPArecode(ID182DS0$S4208400)
ID182DS0$S4208500<-colGPArecode(ID182DS0$S4208500)
ID182DS0$S4208600<-colGPArecode(ID182DS0$S4208600)
ID182DS0$colGPAaverage<-rowMeans(x=cbind(ID182DS0$S4208300,ID182DS0$S4208400,ID182DS0$S4208500,
                                         ID182DS0$S4208600),na.rm = TRUE)
#high school transcript grades 
hsgraderecode<-function(transtatus,hsgrade){ifelse(transtatus=="Wave 2 complete",dplyr::recode(hsgrade,"1: A+"=4.0,"2: A"=4.0,"3: A-"=3.7,"4: B+"=3.3,"5: B"=3.0,"6: B-"=2.7,
              "7: C+"=2.3,"8: C"=2.0,"9: C-"=1.7,"10: D+"=1.3,"11: D" =1.0,"12: D-"=0.7,"13: F"=0.0),NA)}
ID182DS0$R9750000<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9750000)
ID182DS0$R9750100<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9750100)
ID182DS0$R9750200<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9750200)
ID182DS0$R9750300<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9750300)
ID182DS0$R9750400<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9750400)
ID182DS0$R9750500<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9750500)
ID182DS0$R9750600<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9750600)
ID182DS0$R9750700<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9750700)
ID182DS0$R9750800<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9750800)
ID182DS0$R9750900<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9750900)
ID182DS0$R9751000<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9751000)
ID182DS0$R9751100<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9751100)
ID182DS0$R9751200<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9751200)
ID182DS0$R9751300<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9751300)
ID182DS0$R9751400<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9751400)
ID182DS0$R9751500<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9751500)
ID182DS0$R9751600<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9751600)
ID182DS0$R9751700<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9751700)
ID182DS0$R9751800<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9751800)
ID182DS0$R9751900<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9751900)
ID182DS0$R9752000<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9752000)
ID182DS0$R9752100<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9752100)
ID182DS0$R9752200<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9752200)
ID182DS0$R9752300<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9752300)
ID182DS0$R9752400<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9752400)
ID182DS0$R9752500<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9752500)
ID182DS0$R9752600<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9752600)
ID182DS0$R9752700<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9752700)
ID182DS0$R9752800<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9752800)
ID182DS0$R9752900<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9752900)
ID182DS0$R9753000<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9753000)
ID182DS0$R9753100<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9753100)
ID182DS0$R9753200<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9753200)
ID182DS0$R9753300<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9753300)
ID182DS0$R9753400<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9753400)
ID182DS0$R9753500<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9753500)
ID182DS0$R9753600<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9753600)
ID182DS0$R9753700<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9753700)
ID182DS0$R9753800<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9753800)
ID182DS0$R9753900<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9753900)
ID182DS0$R9754000<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9754000)
ID182DS0$R9754100<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9754100)
ID182DS0$R9754200<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9754200)
ID182DS0$R9754300<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9754300)
ID182DS0$R9754400<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9754400)
ID182DS0$R9754500<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9754500)
ID182DS0$R9754600<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9754600)
ID182DS0$R9754700<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9754700)
ID182DS0$R9754800<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9754800)
ID182DS0$R9754900<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9754900)
ID182DS0$R9755000<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9755000)
ID182DS0$R9755100<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9755100)
ID182DS0$R9755200<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9755200)
ID182DS0$R9755300<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9755300)
ID182DS0$R9755400<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9755400)
ID182DS0$R9755500<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9755500)
ID182DS0$R9755600<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9755600)
ID182DS0$R9755700<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9755700)
ID182DS0$R9755800<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9755800)
ID182DS0$R9755900<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9755900)
ID182DS0$R9756000<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9756000)
ID182DS0$R9756100<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9756100)
ID182DS0$R9756200<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9756200)
ID182DS0$R9756300<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9756300)
ID182DS0$R9756400<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9756400)
ID182DS0$R9756500<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9756500)
ID182DS0$R9756600<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9756600)
ID182DS0$R9756700<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9756700)
ID182DS0$R9756800<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9756800)
ID182DS0$R9756900<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9756900)
ID182DS0$R9757000<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9757000)
ID182DS0$R9757100<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9757100)
ID182DS0$R9757200<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9757200)
ID182DS0$R9757300<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9757300)
ID182DS0$R9757400<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9757400)
ID182DS0$R9757500<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9757500)
ID182DS0$R9757600<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9757600)
ID182DS0$R9757700<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9757700)
ID182DS0$R9757800<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9757800)
ID182DS0$R9757900<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9757900)
ID182DS0$R9758000<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9758000)
ID182DS0$R9758100<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9758100)
ID182DS0$R9758200<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9758200)
ID182DS0$R9758300<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9758300)
ID182DS0$R9758400<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9758400)
ID182DS0$R9758500<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9758500)
ID182DS0$R9758600<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9758600)
ID182DS0$R9758700<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9758700)
ID182DS0$R9758800<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9758800)
ID182DS0$R9758900<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9758900)
ID182DS0$R9759000<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9759000)
ID182DS0$R9759100<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9759100)
ID182DS0$R9759200<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9759200)
ID182DS0$R9759300<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9759300)
ID182DS0$R9759400<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9759400)
ID182DS0$R9759500<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9759500)
ID182DS0$R9759600<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9759600)
ID182DS0$R9759700<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9759700)
ID182DS0$R9759800<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9759800)
ID182DS0$R9759900<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9759900)
ID182DS0$R9760000<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9760000)
ID182DS0$R9760100<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9760100)
ID182DS0$R9760200<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9760200)
ID182DS0$R9760300<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9760300)
ID182DS0$R9760400<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9760400)
ID182DS0$R9760500<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9760500)
ID182DS0$R9760600<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9760600)
ID182DS0$R9760700<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9760700)
ID182DS0$R9760800<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9760800)
ID182DS0$R9760900<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9760900)
ID182DS0$R9761000<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9761000)
ID182DS0$R9761100<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9761100)
ID182DS0$R9761200<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9761200)
ID182DS0$R9761300<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9761300)
ID182DS0$R9761400<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9761400)
ID182DS0$R9761500<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9761500)
ID182DS0$R9761600<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9761600)
ID182DS0$R9761700<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9761700)
ID182DS0$R9761800<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9761800)
ID182DS0$R9761900<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9761900)
ID182DS0$R9762000<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9762000)
ID182DS0$R9762100<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9762100)
ID182DS0$R9762200<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9762200)
ID182DS0$R9762300<-hsgraderecode(ID182DS0$R9859600,ID182DS0$R9762300)
attach(ID182DS0)
ID182DS0$hsGPAaverage<-rowMeans(x=cbind(R9750000,R9750100,R9750200,R9750300,R9750400,R9750500,R9750600,R9750700,R9750800,R9750900,R9751000,
R9751100,R9751200,R9751300,R9751400,R9751500,R9751600,R9751700,R9751800,R9751900,R9752000,R9752100,
R9752200,R9752300,R9752400,R9752500,R9752600,R9752700,R9752800,R9752900,R9753000,R9753100,R9753200,
R9753300,R9753400,R9753500,R9753600,R9753700,R9753800,R9753900,R9754000,R9754100,R9754200,R9754300,
R9754400,R9754500,R9754600,R9754700,R9754800,R9754900,R9755000,R9755100,R9755200,R9755300,R9755400,
...
R9759900,R9760000,R9760100,R9760200,R9760300,R9760400,R9760500,R9760600,R9760700,R9760800,R9760900,
R9761000,R9761100,R9761200,R9761300,R9761400,R9761500,R9761600,R9761700,R9761800,R9761900,R9762000,
R9762100,R9762200,R9762300),na.rm = TRUE)
detach(ID182DS0)
ID182DS0$ACHV<-rowMeans(x=cbind(ID182DS0$hsGPAaverage,ID182DS0$colGPAaverage),na.rm = TRUE)

#Recode Academic Acehievement (prior wave)
ID182DS0$S0438700<-colGPArecode(ID182DS0$S0438700)
ID182DS0$S0438800<-colGPArecode(ID182DS0$S0438800)
ID182DS0$S0438900<-colGPArecode(ID182DS0$S0438900)
ID182DS0$S0439000<-colGPArecode(ID182DS0$S0439000)
ID182DS0$S0439100<-colGPArecode(ID182DS0$S0439100)
ID182DS0$ACHVPW<-rowMeans(x=cbind(ID182DS0$S0438700,ID182DS0$S0438800,ID182DS0$S0438900,
                                  ID182DS0$S0439000,ID182DS0$S0439100),na.rm = TRUE)

#Demographics ----
#Recode race/ethnicity
ID182DS0$LAT<-ifelse(ID182DS0$S1224800=="YES",1,0)
ID182DS0$BLK<-ifelse(ID182DS0$S1224901=="Black or African American",1,0)
ID182DS0$AI<-ifelse(ID182DS0$S1224904=="American Indian or Alaska Native",1,0)
ID182DS0$AA<-ifelse(((ID182DS0$S1224902=="Asian")|(ID182DS0$S1224903=="Native Hawaiian or other Pacific Islander")),1,0)
ID182DS0$OTH<-ifelse(ID182DS0$S1224905=="OTHER (SPECIFY)",1,0)
ID182DS0$WHT<-ifelse(ID182DS0$S1224900=="White",1,0)
...
ID182DS0$SEX<-ifelse(ID182DS0$R0536300=="Male",1,
              ifelse(ID182DS0$R0536300=="Female",0,NA))

#Recode age 
ID182DS0$AGECALC<-ID182DS0$S3801100

#Income, Education, Occupation ----
##Income
#Take highest income reported
ID182DS0$INC<-pmax(ID182DS0$S4799600,ID182DS0$S3812400,na.rm = TRUE)

##Education
ID182DS0$EDU<-ifelse(ID182DS0$S4032500=="1ST GRADE",1,         
              ifelse(ID182DS0$S4032500=="2ND GRADE",2,          
              ifelse(ID182DS0$S4032500=="3RD GRADE",3,         
              ifelse(ID182DS0$S4032500=="4TH GRADE",4,          
              ifelse(ID182DS0$S4032500=="5TH GRADE",5,         
              ifelse(ID182DS0$S4032500=="6TH GRADE",6,          
              ifelse(ID182DS0$S4032500=="7TH GRADE",7,         
              ifelse(ID182DS0$S4032500=="8TH GRADE",8,          
              ifelse(ID182DS0$S4032500=="9TH GRADE",9,         
              ifelse(ID182DS0$S4032500=="10TH GRADE",10,         
              ifelse(ID182DS0$S4032500=="11TH GRADE",11,        
              ifelse(ID182DS0$S4032500=="12TH GRADE",12,         
              ifelse(ID182DS0$S4032500=="1ST YEAR COLLEGE",13,        
              ifelse(ID182DS0$S4032500=="2ND YEAR COLLEGE",14,         
              ifelse(ID182DS0$S4032500=="3RD YEAR COLLEGE",15,        
              ifelse(ID182DS0$S4032500=="4TH YEAR COLLEGE",16,         
              ifelse(ID182DS0$S4032500=="5TH YEAR COLLEGE",17,        
              ifelse(ID182DS0$S4032500=="6TH YEAR COLLEGE",18,         
              ifelse(ID182DS0$S4032500=="7TH YEAR COLLEGE",19,        
              ifelse(ID182DS0$S4032500=="8TH YEAR COLLEGE OR MORE",20,NA))))))))))))))))))))
...
occ_codes<-read.csv('IPD182DS0_NLSY97_2004_Occupational codes.csv')
...
ID182DS0$S5041700<-factor(ID182DS0$S5041700)
ID182DS0$OCCS<-as.numeric(as.character(occstatusvalues[ match(ID182DS0$S5041700, occvalues) ]))
...
ID182DS0$S5041700<-factor(ID182DS0$S5041700)
ID182DS0$OCCP<-as.numeric(as.character(occprestvalues[ match(ID182DS0$S5041700, occvalues) ]))

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID182DS0, file = 'ID182NLSY97_2004_recoded.csv')
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADMC[2:6], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADMC[2:6], type = "omega", interval.type = "none")
...
#Select variables for correlation matrix
AIYDMCmatrixvars<-matrixvars[-c(12)]
...
write.csv(ID182DS0_aggregated, file = 'ID182NLSY97_2004_aggregated.csv',row.names = FALSE)
