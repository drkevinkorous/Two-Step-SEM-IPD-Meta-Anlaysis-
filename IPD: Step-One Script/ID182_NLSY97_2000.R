...
#Depressive symptom items: R4893600,R4893700(RC),R4893800,R4893900(RC),R4894000
#Depressive symptom items prior wave: NA
#Academic Achievement: 
#Self-report grade for participants in college
#R4281100,R4281200,R4281300,R4281400,R4281500,R4281600,R4281700,R4281800,R4281900,R4282000,R4282100
#R4282200,R4282300,R4282400,R4282500,R4282600
...
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: R5098900 
#Maternal Income: NA
#Paternal Income: NA
#Household Income: R5464100 
#Participant Education: R4173100 
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: S3713000 (2002 census codes) 
...
ID182DS0<-data.frame(R0000100,R4893600,R4893700,R4893800,R4893900,R4894000,R4281100,R4281200,R4281300,R4281400,R4281500,R4281600,
                     R4281700,R4281800,R4281900,R4282000,R4282100,R4282200,R4282300,R4282400,R4282500,R4282600,R9859600,
                     R9750000,R9750100,R9750200,R9750300,R9750400,R9750500,R9750600,R9750700,R9750800,R9750900,R9751000,
                     R9751100,R9751200,R9751300,R9751400,R9751500,R9751600,R9751700,R9751800,R9751900,R9752000,R9752100,
                     R9752200,R9752300,R9752400,R9752500,R9752600,R9752700,R9752800,R9752900,R9753000,R9753100,R9753200,
                     R9753300,R9753400,R9753500,R9753600,R9753700,R9753800,R9753900,R9754000,R9754100,R9754200,R9754300,
                     ...
                     R5453700,R0536402,R0536401,R5098900,R5464100,R4173100,S3713000)
detach(merged182)
...
ID182DS0$R4893600<-ifelse(ID182DS0$R4893600=="All of the time",3,                 
                   ifelse(ID182DS0$R4893600=="Most of the time",2, 
                   ifelse(ID182DS0$R4893600=="Some of the time",1,       
                   ifelse(ID182DS0$R4893600=="None of the time",0,NA))))
ID182DS0$R4893700<-ifelse(ID182DS0$R4893700=="All of the time",0,                 
                   ifelse(ID182DS0$R4893700=="Most of the time",1, 
                   ifelse(ID182DS0$R4893700=="Some of the time",2,       
                   ifelse(ID182DS0$R4893700=="None of the time",3,NA))))#RC
ID182DS0$R4893800<-ifelse(ID182DS0$R4893800=="All of the time",3,                 
                   ifelse(ID182DS0$R4893800=="Most of the time",2, 
                   ifelse(ID182DS0$R4893800=="Some of the time",1,       
                   ifelse(ID182DS0$R4893800=="None of the time",0,NA))))
ID182DS0$R4893900<-ifelse(ID182DS0$R4893900=="All of the time",0,                 
                   ifelse(ID182DS0$R4893900=="Most of the time",1, 
                   ifelse(ID182DS0$R4893900=="Some of the time",2,       
                   ifelse(ID182DS0$R4893900=="None of the time",3,NA))))#RC
ID182DS0$R4894000<-ifelse(ID182DS0$R4894000=="All of the time",3,                 
                   ifelse(ID182DS0$R4894000=="Most of the time",2, 
                   ifelse(ID182DS0$R4894000=="Some of the time",1,       
                   ifelse(ID182DS0$R4894000=="None of the time",0,NA))))
...
ID182DS0$R4281100<-colGPArecode(ID182DS0$R4281100)
ID182DS0$R4281200<-colGPArecode(ID182DS0$R4281200)
ID182DS0$R4281300<-colGPArecode(ID182DS0$R4281300)
ID182DS0$R4281400<-colGPArecode(ID182DS0$R4281400)
ID182DS0$R4281500<-colGPArecode(ID182DS0$R4281500)
ID182DS0$R4281600<-colGPArecode(ID182DS0$R4281600)
ID182DS0$R4281700<-colGPArecode(ID182DS0$R4281700)
ID182DS0$R4281800<-colGPArecode(ID182DS0$R4281800)
ID182DS0$R4281900<-colGPArecode(ID182DS0$R4281900)
ID182DS0$R4282000<-colGPArecode(ID182DS0$R4282000)
ID182DS0$R4282100<-colGPArecode(ID182DS0$R4282100)
ID182DS0$R4282200<-colGPArecode(ID182DS0$R4282200)
ID182DS0$R4282300<-colGPArecode(ID182DS0$R4282300)
ID182DS0$R4282400<-colGPArecode(ID182DS0$R4282400)
ID182DS0$R4282500<-colGPArecode(ID182DS0$R4282500)
ID182DS0$R4282600<-colGPArecode(ID182DS0$R4282600)
ID182DS0$colGPAaverage<-rowMeans(x=cbind(ID182DS0$R4281100,ID182DS0$R4281200,ID182DS0$R4281300,ID182DS0$R4281400,
                        ID182DS0$R4281500,ID182DS0$R4281600,ID182DS0$R4281700,ID182DS0$R4281800,
                        ID182DS0$R4281900,ID182DS0$R4282000,ID182DS0$R4282100,ID182DS0$R4282200,
                        ID182DS0$R4282300,ID182DS0$R4282400,ID182DS0$R4282500,ID182DS0$R4282600),na.rm=TRUE)
#high school transcript grades 
hsgraderecode<-function(transtatus,hsgrade){ifelse(transtatus=="Wave 1 complete",dplyr::recode(hsgrade,"1: A+"=4.0,"2: A"=4.0,"3: A-"=3.7,"4: B+"=3.3,"5: B"=3.0,"6: B-"=2.7,
...
#Recode age 
ID182DS0$AGECALC<-ID182DS0$R5453700

#Income, Education, Occupation ----
##Income
#Take highest income reported
ID182DS0$INC<-pmax(ID182DS0$R5098900,ID182DS0$R5464100,na.rm = TRUE)

##Education
ID182DS0$EDU<-ifelse(ID182DS0$R4173100=="1ST GRADE",1,         
              ifelse(ID182DS0$R4173100=="2ND GRADE",2,          
              ifelse(ID182DS0$R4173100=="3RD GRADE",3,         
              ifelse(ID182DS0$R4173100=="4TH GRADE",4,          
              ifelse(ID182DS0$R4173100=="5TH GRADE",5,         
              ifelse(ID182DS0$R4173100=="6TH GRADE",6,          
              ifelse(ID182DS0$R4173100=="7TH GRADE",7,         
              ifelse(ID182DS0$R4173100=="8TH GRADE",8,          
              ifelse(ID182DS0$R4173100=="9TH GRADE",9,         
              ifelse(ID182DS0$R4173100=="10TH GRADE",10,         
              ifelse(ID182DS0$R4173100=="11TH GRADE",11,        
              ifelse(ID182DS0$R4173100=="12TH GRADE",12,         
              ifelse(ID182DS0$R4173100=="1ST YEAR COLLEGE",13,        
              ifelse(ID182DS0$R4173100=="2ND YEAR COLLEGE",14,         
              ifelse(ID182DS0$R4173100=="3RD YEAR COLLEGE",15,        
              ifelse(ID182DS0$R4173100=="4TH YEAR COLLEGE",16,         
              ifelse(ID182DS0$R4173100=="5TH YEAR COLLEGE",17,        
              ifelse(ID182DS0$R4173100=="6TH YEAR COLLEGE",18,         
              ifelse(ID182DS0$R4173100=="7TH YEAR COLLEGE",19,        
              ifelse(ID182DS0$R4173100=="8TH YEAR COLLEGE OR MORE",20,NA))))))))))))))))))))
...
occ_codes<-read.csv('IPD182DS0_NLSY97_2000_Occupational codes.csv')
...
ID182DS0$S3713000<-factor(ID182DS0$S3713000)
ID182DS0$OCCS<-as.numeric(as.character(occstatusvalues[ match(ID182DS0$S3713000, occvalues) ]))
...
ID182DS0$S3713000<-factor(ID182DS0$S3713000)
ID182DS0$OCCP<-as.numeric(as.character(occprestvalues[ match(ID182DS0$S3713000, occvalues) ]))

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID182DS0, file = 'ID182NLSY97_2000_recoded.csv')
...
#Select variables for correlation matrix
LATADMCmatrixvars<-matrixvars[-10]
...
#Select variables for correlation matrix
BLKADMCmatrixvars<-matrixvars[-10]
...
#Select variables for correlation matrix
AAADFCmatrixvars<-matrixvars[-10]
AAADFC <- AAADF[AAADFCmatrixvars]
...
#Select variables for correlation matrix
AAADMCmatrixvars<-matrixvars[-10]
AAADMC <- AAADM[AAADMCmatrixvars]
...
#Select variables for correlation matrix
AIADFCmatrixvars<-matrixvars[-10]
...
#Select variables for correlation matrix
AIYDFCmatrixvars<-matrixvars[-10]
...
#Select variables for correlation matrix
AIYDMCmatrixvars<-matrixvars[-10]
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AIYDM[2:6], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AIYDM[2:6], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Select variables for correlation matrix
MRADFCmatrixvars<-matrixvars[-10]
...
#Select variables for correlation matrix
MRADMCmatrixvars<-matrixvars[-10]
...
write.csv(ID182DS0_aggregated, file = 'ID182NLSY97_2000_aggregated.csv',row.names = FALSE)
