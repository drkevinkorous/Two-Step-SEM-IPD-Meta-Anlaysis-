library('foreign')
data<-read.spss('20240-0001-Data.sav')
#Coded variables
#Participant ID: CPESCASE
#Measure Name (not a variable in the dataset): CESD 
#Depressive symptom items: #V04527(RC),V04528,V04530,V04532,V04535(RC),V04536,V04539(RC),V04541,V04542(RC),V04545,V04547,V04548
...
#Maternal Income: NA
#Paternal Income: NA
#Household Income: V08683
#Participant Education: V09381
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: V05203
...
#Notes: CPES (includes NSAL,NCSR,NLAAS)

#Create Dataset ----
attach(data)
#Extract relevant variables into a dataframe.
ID20240DS1<-data.frame(V04527,V04528,V04530,V04532,V04535,V04536,V04539,V04541,V04542,
                     V04545,V04547,V04548,RANCEST,V09036,V07306,V08683,V09381,V05203) 

detach(data)
ID20240DS1$ORIGOBS<-nrow(ID20240DS1)
rm(data)
...
ID20240DS1$V04527<-ifelse(ID20240DS1$V04527=="RARELY OR NEVER",3,
                   ifelse(ID20240DS1$V04527=="SOME OF THE TIME",2,
                   ifelse(ID20240DS1$V04527=="OCCASIONALLY",1,
                   ifelse(ID20240DS1$V04527=="MOST OR ALL OF THE TIME",0,NA))))#RC
ID20240DS1$V04528<-ifelse(ID20240DS1$V04528=="RARELY OR NEVER",0,
                   ifelse(ID20240DS1$V04528=="SOME OF THE TIME",1,
                   ifelse(ID20240DS1$V04528=="OCCASIONALLY",2,
                   ifelse(ID20240DS1$V04528=="MOST OR ALL OF THE TIME",3,NA))))
ID20240DS1$V04530<-ifelse(ID20240DS1$V04530=="RARELY OR NEVER",0,
                   ifelse(ID20240DS1$V04530=="SOME OF THE TIME",1,
                   ifelse(ID20240DS1$V04530=="OCCASIONALLY",2,
                   ifelse(ID20240DS1$V04530=="MOST OR ALL OF THE TIME",3,NA))))
ID20240DS1$V04532<-ifelse(ID20240DS1$V04532=="RARELY OR NEVER",0,
                   ifelse(ID20240DS1$V04532=="SOME OF THE TIME",1,
                   ifelse(ID20240DS1$V04532=="OCCASIONALLY",2,
                   ifelse(ID20240DS1$V04532=="MOST OR ALL OF THE TIME",3,NA))))
ID20240DS1$V04535<-ifelse(ID20240DS1$V04535=="RARELY OR NEVER",3,
                   ifelse(ID20240DS1$V04535=="SOME OF THE TIME",2,
                   ifelse(ID20240DS1$V04535=="OCCASIONALLY",1,
                   ifelse(ID20240DS1$V04535=="MOST OR ALL OF THE TIME",0,NA))))#RC
ID20240DS1$V04536<-ifelse(ID20240DS1$V04536=="RARELY OR NEVER",0,
                   ifelse(ID20240DS1$V04536=="SOME OF THE TIME",1,
                   ifelse(ID20240DS1$V04536=="OCCASIONALLY",2,
                   ifelse(ID20240DS1$V04536=="MOST OR ALL OF THE TIME",3,NA))))
ID20240DS1$V04539<-ifelse(ID20240DS1$V04539=="RARELY OR NEVER",3,
                   ifelse(ID20240DS1$V04539=="SOME OF THE TIME",2,
                   ifelse(ID20240DS1$V04539=="OCCASIONALLY",1,
                   ifelse(ID20240DS1$V04539=="MOST OR ALL OF THE TIME",0,NA))))#RC
ID20240DS1$V04541<-ifelse(ID20240DS1$V04541=="RARELY OR NEVER",0,
                   ifelse(ID20240DS1$V04541=="SOME OF THE TIME",1,
                   ifelse(ID20240DS1$V04541=="OCCASIONALLY",2,
                   ifelse(ID20240DS1$V04541=="MOST OR ALL OF THE TIME",3,NA))))
ID20240DS1$V04542<-ifelse(ID20240DS1$V04542=="RARELY OR NEVER",3,
                   ifelse(ID20240DS1$V04542=="SOME OF THE TIME",2,
                   ifelse(ID20240DS1$V04542=="OCCASIONALLY",1,
                   ifelse(ID20240DS1$V04542=="MOST OR ALL OF THE TIME",0,NA))))#RC
ID20240DS1$V04545<-ifelse(ID20240DS1$V04545=="RARELY OR NEVER",0,
                   ifelse(ID20240DS1$V04545=="SOME OF THE TIME",1,
                   ifelse(ID20240DS1$V04545=="OCCASIONALLY",2,
                   ifelse(ID20240DS1$V04545=="MOST OR ALL OF THE TIME",3,NA))))
ID20240DS1$V04547<-ifelse(ID20240DS1$V04547=="RARELY OR NEVER",0,
                   ifelse(ID20240DS1$V04547=="SOME OF THE TIME",1,
                   ifelse(ID20240DS1$V04547=="OCCASIONALLY",2,
                   ifelse(ID20240DS1$V04547=="MOST OR ALL OF THE TIME",3,NA))))
ID20240DS1$V04548<-ifelse(ID20240DS1$V04548=="RARELY OR NEVER",0,
                   ifelse(ID20240DS1$V04548=="SOME OF THE TIME",1,
                   ifelse(ID20240DS1$V04548=="OCCASIONALLY",2,
                   ifelse(ID20240DS1$V04548=="MOST OR ALL OF THE TIME",3,NA))))
...
dsitems <- ID20240DS1[c(1:12)]
#dsitemspw <- ID20240DS1[c()]
#Identify participants missing more than half of dsitems (not dsitemsW1) (1=missing > 50%) - to be used later
ID20240DS1$dsmiss<-ifelse(rowSums(is.na(dsitems))>((ncol(dsitems)/2)),1,0)
#Compute mean symptom score 
ID20240DS1$DEP<-rowMeans(x=dsitems,na.rm=TRUE)
ID20240DS1$DEPPW<-NA#rowMeans(x=dsitemspw,na.rm=TRUE)
...
ID20240DS1$ACHVPW<-NA

#Demographics ----
#Recode race/ethnicity
ID20240DS1$LAT<-ifelse(((ID20240DS1$RANCEST=="MEXICAN")|(ID20240DS1$RANCEST=="PUERTO RICAN")|
                        (ID20240DS1$RANCEST=="CUBAN")|(ID20240DS1$RANCEST=="ALL OTHER HISPANIC")), 1, 0)
ID20240DS1$WHT<-ifelse(ID20240DS1$RANCEST=="NON-LATINO WHITES",1, 0)
ID20240DS1$BLK<-ifelse(((ID20240DS1$RANCEST=="AFRO-CARIBBEAN")|(ID20240DS1$RANCEST=="AFRICAN AMERICAN")),1, 0)
ID20240DS1$AA<-ifelse(((ID20240DS1$RANCEST=="VIETNAMESE")|(ID20240DS1$RANCEST=="FILIPINO")|
                       (ID20240DS1$RANCEST=="CHINESE")|(ID20240DS1$RANCEST=="ALL OTHER ASIAN")),1, 0)
ID20240DS1$OTH<-ifelse(ID20240DS1$RANCEST=="ALL OTHER",1, 0)

#Recode factor into numeric (sex),
ID20240DS1$SEX<-ifelse(ID20240DS1$V09036=="MALE",1,0)

#Recode age from months to years
levels(ID20240DS1$V07306)[levels(ID20240DS1$V07306)=="BOTTOM CODED AT 18"]<-"18"
ID20240DS1$AGECALC<-as.numeric(as.character(ID20240DS1$V07306))

#Income, Education, Occupation ----
##Income
levels(ID20240DS1$V08683)[levels(ID20240DS1$V08683)=="TOP CODED AT $200,000"]<-"200000"
ID20240DS1$INC<- as.numeric(as.character(ID20240DS1$V08683))

##Education
ID20240DS1$EDU<-ifelse(ID20240DS1$V09381=="4 OR LESS",4,
                ifelse(ID20240DS1$V09381=="FIVE",5,
                ifelse(ID20240DS1$V09381=="SIX",6,
                ifelse(ID20240DS1$V09381=="SEVEN",7,
                ifelse(ID20240DS1$V09381=="EIGHT",8,
                ifelse(ID20240DS1$V09381=="NINE",9,
                ifelse(ID20240DS1$V09381=="TEN",10,
                ifelse(ID20240DS1$V09381=="ELEVEN",11,
                ifelse(ID20240DS1$V09381=="TWELVE",12,
                ifelse(ID20240DS1$V09381=="THIRTEEN",13,
                ifelse(ID20240DS1$V09381=="FOURTEEN",14,
                ifelse(ID20240DS1$V09381=="FIFTEEN",15,
                ifelse(ID20240DS1$V09381=="SIXTEEN",16,
                ifelse(ID20240DS1$V09381=="17 OR MORE",17,NA))))))))))))))

##Occupation
#Recode factor into numeric (occupational status)
#Nam-Powers-Boyd scale (Nam & Boyd, 2008)
#Categories are too general see table(ID20240DS1$V05203)
ID20240DS1$OCCS<-NA
...
write.csv(ID20240DS1, file = 'ID20240DS1_recoded.csv')

#Descriptives and Correlations -----
#Exclude participants with more than 50% missing on depressive symtpoms items
ID20240DS1 <- ID20240DS1[which(ID20240DS1$dsmiss==0), ]

##Compute mean and sd across all participants within dataset
library('psych')
#Means & SDs of focal variables
dstatsage<-describe(ID20240DS1$AGECALC)
dstatsdep<-describe(ID20240DS1$DEP)
dstatsachv<-NA#describe(ID20240DS1$ACHV)
dstatsinc<-describe(ID20240DS1$INC)
dstatsedu<-NA#describe(ID20240DS1$EDU)
dstatsoccs<-NA#describe(ID20240DS1$OCCS)
dstatsoccp<-NA#describe(ID20240DS1$OCCP)

#Save descriptive stats
dstats<-rbind(dstatsage,dstatsdep,dstatsachv,dstatsinc,dstatsedu,dstatsoccs,dstatsoccp,make.row.names= FALSE)
write.csv(dstats,file = 'ID20240DS1_dstats.csv',
          row.names=c("dstatsage","dstatsdep","dstatsachv","dstatsinc","dstatsedu","dstatsoccs","dstatsoccp"))

##Histograms 
pdf('ID20240DS1_dephist.pdf')
hist(ID20240DS1$DEP, xlab="Depressive Symptoms", main = NULL, col="grey")
dev.off()
#pdf('ID20240DS1_achvhist.pdf')
#hist(ID20240DS1$ACHV, xlab="Academic Achievement", main = NULL, col="grey")
#dev.off()
pdf('ID20240DS1_inchist.pdf')
hist(ID20240DS1$INC, xlab="Income", main = NULL, col="grey")
dev.off()
#pdf('ID20240DS1_educhist.pdf')
#hist(ID20240DS1$EDU, xlab="Educational Attainment", main = NULL, col="grey")
#dev.off()
#pdf('ID20240DS1_occshist.pdf')
#hist(ID20240DS1$OCCS, xlab="Occupational Status", main = NULL, col="grey")
#dev.off()
#pdf('ID20240DS1_occphist.pdf')
#hist(ID20240DS1$OCCP, xlab="Occupational Prestige", main = NULL, col="grey")
#dev.off()
...
table(ID20240DS1$AGECALC)
#Separate dataset by developmental period, if needed
#CH<-ID20240DS1[which((ID20240DS1$AGECALC >= 5)&(ID20240DS1$AGECALC <= 11)), ]
#AD<-ID20240DS1[which((ID20240DS1$AGECALC >= 12)&(ID20240DS1$AGECALC <= 17)), ]
YD<-ID20240DS1[which((ID20240DS1$AGECALC >= 18)&(ID20240DS1$AGECALC <= 25)), ]
AT<-ID20240DS1[which((ID20240DS1$AGECALC >= 26)&(ID20240DS1$AGECALC <= 64)), ] 
OA<-ID20240DS1[which(ID20240DS1$AGECALC >= 65), ]
...
##Assign ICPSR ID number (ICPSR Number; e.g., file name = ID20240DS1, then DATAID = 21600)
#DATAID<-'20240'
#names(DATAID)<-'DATAID'
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=LATOAF[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=LATOAF[1:12], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=LATOAM[1:12], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=LATOAM[1:12], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAADMC[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAADMC[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AAYDF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AAYDF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIADF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIADF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIATF[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIATF[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
##Compute reliability estimates
##Only need to change depressive symptoms items 
#ALPHAOV <- ci.reliability(data=AIATM[1:12], type = "alpha", interval.type = "none")
#OMEGAOV <- ci.reliability(data=AIATM[1:12], type = "omega", interval.type = "none")
#ALPHA <- ALPHAOV$est
#OMEGA <- OMEGAOV$est
##Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
ID20240DS1_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID20240DS1_aggregated, file = 'ID20240DS1_aggregated.csv',row.names = FALSE)
