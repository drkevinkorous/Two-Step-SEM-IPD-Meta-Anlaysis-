...
#Birth Month: NA
#Birth Day: NA
#Evaluation Year: INTYEAR
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: EARN1  
#Maternal Income: NA
#Paternal Income: NA
#Household Income: FAMINC1
#Participant Education: ED
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: OCC1 
...
#Notes: Aging, Status, and Sense of Control (ASOC) - Wave 1

#Create Dataset ----
attach(data)
#Extract relevant variables into a dataframe.
ID3334DS1<-data.frame(ID,SLEEP,EFFORT,GETGO,MIND,SAD,LONELY,BLUES,ENJOY,HOPEFUL,HAPPY,
                      HISPANIC,RACE,SEX,YEARBORN,INTYEAR,EARN1,FAMINC1,ED,OCC1) 
detach(data)
...
ID3334DS1$DEPPW<-NA#rowMeans(x=dsitemspw,na.rm=TRUE)
...
ID3334DS1$LAT<-ifelse(ID3334DS1$HISPANIC == "Yes", 1, 0)
ID3334DS1$WHT<-ifelse(ID3334DS1$RACE == "White,", 1, 0)
ID3334DS1$BLK<-ifelse(ID3334DS1$RACE == "Black or African American,", 1, 0)
ID3334DS1$AI<-ifelse(ID3334DS1$RACE == "Asian or Pacific Islander,", 1, 0)
ID3334DS1$AA<-ifelse(ID3334DS1$RACE == "Native American or Alaskan native, or", 1, 0)
ID3334DS1$OTH<-ifelse(ID3334DS1$RACE == "Something else?", 1, 0)
...
#Recode sex
ID3334DS1$SEX<-ifelse(ID3334DS1$SEX == 1, 1, 
               ifelse(ID3334DS1$SEX == 2, 0, NA))

#Recode age 
levels(ID3334DS1$YEARBORN)[levels(ID3334DS1$YEARBORN)=="_duplicated_1977"]<-"1977"
ID3334DS1$YEARBORN<-as.numeric(as.character(ID3334DS1$YEARBORN))
ID3334DS1$INTYEAR <-ID3334DS1$INTYEAR + 1900
ID3334DS1$AGECALC<-ID3334DS1$INTYEAR-ID3334DS1$YEARBORN

#Income, Education, Occupation ----
##Income 
levels(ID3334DS1$EARN1)[levels(ID3334DS1$EARN1)=="Dollars"]<-"0"
levels(ID3334DS1$EARN1)[levels(ID3334DS1$EARN1)=="1e+05"]<-"100000"
levels(ID3334DS1$EARN1)[levels(ID3334DS1$EARN1)=="2e+05"]<-"200000"
levels(ID3334DS1$EARN1)[levels(ID3334DS1$EARN1)=="3e+05"]<-"300000"
levels(ID3334DS1$EARN1)[levels(ID3334DS1$EARN1)=="4e+05"]<-"400000"
levels(ID3334DS1$EARN1)[levels(ID3334DS1$EARN1)=="Dollars_duplicated_5e+05" ]<-"500000"
levels(ID3334DS1$EARN1)[levels(ID3334DS1$EARN1)=="$500,001 or more"]<-"500001"
ID3334DS1$EARN1<-as.numeric(as.character(ID3334DS1$EARN1))

levels(ID3334DS1$FAMINC1)[levels(ID3334DS1$FAMINC1)=="Dollars"]<-"0"
levels(ID3334DS1$FAMINC1)[levels(ID3334DS1$FAMINC1)=="1e+05"]<-"100000"
levels(ID3334DS1$FAMINC1)[levels(ID3334DS1$FAMINC1)=="2e+05"]<-"200000"
levels(ID3334DS1$FAMINC1)[levels(ID3334DS1$FAMINC1)=="3e+05"]<-"300000"
levels(ID3334DS1$FAMINC1)[levels(ID3334DS1$FAMINC1)=="4e+05"]<-"400000"
levels(ID3334DS1$FAMINC1)[levels(ID3334DS1$FAMINC1)=="5e+05"]<-"500000"
levels(ID3334DS1$FAMINC1)[levels(ID3334DS1$FAMINC1)=="6e+05"]<-"600000"
levels(ID3334DS1$FAMINC1)[levels(ID3334DS1$FAMINC1)=="7e+05"]<-"700000"
levels(ID3334DS1$FAMINC1)[levels(ID3334DS1$FAMINC1)=="Dollars_duplicated_8e+05" ]<-"800000"
levels(ID3334DS1$FAMINC1)[levels(ID3334DS1$FAMINC1)=="$800,001 or more"]<-"800001"
ID3334DS1$FAMINC1<-as.numeric(as.character(ID3334DS1$FAMINC1))

ID3334DS1$INC<-pmax(ID3334DS1$FAMINC1,ID3334DS1$EARN1,na.rm = TRUE)

##Education
ID3334DS1$EDU<-ifelse(ID3334DS1$ED=="None", 0,              
               ifelse(ID3334DS1$ED=="Elementary", 1,                 
               ifelse(ID3334DS1$ED=="2", 2,                 
               ifelse(ID3334DS1$ED=="3", 3,                 
               ifelse(ID3334DS1$ED=="4", 4,               
               ifelse(ID3334DS1$ED=="5", 5,                 
               ifelse(ID3334DS1$ED=="6", 6,                  
               ifelse(ID3334DS1$ED=="7", 7,
               ifelse(ID3334DS1$ED=="Elementary_duplicated_8", 8,              
               ifelse(ID3334DS1$ED=="Some High school", 9,                 
               ifelse(ID3334DS1$ED=="10", 10,                 
               ifelse(ID3334DS1$ED=="Some High school_duplicated_11", 11,                 
               ifelse(ID3334DS1$ED=="High school graduate or GED", 12,               
               ifelse(ID3334DS1$ED=="Some college", 13,                 
               ifelse(ID3334DS1$ED=="14", 14,                  
               ifelse(ID3334DS1$ED=="Some college_duplicated_15", 15,
               ifelse(ID3334DS1$ED=="College degree (BS or BA)", 16,                 
               ifelse(ID3334DS1$ED=="Some graduate school", 17,                 
               ifelse(ID3334DS1$ED=="Masters level degree (MA, MS, MBA, MSW)", 18,               
               ifelse(ID3334DS1$ED=="Doctoral degree (PhD)", 20,                 
               ifelse(ID3334DS1$ED=="Professional degree (MD, JD-Law, DDS, EdD)", 20, NA)))))))))))))))))))))


##Occupation
#Nam-Powers-Boyd scale (Nam & Boyd, 2008)
occ_codes<-read.csv(file = 'ID3334DS1_1995_Occupational codes.csv')
#match codes with each row in data
ID3334DS1$OCCS<-occ_codes$OCC_STATUS[ match(ID3334DS1$OCC1,occ_codes$OCC_CODE)]

#Recode factor into numeric (occupational prestige)
#Nakao & Tres scale (1994)
ID3334DS1$OCCP<-occ_codes$OCC_PREST[ match(ID3334DS1$OCC1,occ_codes$OCC_CODE)]

#Save Recoded Dataset ------
#Save database as .csv for OSF 
write.csv(ID3334DS1, file = 'ID3334DS1_1995_recoded.csv')
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=LATOAM[2:11], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=LATOAM[2:11], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=BLKYDM[2:11], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=BLKYDM[2:11], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- ci.reliability(data=BLKOAM[2:11], type = "alpha", interval.type = "none")
OMEGAOV <- ci.reliability(data=BLKOAM[2:11], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
#Compute reliability estimates
#Only need to change depressive symptoms items 
ALPHAOV <- NA#ci.reliability(data=AAATF[2:11], type = "alpha", interval.type = "none")
OMEGAOV <- NA#ci.reliability(data=AAATF[2:11], type = "omega", interval.type = "none")
ALPHA <- NA#ALPHAOV$est
OMEGA <- NA#OMEGAOV$est
#Combine columns of aggregated data and computed codes for meta-analysis (do not include individual scores here)
...
ID3334DS1_1995_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID3334DS1_1995_aggregated, file = 'ID3334DS1_1995_aggregated.csv',row.names = FALSE)
