...
#Depressive symptom items: H0000300,H0000400,H0000500,H0000600,H0000700,H0000800,H0000900,H0001000,H0001100
...
#Evaluation Month: NA
#Evaluation Day: NA
#Participant Income: T0912400 
#Maternal Income: NA
#Paternal Income: NA
#Household Income: T0987800 
#Participant Education: T0014400
...
#Household Occupation: T0138400 (2000 census codes)
#SES: NA
...
ID182DS0<-data.frame(R0000100,H0000300,H0000400,H0000500,H0000600,H0000700,H0000800,H0000900,H0001000,H0001100,
                     R0009600,R0010200,R0214800,T0989000,T0912400,T0987800,T0014400,T0138400) 
detach(merged182)
...
ID182DS0$H0000300<-ifelse(ID182DS0$H0000300=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0000300=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0000300=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0000300=="Most/All of the time/5-7 Days",3,NA))))
ID182DS0$H0000400<-ifelse(ID182DS0$H0000400=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0000400=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0000400=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0000400=="Most/All of the time/5-7 Days",3,NA))))  
ID182DS0$H0000500<-ifelse(ID182DS0$H0000500=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0000500=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0000500=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0000500=="Most/All of the time/5-7 Days",3,NA))))  
ID182DS0$H0000600<-ifelse(ID182DS0$H0000600=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0000600=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0000600=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0000600=="Most/All of the time/5-7 Days",3,NA))))  
ID182DS0$H0000700<-ifelse(ID182DS0$H0000700=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0000700=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0000700=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0000700=="Most/All of the time/5-7 Days",3,NA))))  
ID182DS0$H0000800<-ifelse(ID182DS0$H0000800=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0000800=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0000800=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0000800=="Most/All of the time/5-7 Days",3,NA))))  
ID182DS0$H0000900<-ifelse(ID182DS0$H0000900=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0000900=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0000900=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0000900=="Most/All of the time/5-7 Days",3,NA))))
ID182DS0$H0001000<-ifelse(ID182DS0$H0001000=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0001000=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0001000=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0001000=="Most/All of the time/5-7 Days",3,NA))))
ID182DS0$H0001100<-ifelse(ID182DS0$H0001100=="Rarely/None of the time/1 Day",0,                 
                   ifelse(ID182DS0$H0001100=="Some/A little of the time/1-2 Days",1,            
                   ifelse(ID182DS0$H0001100=="Occasionally/Moderate amount of the time/3-4 Days",2,
                   ifelse(ID182DS0$H0001100=="Most/All of the time/5-7 Days",3,NA))))
...
#Recode age 
ID182DS0$AGECALC<-as.numeric(as.character(ID182DS0$T0989000))
...
write.csv(ID182DS0, file = 'ID182DS0_2006_recoded.csv')
...
#Select variables for correlation matrix
AIATMCmatrixvars<-matrixvars[-c(3:4)]
...
write.csv(ID182DS0_aggregated, file = 'ID182DS0_2006_aggregated.csv',row.names = FALSE)
