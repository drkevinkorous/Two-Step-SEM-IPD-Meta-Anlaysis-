#load dataset
library('foreign')
#H16B_R.SAV (demographics) is partial data (a lot missing), merge with prior wave 
#merge with recoded data from 2014 (includes prior wave dep symptoms, race/ethnicity, and education)
demographics<-read.spss('H16B_R.SAV') 
demographicspw<-read.csv(file = 'ID6854DS0_2014_recoded.csv')
demographicspw<-demographicspw[,c(2:10,19,21:23,36)]
demographics$HHIDPN<-paste(demographics$HHID,demographics$PN,sep = "")
demographics<-merge(demographics,demographicspw,by="HHIDPN",all.x = TRUE)
depression<-read.spss('H16D_R.SAV')
income<-read.spss('H16Q_H.sav')
employment<-read.spss('H16J_R.SAV')
other<-read.spss('H16A_R.SAV')
preload<-read.spss('H16PR_R.SAV')
#Merge datasets by Case ID (V1)
ID68542016<-merge(depression,income,by="HHID",all=TRUE)
ID68542016$HHIDPN<-paste(ID68542016$HHID,ID68542016$PN,sep = "")
ID68542016<-merge(ID68542016,demographics,by="HHIDPN",all=TRUE)
employment$HHIDPN<-paste(employment$HHID,employment$PN,sep = "")
ID68542016<-merge(ID68542016,employment,by="HHIDPN",all=TRUE)
other$HHIDPN<-paste(other$HHID,other$PN,sep = "")
ID68542016<-merge(ID68542016,other,by="HHIDPN",all=TRUE)
preload$HHIDPN<-paste(preload$HHID,preload$PN,sep = "")
ID68542016<-merge(ID68542016,preload,by="HHIDPN",all=TRUE)
#Coded variables
#Participant ID: HHID (household ID); PN (rep ID)
#Measure Name (not a variable in the dataset): CESD
#Depressive symptom items: 
#PD110,PD111,PD112,PD113(RC),PD114,PD115(RC),PD116,PD117
#Depressive symptom items prior wave:
#OD110,OD111,OD112,OD113(RC),OD114,OD115(RC),OD116,OD117
#Academic Achievement: NA
#Academic Achievement prior wave: NA
#Ethnicity: PB028 prior wave: OB028
#Race: PB089M1M,PB089M2M,PB089M3M prior wave: OB089M1M,OB089M2M,OB089M3M 
#White: NA
#Black: NA 
...
#Birth Month: PX004_R
#Birth Day: NA
#Evaluation Year: PA501
#Evaluation Month: PA500
#Evaluation Day: NA
#Participant Income: PQ020  
#Maternal Income: NA
#Paternal Income: NA
#Household Income: PQ020+PQ045(partner)
#Participant Education: PB014 prior wave: EDU
#Maternal Education: NA
#Paternal Education: NA
#Household Education: NA
#Participant Occupation: PJ168M 
...
ID6854DS0<-data.frame(HHIDPN,PD110,PD111,PD112,PD113,PD114,PD115,PD116,PD117,
                      OD110,OD111,OD112,OD113,OD114,OD115,OD116,OD117,PB028,OB028,
                      PB089M1M,PB089M2M,PB089M3M,OB089M1M,OB089M2M,OB089M3M,PX060_R,
                      PA019,PX067_R,PX004_R,PA501,PA500,PQ020,PQ045,PB014,EDU,PJ168M)
detach(ID68542016)
ID6854DS0$ORIGOBS<-nrow(ID6854DS0)
rm(ID68542016,demographics,demographicspw,depression,employment,income,other,preload)
...
#9=RF (refused)
ID6854DS0$PD110<-ifelse(ID6854DS0$PD110==1,1,
                ifelse(ID6854DS0$PD110==5,0,NA))
ID6854DS0$PD111<-ifelse(ID6854DS0$PD111==1,1,
                ifelse(ID6854DS0$PD111==5,0,NA))                 
ID6854DS0$PD112<-ifelse(ID6854DS0$PD112==1,1,
                ifelse(ID6854DS0$PD112==5,0,NA))
ID6854DS0$PD113<-ifelse(ID6854DS0$PD113==1,0,
                ifelse(ID6854DS0$PD113==5,1,NA))#RC
ID6854DS0$PD114<-ifelse(ID6854DS0$PD114==1,1,
                ifelse(ID6854DS0$PD114==5,0,NA))
ID6854DS0$PD115<-ifelse(ID6854DS0$PD115==1,0,
                ifelse(ID6854DS0$PD115==5,1,NA))#RC
ID6854DS0$PD116<-ifelse(ID6854DS0$PD116==1,1,
                ifelse(ID6854DS0$PD116==5,0,NA))
ID6854DS0$PD117<-ifelse(ID6854DS0$PD117==1,1,
                 ifelse(ID6854DS0$PD117==5,0,NA))
...
#8=DK (don't know); NA (not ascertained)
#9=RF (refused)
#already recoded from prior wave
...
#1=YES
#5=NO
ID6854DS0$PB028<-ifelse(is.na(ID6854DS0$PB028),ID6854DS0$OB028,ID6854DS0$PB028)
ID6854DS0$LAT<-ifelse(ID6854DS0$PB028==1,1,0)
#1=WHITE/CAUCASIAN
#2=BLACK/AFRICAN AM
#97=OTHER (SPECIFY);
#98=DK (don't know);
#99=RF (refused)
ID6854DS0$PB089M1M<-ifelse(is.na(ID6854DS0$PB089M1M),ID6854DS0$OB089M1M,ID6854DS0$PB089M1M)
ID6854DS0$PB089M2M<-ifelse(is.na(ID6854DS0$PB089M2M),ID6854DS0$OB089M2M,ID6854DS0$PB089M2M)
ID6854DS0$PB089M3M<-ifelse(is.na(ID6854DS0$PB089M3M),ID6854DS0$OB089M3M,ID6854DS0$PB089M3M)
ID6854DS0$BLK<-ifelse(((ID6854DS0$PB089M1M==2)|(ID6854DS0$PB089M2M==2)|(ID6854DS0$PB089M3M==2)),1,0)
ID6854DS0$OTH<-ifelse(((ID6854DS0$PB089M1M==97)|(ID6854DS0$PB089M2M==97)|(ID6854DS0$PB089M3M==97)),1,0)
ID6854DS0$WHT<-ifelse(((ID6854DS0$PB089M1M==1)|(ID6854DS0$PB089M2M==1)|(ID6854DS0$PB089M3M==1)),1,0)
...
#1=MALE
#2=FEMALE
ID6854DS0$SEX<-ifelse(ID6854DS0$PX060_R==1,1,
               ifelse(ID6854DS0$PX060_R==2,0,NA))

#Recode age 
ID6854DS0$AGECALC<-ID6854DS0$PA019

#Income, Education, Occupation ----
##Income
ID6854DS0$PQ020[ID6854DS0$PQ020=="999998"]<-NA
ID6854DS0$PQ020[ID6854DS0$PQ020=="999999"]<-NA
ID6854DS0$PQ045[ID6854DS0$PQ045=="999998"]<-NA
ID6854DS0$PQ045[ID6854DS0$PQ045=="999999"]<-NA
ID6854DS0$INC<-rowSums(x=cbind(ID6854DS0$PQ020,ID6854DS0$PQ045),na.rm = TRUE)
        
##Education
ID6854DS0$PB014[ID6854DS0$PB014=="97"]<-NA
ID6854DS0$PB014[ID6854DS0$PB014=="98"]<-NA
ID6854DS0$PB014[ID6854DS0$PB014=="99"]<-NA
ID6854DS0$EDU<-pmax(ID6854DS0$EDU,ID6854DS0$PB014,na.rm=TRUE)
...
write.csv(ID6854DS0, file = 'ID6854DS0_2016_recoded.csv')
...
ID6854DS0_2016_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID6854DS0_2016_aggregated, file = 'ID6854DS0_2016_aggregated.csv',row.names = FALSE)
