...
ID4596DS1<-data.frame(YELSTGRD,NEWRACE2,IRSEX,AGE2,IRFAMIN3)
detach(da04596.0001)
...
ID4596DS1$DEP<-NA#rowMeans(x=dsitems,na.rm=TRUE)
...
##Income
ID4596DS1$INC<-ifelse(ID4596DS1$IRFAMIN3=="(1) Less than $10,000 (Including Loss)",900,
...
write.csv(ID4596DS1, file = 'ID4596DS1_ACHV_recoded.csv')

#Descriptives and Correlations -----
#Only AD answered achievement questions, exclude participants without sufficient data
achievementdata<-ID4596DS1[which(ID4596DS1$ACHV>=1.00),]
...
#CH<-ID4596DS1[which((achievementdata$AGECALC >= 5)&(achievementdata$AGECALC <= 11)), ] 
AD<-ID4596DS1[which((achievementdata$AGECALC >= 12)&(achievementdata$AGECALC <= 17)), ]
#YD<-ID4596DS1[which((achievementdata$AGECALC >= 18)&(achievementdata$AGECALC <= 25)), ]
#AT<-ID4596DS1[which((achievementdata$AGECALC >= 26)&(achievementdata$AGECALC <= 64)), ]
#OA<-ID4596DS1[which(achievementdata$AGECALC >= 65), ]
...
ID4596DS1_ACHV_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
WHTADFAGGRTED,
WHTADMAGGRTED,
...
write.csv(ID4596DS1_ACHV_aggregated, file = 'ID4596DS1_ACHV_aggregated.csv',row.names = FALSE)
