#Load data
library('foreign')
da03255.0002<-as.data.frame(read.spss('03255-0002-Data.sav'))
#merge prior wave
da03255.0001<-as.data.frame(read.spss('03255-0001-Data.sav'))
names(da03255.0002)[names(da03255.0002)=="link"]<-"id_w1"
merged3255<-merge(da03255.0002,da03255.0001,by.x = "id_w1",by.y = "id")

#Coded variables
#Participant ID: link is wave 2, id is wave 1
#Measure Name (not a variable in the dataset): CESD
#Depressive symptom items: 
#Q5005AW2,Q5005BW2,Q5005CW2,Q5005DW2,Q5005EW2,Q5005FW2,Q5005GW2,Q5005HW2
...
#Notes: Religion, Aging, and Health Survey, 2001, 2004 [United States] - Wave 2

#Create Dataset ----
attach(merged3255)
#Extract relevant variables into a dataframe.
ID3255DS2<-data.frame(id_w1,q5005aw2,q5005bw2,q5005cw2,q5005dw2,q5005ew2,q5005fw2,q5005gw2,q5005hw2,
                      q1703a1,q1703a2,q1703a3,q1703a4,q1703a5,q1703a6,q1703a7,q1703a8,
                      q14,q120,q110,q108,q8505w2,q8510w2,q104)
detach(merged3255)
ID3255DS2$ORIGOBS<-nrow(ID3255DS2)
rm(merged3255,da03255.0001,da03255.0002)

#Check to make sure there is no funny business
head(ID3255DS2)

#Depressive Symptoms ---------
ID3255DS2$q5005aw2<-ifelse(ID3255DS2$q5005aw2=="Rarely or none of the time",0,               
                    ifelse(ID3255DS2$q5005aw2=="Some of little of the time",1,               
                    ifelse(ID3255DS2$q5005aw2=="Occasionally or a moderate amount of the time",2,
                    ifelse(ID3255DS2$q5005aw2=="Most or all of the time",3,NA))))
ID3255DS2$q5005bw2<-ifelse(ID3255DS2$q5005bw2=="Rarely or none of the time",0,               
                    ifelse(ID3255DS2$q5005bw2=="Some of little of the time",1,               
                    ifelse(ID3255DS2$q5005bw2=="Occasionally or a moderate amount of the time",2,
                    ifelse(ID3255DS2$q5005bw2=="Most or all of the time",3,NA))))
ID3255DS2$q5005cw2<-ifelse(ID3255DS2$q5005cw2=="Rarely or none of the time",0,               
                    ifelse(ID3255DS2$q5005cw2=="Some of little of the time",1,               
                    ifelse(ID3255DS2$q5005cw2=="Occasionally or a moderate amount of the time",2,
                    ifelse(ID3255DS2$q5005cw2=="Most or all of the time",3,NA))))
ID3255DS2$q5005dw2<-ifelse(ID3255DS2$q5005dw2=="Rarely or none of the time",0,               
                    ifelse(ID3255DS2$q5005dw2=="Some of little of the time",1,               
                    ifelse(ID3255DS2$q5005dw2=="Occasionally or a moderate amount of the time",2,
                    ifelse(ID3255DS2$q5005dw2=="Most or all of the time",3,NA))))
ID3255DS2$q5005ew2<-ifelse(ID3255DS2$q5005ew2=="Rarely or none of the time",0,               
                    ifelse(ID3255DS2$q5005ew2=="Some of little of the time",1,               
                    ifelse(ID3255DS2$q5005ew2=="Occasionally or a moderate amount of the time",2,
                    ifelse(ID3255DS2$q5005ew2=="Most or all of the time",3,NA))))
ID3255DS2$q5005fw2<-ifelse(ID3255DS2$q5005fw2=="Rarely or none of the time",0,               
                    ifelse(ID3255DS2$q5005fw2=="Some of little of the time",1,               
                    ifelse(ID3255DS2$q5005fw2=="Occasionally or a moderate amount of the time",2,
                    ifelse(ID3255DS2$q5005fw2=="Most or all of the time",3,NA))))
ID3255DS2$q5005gw2<-ifelse(ID3255DS2$q5005gw2=="Rarely or none of the time",0,               
                    ifelse(ID3255DS2$q5005gw2=="Some of little of the time",1,               
                    ifelse(ID3255DS2$q5005gw2=="Occasionally or a moderate amount of the time",2,
                    ifelse(ID3255DS2$q5005gw2=="Most or all of the time",3,NA))))
ID3255DS2$q5005hw2<-ifelse(ID3255DS2$q5005hw2=="Rarely or none of the time",0,               
                    ifelse(ID3255DS2$q5005hw2=="Some of little of the time",1,               
                    ifelse(ID3255DS2$q5005hw2=="Occasionally or a moderate amount of the time",2,
                    ifelse(ID3255DS2$q5005hw2=="Most or all of the time",3,NA))))

#Depressive symptoms prior wave 
ID3255DS2$q1703a1<-ifelse(ID3255DS2$q1703a1=="Rarely or None of the Time",0,               
                   ifelse(ID3255DS2$q1703a1=="Some or Little of the Time",1,               
                   ifelse(ID3255DS2$q1703a1=="Occasionally or a Moderate Amount of Time",2,
                   ifelse(ID3255DS2$q1703a1=="Most or All of the Time",3,NA))))
ID3255DS2$q1703a2<-ifelse(ID3255DS2$q1703a2=="Rarely or None of the Time",0,               
                   ifelse(ID3255DS2$q1703a2=="Some or Little of the Time",1,               
                   ifelse(ID3255DS2$q1703a2=="Occasionally or a Moderate Amount of Time",2,
                   ifelse(ID3255DS2$q1703a2=="Most or All of the Time",3,NA))))
ID3255DS2$q1703a3<-ifelse(ID3255DS2$q1703a3=="Rarely or None of the Time",0,               
                   ifelse(ID3255DS2$q1703a3=="Some or Little of the Time",1,               
                   ifelse(ID3255DS2$q1703a3=="Occasionally or a Moderate Amount of Time",2,
                   ifelse(ID3255DS2$q1703a3=="Most or All of the Time",3,NA))))
ID3255DS2$q1703a4<-ifelse(ID3255DS2$q1703a4=="Rarely or None of the Time",0,               
                   ifelse(ID3255DS2$q1703a4=="Some or Little of the Time",1,               
                   ifelse(ID3255DS2$q1703a4=="Occasionally or a Moderate Amount of Time",2,
                   ifelse(ID3255DS2$q1703a4=="Most or All of the Time",3,NA))))
ID3255DS2$q1703a5<-ifelse(ID3255DS2$q1703a5=="Rarely or None of the Time",0,               
                   ifelse(ID3255DS2$q1703a5=="Some or Little of the Time",1,               
                   ifelse(ID3255DS2$q1703a5=="Occasionally or a Moderate Amount of Time",2,
                   ifelse(ID3255DS2$q1703a5=="Most or All of the Time",3,NA))))
ID3255DS2$q1703a6<-ifelse(ID3255DS2$q1703a6=="Rarely or None of the Time",0,               
                   ifelse(ID3255DS2$q1703a6=="Some or Little of the Time",1,               
                   ifelse(ID3255DS2$q1703a6=="Occasionally or a Moderate Amount of Time",2,
                   ifelse(ID3255DS2$q1703a6=="Most or All of the Time",3,NA))))
ID3255DS2$q1703a7<-ifelse(ID3255DS2$q1703a7=="Rarely or None of the Time",0,               
                   ifelse(ID3255DS2$q1703a7=="Some or Little of the Time",1,               
                   ifelse(ID3255DS2$q1703a7=="Occasionally or a Moderate Amount of Time",2,
                   ifelse(ID3255DS2$q1703a7=="Most or All of the Time",3,NA))))
ID3255DS2$q1703a8<-ifelse(ID3255DS2$q1703a8=="Rarely or None of the Time",0,               
                   ifelse(ID3255DS2$q1703a8=="Some or Little of the Time",1,               
                   ifelse(ID3255DS2$q1703a8=="Occasionally or a Moderate Amount of Time",2,
                   ifelse(ID3255DS2$q1703a8=="Most or All of the Time",3,NA))))

#Assign dataframe that contains all depressive symtpoms (using the column numbers of the items)
dsitems <- ID3255DS2[c(2:9)]
dsitemspw <- ID3255DS2[c(10:17)]
#Identify participants missing more than half of dsitems (not dsitemsW1) (1=missing > 50%) - to be used later
ID3255DS2$dsmiss<-ifelse(rowSums(is.na(dsitems))>((ncol(dsitems)/2)),1,0)
#Compute mean symptom score 
ID3255DS2$DEP<-rowMeans(x=dsitems,na.rm=TRUE)
ID3255DS2$DEPPW<-rowMeans(x=dsitemspw,na.rm=TRUE)
...
ID3255DS2$LAT<-ifelse(ID3255DS2$q14=="Hispanic/Latino",1,0)
ID3255DS2$WHT<-ifelse(ID3255DS2$q14=="White/Caucasian",1,0)
ID3255DS2$BLK<-ifelse(ID3255DS2$q14=="Black/African American",1,0)
ID3255DS2$AI<-ifelse(ID3255DS2$q14=="American Indian or Alaskan Native",1,0)
ID3255DS2$AA<-ifelse(ID3255DS2$q14=="Asian or Pacific Islander",1,0)
ID3255DS2$OTH<-ifelse(ID3255DS2$q14=="Other",1,0)

#Compute variable for participants who reported more than one race (mixed/biracial; do not include Latino)
ID3255DS2$MR<-ifelse(((ID3255DS2$q14=="White/Caucasian and some other race")|
                      (ID3255DS2$q14=="Black/African American and some other race")),1,0)
#ID3255DS2$MR<-ifelse((rowSums(x=cbind(ID3255DS2$WHT,ID3255DS2$BLK,ID3255DS2$AI,ID3255DS2$AA,
#                                       ID3255DS2$OTH),na.rm=TRUE)) > 1, 1, 0)

##Compute variables for participants who reported a single race (excluding mixed/biracial & Latino)
#ID3255DS2$WHT<-ifelse(((ID3255DS2$LAT == 0)&(ID3255DS2$MR == 0)&(ID3255DS2$WHT == 1)), 1, 0)
#ID3255DS2$BLK<-ifelse(((ID3255DS2$LAT == 0)&(ID3255DS2$MR == 0)&(ID3255DS2$BLK == 1)), 1, 0)
#ID3255DS2$AI<-ifelse(((ID3255DS2$LAT == 0)&(ID3255DS2$MR == 0)&(ID3255DS2$AI == 1)), 1, 0)
#ID3255DS2$AA<-ifelse(((ID3255DS2$LAT == 0)&(ID3255DS2$MR == 0)&(ID3255DS2$AA == 1)), 1, 0)
#ID3255DS2$OTH<-ifelse(((ID3255DS2$LAT == 0)&(ID3255DS2$MR == 0)&(ID3255DS2$OTH == 1)), 1, 0)
#ID3255DS2$MR<-ifelse(((ID3255DS2$LAT == 0)&(ID3255DS2$MR == 1)), 1, 0)

#Recode sex
ID3255DS2$SEX<-ifelse(ID3255DS2$q120 == "Male",1,
               ifelse(ID3255DS2$q120 == "Female",0,NA))

#Recode age 
ID3255DS2$q8505w2[ID3255DS2$q8505w2==999]<-NA
ID3255DS2$AGECALC<-ID3255DS2$q8505w2

#Income, Education, Occupation ----
##Income   
ID3255DS2$INC<-ifelse(ID3255DS2$q8510w2=="$Less than $5,000",4999, 
               ifelse(ID3255DS2$q8510w2=="$5,001 - $9,999",7499.5,     
               ifelse(ID3255DS2$q8510w2=="$10,000 -$14,999",12499.5,   
               ifelse(ID3255DS2$q8510w2=="$15,000 - $19,999",17499.5,   
               ifelse(ID3255DS2$q8510w2=="$20,000 - $24,999",22499.5,  
               ifelse(ID3255DS2$q8510w2=="$25,000 - $29,999",27499.5,   
               ifelse(ID3255DS2$q8510w2=="$30,000 - $39,999",34999.5,   
               ifelse(ID3255DS2$q8510w2=="$40,000 - $59,999",49999.5,   
               ifelse(ID3255DS2$q8510w2=="$60,000 - $79,999",69999.5,   
               ifelse(ID3255DS2$q8510w2=="$80,000+",80000,NA))))))))))

##Education 
ID3255DS2$q104[ID3255DS2$q104==99]<-NA
ID3255DS2$q104[ID3255DS2$q104==98]<-NA
ID3255DS2$EDU<-ID3255DS2$q104
...
write.csv(ID3255DS2, file = 'ID3255DS2_recoded.csv')

#Descriptives and Correlations -----
#Exclude participants with more than 50% missing on depressive symptoms items
ID3255DS2 <- ID3255DS2[which(ID3255DS2$dsmiss==0), ]

##Compute mean and sd across all participants within dataset
library('psych')
#Means & SDs of focal variables
dstatsage<-describe(ID3255DS2$AGECALC)
dstatsdep<-describe(ID3255DS2$DEP)
dstatsachv<-NA#describe(ID3255DS2$ACHV)
dstatsinc<-describe(ID3255DS2$INC)
dstatsedu<-describe(ID3255DS2$EDU)
dstatsoccs<-NA#describe(ID3255DS2$OCCS)
dstatsoccp<-NA#describe(ID3255DS2$OCCP)

#Save descriptive stats
dstats<-rbind(dstatsage,dstatsdep,dstatsachv,dstatsinc,dstatsedu,dstatsoccs,dstatsoccp,make.row.names= FALSE)
write.csv(dstats,file = 'ID3255DS2_dstats.csv',
          row.names=c("dstatsage","dstatsdep","dstatsachv","dstatsinc","dstatsedu","dstatsoccs","dstatsoccp"))

##Histograms 
pdf('ID3255DS2_dephist.pdf')
hist(ID3255DS2$DEP, xlab="Depressive Symptoms", main = NULL, col="grey")
dev.off()
#pdf('ID3255DS2_achvhist.pdf')
#hist(ID3255DS2$ACHV, xlab="Academic Achievement", main = NULL, col="grey")
#dev.off()
pdf('ID3255DS2_inchist.pdf')
hist(ID3255DS2$INC, xlab="Income", main = NULL, col="grey")
dev.off()
pdf('ID3255DS2_educhist.pdf')
hist(ID3255DS2$EDU, xlab="Educational Attainment", main = NULL, col="grey")
dev.off()
#pdf('ID3255DS2_occshist.pdf')
#hist(ID3255DS2$OCCS, xlab="Occupational Status", main = NULL, col="grey")
#dev.off()
#pdf('ID3255DS2_occphist.pdf')
#hist(ID3255DS2$OCCP, xlab="Occupational Prestige", main = NULL, col="grey")
#dev.off()
...
table(ID3255DS2$AGECALC)
#Separate dataset by developmental period, if needed
#CH<-ID3255DS2[which((ID3255DS2$AGECALC >= 5)&(ID3255DS2$AGECALC <= 11)), ] 
#AD<-ID3255DS2[which((ID3255DS2$AGECALC >= 12)&(ID3255DS2$AGECALC <= 17)), ]
#YD<-ID3255DS2[which((ID3255DS2$AGECALC >= 18)&(ID3255DS2$AGECALC <= 25)), ]
#AT<-ID3255DS2[which((ID3255DS2$AGECALC >= 26)&(ID3255DS2$AGECALC <= 64)), ]
OA<-ID3255DS2[which(ID3255DS2$AGECALC >= 65), ]
...
matrixvars <- c("INCMC","INC2","EDUMC","EDU2","DEP","DEPPW")
...
##Assign ICPSR ID number (ICPSR Number; e.g., file name = ID3255DS2, then DATAID = 21600)
#DATAID<-'3255'
#names(DATAID)<-'DATAID'
...
ID3255DS2_aggregated<-dplyr::bind_rows(
#WHTCHFAGGRTED,
#WHTCHMAGGRTED,
#WHTADFAGGRTED,
#WHTADMAGGRTED,
...
write.csv(ID3255DS2_aggregated, file = 'ID3255DS2_aggregated.csv',row.names = FALSE)